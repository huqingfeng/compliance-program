...
class Camcraft2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Camcraft2017ComplianceProgramReportPrinter();
    }
...
class Camcraft2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>As communicated, a medical premium discount will be offered for those employees (and spouses) who fall
                within the acceptable range for at least <span class="bund">three</span> out of the six "Health Standards"
                shown below. If you (or your spouse) do not fall within the acceptable range for at least three measures,
                you have the option of the “Alternate Process” in order to still receive the discount. If you do not
                successfully complete either of these options, you will not be eligible for the employee medical premium
                discount this year.</p>
            ...
            <?php if($this->getNumCompliant($status) >= 3 && $cotinineCompliant) : ?>
                ...
                <p>CONGRATULATIONS! Based on your results of the wellness screening, you <span class="bund">DO</span> fall within the
                ...
                <p>Based on your results of the wellness screening, you do fall within the acceptable range for at least
                 three “Health Standards”. However, your cotinine result was not in the acceptable range. It is
                  <span class="bund">required</span> for you to enroll in American Lung Association’s Smoking
                   Cessation Program within 2 months from your start date and complete thereafter.</p>
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>Based on your results of the wellness screening, you <span class="bund">DO NOT</span> fall within the acceptable range
                    ...
                    <p>In order to receive the discount, we <strong>must</strong> have documentation from your Physician acknowledging
                        ...
                        results packet, to Health Maintenance Institute, complete with your Physician’s signature. If
                        your completed form is not received within 60 days of your start date, you will not qualify for
                        the discount.</p>

                    <p>Specifically for those who did not fall within the acceptable range for the cotinine test, it is
                        <span class="bund">required</span> for you to enroll in American Lung Association's Smoking Cessation Program
                        within 2 months from your state date and complete thereafter.</p>
