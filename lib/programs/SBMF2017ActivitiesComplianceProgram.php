...
class SBMF2017ActivitiesFlushotComplianceView extends DateBasedComplianceView
{
    public function __construct($startDate, $endDate)
    {
        $this->setStartDate('2016-09-01');
        $this->setEndDate('2017-03-31');
    }
...
class SBMF2017ActivitiesBloodDonationComplianceView extends DateBasedComplianceView
{
    public function __construct($startDate, $endDate)
    {
...
class SBMF2017ActivitiesComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new SBMF2017ActivitiesComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $physicalView->addLink(new Link('I did this', '/resources/9531/2017 Physician Biometric Consent Form.pdf'));
        $otherMeasurementsGroup->addComplianceView($physicalView);


        $flushotView = new SBMF2017ActivitiesFlushotComplianceView($programStart, $programEnd);
        ...
        $bloodView = new SBMF2017ActivitiesBloodDonationComplianceView($programStart, $programEnd);
...
class SBMF2017ActivitiesComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    public function printClientMessage()
    {
        ...
        <ol><li><strong>Annual Physical Exam: </strong>
                ...
                Physical exams need to be completed between September 1, 2016 and August 31, 2017.
            </li><li><strong>Annual Flu Shot: </strong>
                Employees and spouses who received a flu vaccination between September 1, 2016 and March 31, 2017 will
...
<!--        <div id="clientNotice">--><?php //$this->printClientNotice() ?><!--</div>-->
    ...
    public function printClientNote()
    {
        ...
        <p>
            Note: A Physical exam/biometric screening is required for the wellness incentive offered in 2017. Points will be rewarded for completing the annual physical exam and successfully meeting the biometric benchmarks.
        </p>
        <p>
