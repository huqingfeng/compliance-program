...
class SBC2015ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new SBC2015ComplianceProgramReportPrinter();
    }
}

class SBC2015ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
