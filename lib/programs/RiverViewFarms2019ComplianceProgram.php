...
class RiverViewFarms2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new RiverViewFarms2019ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('deadline', '7/17/19');
        ...
        $tobaccoAlternative->setReportName('2. OR - Confirm you are working with your doctor on these goals. Just complete the <a href="/resources/10340/2019_River View Farms_AQF_050219.pdf">Alternative Qualification Form</a> then fax or mail to EHS by deadline.');
        ...
        $tobaccoAlternative->setAttribute('goal', 'Fax or mail completed form by 8/8/19 -> <a href="/resources/10340/2019_River View Farms_AQF_050219.pdf" download>Download Form</a>');
        ...
        $bmiView->setAttribute('goal', '< 30 or 2 less from 2018');
        ...
        $ldlView->setAttribute('goal', '<130 or 10 less from 2018');
        ...
        $triglyceridesView->setAttribute('goal', '<160 or 15 less from 2018');
        ...
        $glucoseView->setAttribute('goal', '<110 or 20 less from 2018');
        ...
        $alternativeMeetDrView->setReportName('6. OR - Confirm you are working with your doctor on these goals. Just complete the <a href="/resources/10340/2019_River View Farms_AQF_050219.pdf">Alternative Qualification Form</a> then fax or mail to EHS by deadline.');
        ...
        $alternativeMeetDrView->setAttribute('goal', 'Fax or mail completed form by 8/8/19 -> <a href="/resources/10103/River_View_Farms_AQF_061918.pdf" download>Download Form</a>');
        ...
        return function(ComplianceViewStatus $status, User $user) use ($test, $programStart, $programEnd, $lastStart, $lastEnd, $calculationMethod, $threshold) {
            ...
            if ($cache['this'] || $cache['last']) {
                ...
                if ($thisVal && $lastVal) {
                    ...
                    $status->setAttribute('2018_2019_change', $change);
                ...
                $status->setAttribute('2018_result', $lastVal);
                $status->setAttribute('2019_result', $thisVal);
...
class RiverViewFarms2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                ...
                <div>
                    To encourage wellbeing, the use of this benefit and other related actions, River View Farms offers 2
                     ...
                     <ul style="list-style-type: upper-alpha">
                        <li><strong>Health Action Reward:</strong> A.Get $5 per pay reward (up to $130/year) by meeting 3 of 5 screening result goals noted below -OR- by achieving better results than in 2018.</li>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 320px;">A. Tobacco Free Reward – Meet the 1 of these goals by 8/8/19:</th>
                        <th>Goal</th>
                    ...
                    <?php foreach($healthyGroupStatus->getComplianceViewStatuses() as $viewStatus) : ?>
                        <tr class="status-<?php echo $viewStatus->getStatus() ?>">
                            ...
                            <td><?php echo $viewStatus->getAttribute('2018_2019_change') ?></td>
                            <td>
