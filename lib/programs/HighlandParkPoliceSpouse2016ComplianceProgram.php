...
class HighlandParkPoliceSpouse2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new HighlandParkPoliceSpouse2016ComplianceProgramReportPrinter();
    }

    const EMPLOYEE_RECORD_ID = 596;

    private $relationshipTypes = array(Relationship::SPOUSE, Relationship::EMPLOYEE);
}

class HighlandParkPoliceSpouse2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    protected function printCustomRows($status)
    {
        ...
        <tr class="headerRow headerRow-required">
            ...
            <td>Current Total</td>
            <td>Status</td>
            <td>Minimum Needed for Incentive By 10/31/2016</td>
        </tr>
        <tr>
