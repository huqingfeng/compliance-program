...
class MTIActivities2018Q2WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '04/02/2018 through 04/08/2018',
        2 => '04/09/2018 through 04/15/2018',
        3 => '04/16/2018 through 04/22/2018',
        4 => '04/23/2018 through 04/29/2018',
        5 => '04/30/2018 through 05/06/2018',
        6 => '05/07/2018 through 05/13/2018',
        7 => '05/14/2018 through 05/20/2018',
        8 => '05/21/2018 through 05/27/2018',
        9 => '05/28/2018 through 06/03/2018',
        10 => '06/04/2018 through 06/10/2018',
        11 => '06/11/2018 through 06/17/2018',
        12 => '06/18/2018 through 06/24/2018',
        13 => '06/25/2018 through 07/01/2018'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2018-04-01', '2017-06-30');
    ...
    {
        $records = $this->getActivity()->getRecords($user, '2018-01-01', '2018-12-31');
...
class MTIActivities2018Q2ComplianceProgram extends ComplianceProgram
{
    const MTI_2018Q2_ACTIVITY_START_DATE = '2018-04-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2018Q2WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    {
        return new MTIActivities2018WMS2ComplianceProgramPrinter();
    }
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2018Q2WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2018Q2WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2018Q2_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2018Q2ComplianceProgram::MTI_2018Q2_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
...
class MTIActivities2018WMS2ComplianceProgramPrinter implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $biometricRecord = ComplianceProgramRecordTable::getInstance()->find(1305);
        ...
        $quarterOneRecord = ComplianceProgramRecordTable::getInstance()->find(1306);
        ...
        $quarterTwoRecord = ComplianceProgramRecordTable::getInstance()->find(1307);
        ...
        $quarterThreeRecord = ComplianceProgramRecordTable::getInstance()->find(1308);
        ...
        $quarterFourRecord = ComplianceProgramRecordTable::getInstance()->find(1309);
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                $user = $status->getUser();
                if ($status->getComplianceProgram()->hasFitbitData($status->getUser())) : ?>
                    <div class="alert alert-info">
                        Fitbit/Fitness Tracking syncing is enabled.

                        <a class="btn btn-primary btn-xs pull-right" href="/compliance/mti-program-2016/fitness-tracking-wms3/content/wms3fitbit?wms1Id=<?php echo $user->getId(); ?>&wms2AccountId=<?php echo $user->getWms2AccountId(); ?>&prefix=mti-program-2016"">
                ...
                <div id="more-info" style="display: none">
                    <p>
                        ...
                        of your exams. Exams must take place 01/01/18 - 12/31/18 to receive points, points will be
                        updated from claims received 60-90 days post exam date.
                    </p>

                    <p>
                        Other activities can be updated for the current date or past date between 01/01/18 - 12/31/18
