...
class Midland2015RangeStepsComplianceView extends DateBasedComplianceView
{
...
class Midland2015WalkingComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $quarterOneStart = '2015-04-20';
        $quarterOneEnd = '2015-06-30';

        $quarterOne6K = new Midland2015RangeStepsComplianceView($quarterOneStart, $quarterOneEnd, 6000, 8000, 1);
        ...
        $quarterOne8K = new Midland2015RangeStepsComplianceView($quarterOneStart, $quarterOneEnd, 8000, 10000, 2);
        ...
        $quarterOne10K = new Midland2015RangeStepsComplianceView($quarterOneStart, $quarterOneEnd, 10000, null, 3);
        ...
        $quarterTwoGroup->setPointsRequiredForCompliance(150);

        $quarterTwoStart = '2015-07-01';
        $quarterTwoEnd = '2015-09-30';

        $quarterTwo6K = new Midland2015RangeStepsComplianceView($quarterTwoStart, $quarterTwoEnd, 6000, 8000, 1);
        ...
        $quarterTwo8K = new Midland2015RangeStepsComplianceView($quarterTwoStart, $quarterTwoEnd, 8000, 10000, 2);
        ...
        $quarterTwo10K = new Midland2015RangeStepsComplianceView($quarterTwoStart, $quarterTwoEnd, 10000, null, 3);
        ...
        $quarterThreeGroup->setPointsRequiredForCompliance(200);

        $quarterThreeStart = '2015-10-01';
        $quarterThreeEnd = '2015-12-31';

        $quarterThree6K = new Midland2015RangeStepsComplianceView($quarterThreeStart, $quarterThreeEnd, 6000, 8000, 1);
        ...
        $quarterThree8K = new Midland2015RangeStepsComplianceView($quarterThreeStart, $quarterThreeEnd, 8000, 10000, 2);
        ...
        $quarterThree10K = new Midland2015RangeStepsComplianceView($quarterThreeStart, $quarterThreeEnd, 10000, null, 3);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new Midland2015WalkingComplianceProgramReportPrinter();
...
class Midland2015WalkingComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
?>
    ...
    <style type="text/css">
        ...
        <table class="phipTable">
            <tbody>
            <tr><th colspan="6" class="headerRow">2015 Midland Step Challenge</th></tr>
            ...
            <tr>
                <td rowspan="3">
                    ...
                    &nbsp;<strong>Quarter 1: 4/20 - 6/30/15</strong>
                </td>
            ...
            <tr>
                <td rowspan="3">
                    &nbsp;Individual Walking Program <br /><br />
                    &nbsp;<strong>Quarter 2: 7/1 - 9/30/15</strong>
                </td>
                <td class="requirement">Walk an average of 6,000 steps/day </td>
            ...
            <tr>
                <td rowspan="3">
                    &nbsp;Individual Walking Program <br /><br />
                    &nbsp;<strong>Quarter 3: 10/1 - 12/31/2015</strong>
                </td>
                <td class="requirement">Walk an average of 6,000 steps/day </td>
            ...
            <tr>
                <td colspan="6" style="text-align: center; font-size: 10pt;">
                    ...
                    Q1: Earn at least 75 pts between April 20 - June 30, 2015<br />
                    Q2: Earn at least 150 pts between July 1 - September 30, 2015<br />
                    Q3: Earn at least 200 pts between Oct 1 - Dec 31, 2015<br /><br />
