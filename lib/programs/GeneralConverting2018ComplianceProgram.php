...
class GeneralConverting2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new GeneralConverting2018ComplianceProgramReportPrinter();
    }
...
class GeneralConverting2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <div style="clear: both">
                <div style="width: 100%; margin-top: 10px; display: block">
                    ...
                    <ol type="A">
                        <li><strong>Health Action Reward:</strong> Earn 1,000 points out of the 1,900 possible points by 8/18/18. <strong>Discount = TBD</strong>.</li>
                        <li><strong>Tobacco Free Reward:</strong> Test negative or complete 5 online tobacco cessation lessons by 8/18/18. <strong>Discount = TBD</strong>.</li>
                    </ol>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th style="text-align: left; width: 320px;" colspan="2">A. Earn 1,000 or more points by 8/18/2018 in any of the ways below:</th>
                    ...
                    <tr>
                        <td style="text-align: left; width: 320px;" colspan="3">
                            ...
                            <em style="color: red;">*  #9 and #10 can be done anytime from 1/1/18 to 8/18/18 for points – just use the related
