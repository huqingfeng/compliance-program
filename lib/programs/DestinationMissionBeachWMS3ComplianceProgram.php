...
$_SESSION['redirect_dashboard_link'] = '/compliance_programs?id=1607';

class DestinationMissionBeachWMS3ExerciseToSteps extends CompleteArbitraryActivityComplianceView
{
...
class DestinationMissionBeachWMS3FitbitComplianceView extends DateBasedComplianceView
{
...
class DestinationMissionBeachWMS3AdminPrinter extends BasicComplianceProgramAdminReportPrinter
{
...
class DestinationMissionBeachWMS3ComplianceProgram extends ComplianceProgram
{
    public function getAdminProgramReportPrinter()
    {
        $record = $this->getComplianceProgramRecord();

        return new DestinationMissionBeachWMS3AdminPrinter($record);
    }

    public function getTeamDashboardPrinter()
    {
        return new DestinationMissionBeachWMS3TeamDashboardPrinter();
    }

    public function getBuddyDashboardPrinter()
    {
        return new DestinationMissionBeachWMS3BuddyDashboardPrinter();
    }

    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new DestinationMissionBeachWMS3ProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $missionBeachDataType = $_user->getClient()->getConfigurationParameter('enable_mission_beach_data_type', "mission_beach");
        ...
        $url = $domain."wms3/public/report?bypass=true&method=download&program_id=".$program_id."&program_name=".$missionBeachDataType."&type=mission_beach&return=true";
        ...
        $fitbitView = new DestinationMissionBeachWMS3FitbitComplianceView($startDate, $endDate, $steps);
        ...
        $fitbitView->addLink(new Link('Give Permission to Sync', '/compliance/chp-program/fitness-tracking-wms3/content/wms3fitbit?wms1Id='.$wms1ID.'&wms2AccountId='.$wms2AccountID.'&prefix=chp-program', false, '_blank'));
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('#optinButton').click(function(){
                    $.ajax({
                        method: "GET",
                        url: "<?= sfConfig::get('app_wms2', false) ? '/wms1' : '' ?>/content/mission-beach-opt-in",
                        dataType: "json",
...
class DestinationMissionBeachWMS3ProgramReportPrinter implements ComplianceProgramReportPrinter
{
...
class DestinationMissionBeachWMS3TeamDashboardPrinter extends DestinationMissionBeachWMS3BuddyAndTeamDashboardPrinter implements TeamDashboardPrinter
{
...
class DestinationMissionBeachWMS3BuddyDashboardPrinter extends DestinationMissionBeachWMS3BuddyAndTeamDashboardPrinter implements BuddyDashboardPrinter
{
...
abstract class DestinationMissionBeachWMS3BuddyAndTeamDashboardPrinter
{
