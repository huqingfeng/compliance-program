...
class Medpro2014ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
...
class Medpro2014ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new Medpro2014ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $newCotinineView = new ComplyWithCotinineScreeningTestComplianceView('2014-01-01', '2014-12-31');
        $newCotinineView->setReportName('Cotinine 2014');
        $newCotinineView->setName('cotinine_2014');
        $newCotinineView->setPostEvaluateCallback(
            $this->setNaIfCompliant(array($cotinine2011View, $cotinine2012View, $cotinine2013View))
        );
