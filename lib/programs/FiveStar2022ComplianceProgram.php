<?php
  ...
  class FiveStar2022CompleteScreeningComplianceView extends CompleteScreeningComplianceView {
  ...
  class FiveStar2022ComplianceProgram extends ComplianceProgram {
    ...
    public function executeTobaccoAffidavit(sfActions $actions) {
      ...
      <form class="affidavit_form" action="/compliance_programs/localAction">
        ...
        <p class="mt4">
          ...
          <strong>Five Star</strong> Wellness Program. In addition,
          <strong>Five Star</strong> may take disciplinary action up to
    ...
    public function executeSubmitTobaccoAffidavit(sfActions $actions) {
      ...
      <script>
        window.location.replace("/compliance_programs?id=1735");
      </script>
    ...
    public function getProgramReportPrinter($preferredPrinter = null) {
      return new FiveStar2022WMS2Printer();
    }
  ...
  class FiveStar2022WMS2Printer implements ComplianceProgramReportPrinter {
        ...
        <div class="col-md-12">
          <p>
            ...
            <ul>
              <li>
                Complete a
                <a href="/compliance/fivestar/appointment/content/schedule-appointments">health screening onsite</a>
              </li>
              <li>
                Complete a
                <a href="/compliance_programs/localAction?id=1735&local_action=tobaccoAffidavit">tobacco affidavit</a>
              </li>
              <li>
