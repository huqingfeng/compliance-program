...
class MTIActivities2019Q2WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '04/01/2019 through 04/07/2019',
        2 => '04/08/2019 through 04/14/2019',
        3 => '04/15/2019 through 04/21/2019',
        4 => '04/22/2019 through 04/28/2019',
        5 => '04/29/2019 through 05/05/2019',
        6 => '05/06/2019 through 05/12/2019',
        7 => '05/13/2019 through 05/19/2019',
        8 => '05/20/2019 through 05/26/2019',
        9 => '05/27/2019 through 06/02/2019',
        10 => '06/03/2019 through 06/09/2019',
        11 => '06/10/2019 through 06/16/2019',
        12 => '06/17/2019 through 06/23/2019',
        13 => '06/24/2019 through 06/30/2019'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2019-04-01', '2019-06-30');
...
class MTIActivities2019Q2ComplianceProgram extends ComplianceProgram
{
    const MTI_2019Q2_ACTIVITY_START_DATE = '2019-04-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2019Q2WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2019Q2WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2019Q2WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2019Q2_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2019Q2ComplianceProgram::MTI_2019Q2_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
...
class MTIActivities2019WMS2ComplianceProgramPrinter implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $biometricRecord = ComplianceProgramRecordTable::getInstance()->find(1396);
        ...
        $quarterOneRecord = ComplianceProgramRecordTable::getInstance()->find(1397);
        ...
        $quarterTwoRecord = ComplianceProgramRecordTable::getInstance()->find(1398);
        ...
        $quarterThreeRecord = ComplianceProgramRecordTable::getInstance()->find(1399);
        ...
        $quarterFourRecord = ComplianceProgramRecordTable::getInstance()->find(1400);
            ...
            <div class="col-md-12">
                ...
                <div id="more-info" style="display: none">
                    <p>
                        ...
                        of your exams. Exams must take place 01/01/19 - 12/31/19 to receive points, points will be
                        updated from claims received 60-90 days post exam date.
                    </p>

                    <p>
                        Other activities can be updated for the current date or past date between 01/01/19 - 12/31/19
