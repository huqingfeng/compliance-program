...
class CHW2016FEBCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW2016FEBComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $week1View->setReportName('Week 1 M-F - Feb. 29 - March 4');
        ...
        $week2View->setReportName('Week 2 M-T - March 21-22');
        ...
        $week3View->setReportName('Week 3 M-T - May 9-10');
        ...
        $quizLawsView = new CHW2016FEBCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365));
        ...
        $quizVitalView = new CHW2016FEBCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
    ...
    {
        $printer = new CHW2016FEBComplianceProgramReportPrinter();
...
class CHW2016FEBComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
