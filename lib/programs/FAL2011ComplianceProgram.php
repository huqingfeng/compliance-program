<?php
class FALScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class FAL2011CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class FALWorkshop2011 extends AttendCompanyWorkshopComplianceView
{
...
class FAL2011ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'All Core Actions are Required by '.date('F d, Y', $programEnd));
...
//
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new FALScreeningPrinter();
            ...
            $printer = new FAL2011ComplianceProgramReportPrinter();
        }
...
class FAL2011ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
    ...
    <p></p>
    <p>Welcome to the new My Rewards/To-Do Summary page that part of FAL’s Wellness Matters Benefit.</p>
    ...
    <ul>
        <li>You will save (avoid) <strong><u>$600</strong></u> or more in annual premium increases in 2012 if you/your
            family will have medical benefit coverage in 2012 through FAL.
        </li>
    </ul>
    <p><strong>Note: If you do not get 1A and 1B done by the deadline, your medical benefit premium contribution will
        increase
        $50 per month beginning January 2012 for 12 months. This increase would be above and beyond any possible rate
        increases due to increases in premiums FAL receives from the carrier.</strong></p>

    <p>In addition, by getting 1A and 1B done PLUS your other actions and points in #2 below:
    <ul>
        <li>You will benefit from improvements in health, health care and wellbeing – now and throughout life.</li>
