...
class Justrite2017ManufacturingAlternativeComplianceStatusMapper extends ComplianceStatusMapper
{
...
class JustriteManufacturing2017ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $this->setComplianceStatusMapper(new Justrite2017ManufacturingAlternativeComplianceStatusMapper());
        ...
        $numbers = new ComplianceViewGroup('points', 'Gain points through areas D-E below by the October 17th, 2017 deadline in order to receive a premium discount.');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new JustriteManufacturing2017ComplianceProgramReportPrinter();
        }
...
class JustriteManufacturing2017ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-ras_physician .result').html('<a href="https://services-ded9cdb3f9bc4a07b30c1bbfc414f56a.hpn.com/resources/9362/Justrite RAS Dr. form 2017.pdf">RAS Physician Verification Form</a>');
                ...
                $('.view-comply_with_bmi_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1160">View Result</a><br /><a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=3574">Complete 1 Body Metric Lesson</a>');
        ...
        <p>Welcome to your summary page for the 2017 Justrite Screening Criteria and Premium Discounts.
            <strong>The deadline to complete all actions is October 17th, 2017.</strong></p>
