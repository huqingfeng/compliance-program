...
class LDIIndustries2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new LDIIndustries2020ComplianceProgramReportPrinter();
    }
...
class LDIIndustries2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width: 48%; text-align: right">
                    <img src="/images/empower/ldi_logo.png" style="height:50px;"  />
                </div>
            </p>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 2/12/2021</th>
                        ...
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >0, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 3/19/2021.  You can
                                 <a href="/resources/10608/LDI_Industries_2021_AQF_111720.pdf" download="2021_AQF">download</a>
