...
class UCMC2016VisitHealthUComplianceView extends ComplianceView
{
    ...
    {
        return 'visit_health_u';
    }


    public function getDefaultReportName()
    {
        return 'Visit TotalHealthU for benefit details, changes & decision';
    }
...
class UCMC2016CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class UCMC2016ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new UCMC2016ComplianceProgramReportPrinter();
        }
    ...
    public function loadGroups()
    {
        ...
        $scrView = new UCMC2016CompleteScreeningComplianceView($coreStartDate, $coreEndDate);
...
//        $totalCholesterolView->setAttribute('_screening_printer_hack', 8);
        ...
        $visitHealthU = new UCMC2016VisitHealthUComplianceView($programStartDate, $programEndDate);
...
class UCMC2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    {
        $this->setScreeningResultsLink(new Link('Have your screening results in the healthy zone:', '/content/1094new2016#biometrics2a'));
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <style type="text/css">
            ...
            <?php if(!in_array($status->getUser()->insurance_plan_type, UCMC2016ComplianceProgram::$ppoType)) :  ?>
            .view-nav {
                display:none;
            }
            <?php endif ?>
        ...
        <script type="text/javascript">
            $(function() {
                $('.headerRow-numbers').after(
                    '<tr><td><strong>A</strong>. <a target="_self" href="/content/1094new2016#biometrics2a">Have your screening results in the healthy zone:</a>' +
                    ...
                    '<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=701">View All 8 Results after screening results are received.</a>' +
                    '</td></tr>');
                ...
                $('.view-activity_26').children(':eq(0)').html('<strong>B</strong>. <a href="/content/1094new2016#prevScreen2b">Get Recommended Preventive Screenings/Exams</a>');
                $('.view-activity_242').children(':eq(0)').html('<strong>C</strong>. <a href="/content/1094new2016#immun2c">Get Flu Shot & Other Recommended Immunizations</a>');
                $('.view-physical_activity').children(':eq(0)').html('<strong>D</strong>. <a href="/content/1094new2016#physAct2d">Get Regular Physical Activity</a>');
                $('.view-stress').children(':eq(0)').html('<strong>E</strong>. <a href="/content/1094new2016#stress2e">Complete the Adapting to Stress Skill Builder</a>');
                $('.view-step_it_up').children(':eq(0)').html('<strong>F</strong>. <a href="/content/1094new2016#siu2f">Participate in 2015 Step It Up and meet Step Goal</a>');
                $('.view-thc').children(':eq(0)').html('<strong>G</strong>. <a href="/content/1094new2016#thc2g">Complete the 2016 Total Health Challenge (January-March)</a>');
                $('.view-weight').children(':eq(0)').html('<strong>H</strong>. <a href="/content/1094new2016#weight2h">Verify Qualified Actions Taken to Achieve a Healthy Weight</a>');
                $('.view-complete_elearning_additonal').children(':eq(0)').html('<strong>I</strong>. <a href="/content/1094new2016#addelearn2i">Additional e-Learning Lessons</a>');
                $('.view-eap').children(':eq(0)').html('<strong>J</strong>. <a href="/content/1094new2016#class2j">Attend EAP or UCMC Wellness class</a>');
                $('.view-activity_503').children(':eq(0)').html('<strong>K</strong>. <a href="/content/1094new2016#donate2k">Donate Blood</a>');
                $('.view-aha').children(':eq(0)').html('<strong>L</strong>. <a href="/content/1094new2016#walkingDay2l">AHA National Walking Day</a>');
                $('.view-aha').children('.links').html('<a target="_blank" href="/resources/7577/WalkingDayFlyer.pdf">National Walking Day Flyer</a>');

                $('.view-activity_506').children(':eq(0)').html('<strong>M</strong>. <a href="/content/1094new2016#fitness2m">Self-Directed Fitness Activity</a>');
                $('.view-cubicle').children(':eq(0)').html('<strong>N</strong>. <a href="/content/1094new2016#cubicle2n">Cubicle to 5K</a>');
                $('.view-fitbit').children(':eq(0)').html('<strong>O</strong>. <a href="/content/1094new2016#70kSteps2o">Log 70,000 steps a week</a>');
                $('.view-activity_24').children(':eq(0)').html('<strong>P</strong>. <a href="/content/1094new2016#vol2p">Volunteer Time to Help Others - Type & Time</a>');
                $('.view-bicycle').children(':eq(0)').html('<strong>Q</strong>. <a href="/content/1094new2016#bicycle2q">Bicycle Commuter Program</a>');
                $('.view-nav').children(':eq(0)').html('<strong>R</strong>. <a href="/content/1094new2016#healthNav2r">Check My HealthNavigator online health record (PPO only)</a>');
                $('.view-care').children(':eq(0)').html('<strong>S</strong>. <a href="/content/1094new2016#hcs2s">Work with HealthReach Care Counselor/Coach or Graduate</a>');
                $('.view-visit_health_u').children(':eq(0)').html('<strong>T</strong>. Visit TotalHealthU for benefit details, changes & decision');

                $('.view-visit_health_u').children(':eq(3)').html('<a target="_blank" href="/content/visit-health-u">Visit TotalHealthU</a>');
                ...
                $('tr.view-complete_screening .links').html('<a target="_self" href="/content/1094nh#annScreen1a">Schedule/Options</a> <a target="_self" href="/wms2/compliance/ucmc-2016-2017/my-health">Results</a>');
                <?php else: ?>
                $('tr.view-complete_screening .links').html('<a href="/content/1051">Screening Sign-Ups</a> <br /><a target="_self" href="/wms2/compliance/ucmc-2016-2017/my-health">Results</a>');
                <?php endif ?>

                <?php if($isNewHire) : ?>
                $('tr.view-required_elearning').children(':eq(0)').html('<strong>E</strong>. <a href="/content/1094nh#eLearn1d">Complete 3 Required e-Learning Lessons (First two lessons and the appropriate UCMC New Hire Benefit Enrollment Overview 2016-17)</a>');
                <?php else : ?>
                $('tr.view-required_elearning').children(':eq(0)').html('<strong>E</strong>. <a href="/content/1094new2016#eLearn1e">Complete 3 Required e-Learning Lessons (All 3 Lessons Now Available)</a>');
                <?php endif ?>
            });
        </script>
        ...
        <div>
            <div>
                <?php if($isNewHire) : ?>
                    ...
                    <p>Employees meeting all of the requirements below who enrolled in any 2016-2017 UCMC
                        Medical Insurance Plan will receive a per-pay-period credit on their health insurance
                        premium ($400 annually). Employees meeting the criteria that have elected not to enroll in
                        any 2016 medical Insurance Plan, or are ineligible for benefits, will receive a $50 gift card.
                        (<a href="http://www.hallmarkbusinessconnections.com/merchant-list">Click here to view merchants</a>)
                    </p>
                ...
                <?php else : ?>
                    ...
                    <p>
                        Employees meeting all of the requirements below who enrolled in any 2016-2017 UCMC Medical
                        Insurance Plan will receive a per-pay-period credit on their health insurance premium
                        (up to $400 annually). Employees meeting the criteria that have elected not to enroll
                        in a 2016 medical plan, or are ineligible for benefits, will receive a $50* gift card
        ...
        <div class="pageHeading">
            <a href="/content/<?php echo $isNewHire ? '1094nh' : '1094new2016' ?>">Click here for all details about the 2016-2017 Well Rewards benefit.</a>
            <a href="/content/<?php echo $isNewHire ? '1094nh' : '1094new2016' ?>#faqs">FAQ Page</a>
        </div>
...
class UCMC2016ScreeningTestPrinter extends ScreeningProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <table width="100%"
            ...
            <tr>
                ...
                <td bgcolor="#CCFFCC" style="text-align:center">15 points</td>
            ...
            <tr>
                ...
                <td bgcolor="#FFFF00"><div align="center">5.7 - &lt;6.5</div>
