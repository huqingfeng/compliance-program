...
class Android2013ComplianceProgram extends ComplianceProgram
{
...
class Android2013Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p>
        <a href="/compliance_programs/index?id=204">
            View your 2012 Program
        </a>
    </p>
    <p>
        At Android, your health matters! We have created the following report card
        for you to easily access your wellness incentive status. To see the details of the 2013 incentive program, please <a href="/content/program_overview">Click Here</a>.

      <p>  If you participated in the 2012 screenings, <a href="/compliance_programs?id=264">CLICK HERE</a> to view the new report card populated with those screening results.  This is only a sample .   The report card below will populate following the upcoming screenings and will determine your 2014 incentive.</p>
