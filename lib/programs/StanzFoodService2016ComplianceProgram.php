...
class StanzFoodService2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new StanzFoodService2016ComplianceProgramReportPrinter;
    }
...
class StanzFoodService2016ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
    ...
    public function printClientMessage()
    {
        ...
        <p><strong>Step 2</strong>- Complete your Health Risk Assessment (HRA) Questionnaire by October 30, 2015. <a href="/content/1006">Click here </a> to complete your HRA if you have not done so already. Your current status for each are summarized below.</span></p>
