...
class Auxiant2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Auxiant2020ComplianceProgramReportPrinter();
    }
...
class Auxiant2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width: 48%; text-align: right">
                    <img src="/images/empower/auxiant_logo.png" style="height:60px;"  />
                </div>
            </p>
            ...
            <div style="margin-left:10px;">
                ...
                <p>
                    Thank you for your participation in the Empower Health screening program.
                </p>

                <p>
                    Through this program, each participant is provided with an overall health risk score and a personal
                    health risk score goal.
                </p>

                <p>
                    To earn the full incentive this year, participants must complete the health risk assessment and the
                     biometric screening by January 29, 2021.
                </p>

                <p>
                    In order to earn the full incentive for next year, participants will need to achieve an overall
                     health risk score of 0 or less or meet their personal health risk score goal .
                </p>

                <p>The chart below indicates your current overall risk score and establishes what your goal for next year's screening is.</p>
            </div>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 1/29/2021</th>
