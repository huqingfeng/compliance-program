...
class UCMC2021ReportCardVisitHealthUComplianceView extends ComplianceView
{
...
class UCMC2021ReportCardCompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class UCMC2021CoreReportCardComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $dir = isset($_GET['year']) && $_GET['year'] == 2018 ? 'ucmc2018' : 'ucmcCore';
        if ($_GET['view'] == "ajax") {
            ...
            $url = $domain."wms3/public/ucmcCore?bypass=true&wms1Id=".$wms1Id."&wms2Id=".$wms2Id."&wms2Account=".$wms2Account."&program_id=". $_GET['id']."&view=". $_GET['view'];
            $url.= isset($_GET['year']) ? '&year='.$_GET['year'] : '';
...
class UCMC2021ReportCardComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
class UCMC2021ReportCardScreeningTestPrinter extends ScreeningProgramReportPrinter
{
