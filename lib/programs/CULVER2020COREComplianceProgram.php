...
class CULVER2020ReportCardVisitHealthUComplianceView extends ComplianceView
{
...
class CULVER2020ReportCardCompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class CULVER2020CoreReportCardComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if ($_GET['view'] == "ajax") {
            $url = $domain."wms3/public/culver_core?bypass=true&clientId=ucmc&token=7bc9b94d-8a55-410c-bec8-4787d02c0e7b&view=ajax&wms1Id=$wms1Id&action=".$_GET['action']."&value=".$_GET['value']."&category=".$_GET['category'];
            ...
            $url = $domain."wms3/public/culver_core?bypass=true&view=culver&relationship=".$relationship($_GET['relationship'])."&wms1Id=".$wms1Id."&wms2Id=".$wms2Id."&wms2Account=".$wms2Account."&contactInfoUpdated=".$lastUpdated;
...
class CULVER2020ReportCardComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
class CULVER2020ReportCardScreeningTestPrinter extends ScreeningProgramReportPrinter
{
