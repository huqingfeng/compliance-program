...
class GVT2009ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new GVT2009Printer();
...
class GVT2009Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p>
        ...
        fulfilling your requirement. By completing the following steps in 2010
        you will be eligible for a premium reduction in your health plan
        effective 01/01/2011.</p>
    <p>
        ...
        Screenings will be scheduled again beginning in August/September of 2010
    ...
    <p>
        ...
        based on your 2010 health screening results. If you have a medical reason
        for not being able to reach one or more of the requirements listed below,
        you can contact Mary Vallandingham in Human Resources to discuss a
