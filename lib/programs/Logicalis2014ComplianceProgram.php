...
class Logicalis2014ComplianceProgram extends ComplianceProgram
{
  ...
  {
    return new Logicalis2014ComplianceProgramReportPrinter();
  }
}

class Logicalis2014ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
