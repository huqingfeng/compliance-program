...
class SBMF2017BMIMaintainComplianceView extends DateBasedComplianceView
{
...
class SBMF2017BMIReductionBonusComplianceView extends DateBasedComplianceView
{
    public function __construct($start, $end)
    {
        $this->setStartDate($start);
...
class SBMF2017LifestyleProgramOne extends PlaceHolderComplianceView
{
}

class SBMF2017LifestyleProgramTwo extends PlaceHolderComplianceView
{
}

class SBMF2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new SBMF2017ComplianceProgramReportPrinter();
...
//        $tcLearn->setEvaluateCallback($this->constructCallback($totalOrRatioView));
        ...
        $bmiReductionView = new SBMF2017BMIReductionBonusComplianceView($programStart, $programEnd);

        $bmiMaintain = new SBMF2017BMIMaintainComplianceView($programStart, $programEnd);
...
//        $bmiLearn->setEvaluateCallback($this->constructCallback($bmiReductionView));
    ...
    const ACTIVITY_RECORD_ID = 1215;
    //const ACTIVITY_RECORD_ID = 1004;
}

class SBMF2017ComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    public function printClientMessage()
    {
        ...
        <div id="programMessage" style="margin-top:20px;">
            <p>By completing the following steps in 2017 you will be eligible for the wellness incentive offered in 2018:</p>
            <ul><li><strong>Step 1: </strong>Complete your physical exam, HRA, and blood draw by August 31, 2017.</li><li><strong>Step 2: </strong>
                    You will again have the opportunity to earn incentive points in 2017.
                    You will need to obtain a minimum of 9 incentive points to be eligible for the wellness incentive
                    offered in 2018. You are not required to meet the target range for each individual measure. The
                    ...
                    exception form to Circle Wellness. As long as you accumulate a total of 9 points by 10/31/2017,
                    you will be eligible for the wellness incentive offered for the 2018 plan year.
                </li></ul>
        ...
        <div id="showmeMore" class="hide"><div><p>Incentive Points can be earned in each of the following categories: </p><ul><li><strong>Smoking Status: </strong>Maintain non-smoker status or participate in the Quit for Life Smoking Cessation program.</li><li><strong>Health Profile Measurements: </strong>
                        ...
                        bonus points can be earned by maintaining or reducing your BMI from your 2016 screening.
    ...
    public function printClientNote()
    {
        ...
        <p>
            ...
            an <a href="https://static.hpn.com/wms2/documents/clients/sbmf/SBMF%20Verifcation%20%20Exception%20Form%20-%202017.pdf">exception form</a>
