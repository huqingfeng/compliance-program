...
class MattersightCorporationLearningAlternative2017ComplianceView extends ComplianceView
{
...
class MattersightCorporation2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new MattersightCorporation2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '10/13/17');
        ...
        $hraView->setAttribute('goal', '10/13/17');
...
class MattersightCorporation2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>Earning the incentive this year involves completing a wellness screening, the Empower Health
                ...
                your name will be on a list that is sent to Mattersight Corporation for everyone earning the
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/9745/Mattersight_AQForm_81717.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN October 27, 2017</strong>
                            </td>
                         <?php endif ?>
                    </tr>
