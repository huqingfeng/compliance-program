...
class Justrite2018ManufacturingAlternativeComplianceStatusMapper extends ComplianceStatusMapper
{
...
class JustriteManufacturing2018ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $this->setComplianceStatusMapper(new Justrite2018ManufacturingAlternativeComplianceStatusMapper());
        ...
        $numbers = new ComplianceViewGroup('points', 'Gain points through areas D-E below by the October 17th, 2018 deadline in order to receive a premium discount.');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new JustriteManufacturing2018ComplianceProgramReportPrinter();
        }
...
class JustriteManufacturing2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-ras_physician .result').html('<a href="/resources/9941/Justrite RAS Dr. form 2018.pdf">RAS Physician Verification Form</a>');
                ...
                $('.view-comply_with_bmi_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1319">View Result</a><br /><a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=3574">Complete 1 Body Metric Lesson</a>');
        ...
        <p>Welcome to your summary page for the 2018 Justrite Screening Criteria and Premium Discounts.
            <strong>The deadline to complete all actions is October 17th, 2018.</strong></p>
