...
class SBMF2019BMIMaintainComplianceView extends DateBasedComplianceView
{
...
class SBMF2019BMIReductionBonusComplianceView extends DateBasedComplianceView
{
    public function __construct($start, $end)
    {
        $this->setStartDate($start);
...
class SBMF2019LifestyleProgramOne extends PlaceHolderComplianceView
{
}

class SBMF2019LifestyleProgramTwo extends PlaceHolderComplianceView
{
}

class SBMF2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new SBMF2019ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $preventionEventGroup = new ComplianceViewGroup('Health Risk Appraisal Status');
        $preventionEventGroup->setName('prevention_event');

        $hraScreeningView = new CompleteHRAAndScreeningSeparateDateComplianceView("2019-03-01", '2019-08-31', $programStart, $programEnd);
        ...
        $biometricsGroup = new ComplianceViewGroup('Physician Measurements & Laboratory Results');
...
//        $tcLearn->setEvaluateCallback($this->constructCallback($totalOrRatioView));
        ...
        $bmiReductionView = new SBMF2019BMIReductionBonusComplianceView($programStart, $programEnd);

        $bmiMaintain = new SBMF2019BMIMaintainComplianceView($programStart, $programEnd);
        $bmiMaintain->setReportName('BMI Maintained');
        $bmiMaintain->setName('bmi_maintain');
        $bmiMaintain->setStatusSummary(ComplianceStatus::COMPLIANT, 'BMI Unchanged from 2018');
...
//        $bmiLearn->setEvaluateCallback($this->constructCallback($bmiReductionView));
        ...
        $activitiesGroup = new ComplianceViewGroup('Additional Incentive Activities (Optional)');

        $activitiesView = new PlaceHolderComplianceView(null, 0);
        $activitiesView->setName('activities_points');
        $activitiesView->setReportName('Additional Incentive Activities (Optional)');
        $activitiesView->addLink(new Link('Additional Incentive Activities (Optional)', '/compliance/sbmf-2019/my-activities/compliance_programs?id=1431'));
    ...
    const ACTIVITY_RECORD_ID = 1431;
}

class SBMF2019ComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    public function printClientMessage()
    {
        ...
        <div id="programMessage" style="margin-top:20px;">
            <p>By completing the following steps in 2019 you will be eligible for the wellness incentive offered in 2020:</p>
            <ul><li><strong>Step 1: </strong>Have your Physician Biometric Consent form, HRA and blood draw completed by August 31, 2019.</li><li><strong>Step 2: </strong>
                    You will again have the opportunity to earn incentive points in 2019.
                    You will need to obtain a minimum of 9 incentive points to be eligible for the wellness incentive
                    offered in 2020. You are not required to meet the target range for each individual measure. The
                    ...
                    exception form to Circle Wellness. As long as you accumulate a total of 9 points by 10/31/2019,
                    you will be eligible for the wellness incentive offered for the 2020 plan year.
                </li></ul>
            <p><a href="#" id="showmeMoreTrigger">More</a></p>
        </div>

        <div id="showmeMore" class="hide">
            <div>
                <p>Incentive Points can be earned in each of the following categories: </p>
                <ul>
                    <li><strong>Smoking Status: </strong>Maintain non-smoker status.</li>
                    <li><strong>Health Profile Measurements: </strong>
                        ...
                        bonus points can be earned by maintaining or reducing your BMI from your 2018 screening.
                        <span class="text-danger"> *</span></li></ul>
            </div>
        </div>
    ...
    public function printClientNote()
    {
        ...
        <p>
            <strong>Note:</strong>
            You must complete the physician’s biometric screening, health risk appraisal and wellness laboratory testing
            for the wellness incentive offered in 2020. Points will be awarded for completing the annual physical exam
            and successfully meeting the biometric benchmarks
        </p>
        <p>
            ...
            an <a href="/resources/10335/SBMF_Verifcation_Exception_Form_2019.pdf">exception form</a>
    ...
    protected function printTotalStatus()
    {
        ...
        <div class="wms2_section">
            <div class="wms2_row">
                <div class="wms2_title open closed">Total Incentive Points Earned <span class="triangle"></span></div>
