...
class LincolnElectric2019CompleteScreeningView extends CompleteScreeningComplianceView
{
...
class LincolnElectric2019HomePageComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $screeningFormView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use($screeningFormView) {
            ...
            $status->getComplianceView()->addLink(new Link('Download Form', '/resources/10328/2020_Healt_Linc_Wellness_Program_Preventive_Care_Form_FINAL.pdf', false, '_blank'));
...
class LincolnElectric2019ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $screeningView = new LincolnElectric2019CompleteScreeningView($programStart, $programEnd);
        ...
        $screeningView->addLink(new Link('<br />Download Form', '/resources/10328/2020_Healt_Linc_Wellness_Program_Preventive_Care_Form_FINAL.pdf'));
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new LincolnElectric2019ComplianceProgramReportPrinter();
...
class LincolnElectric2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="pageHeading">2020 HealthLinc Workplace Wellness Program</div>
