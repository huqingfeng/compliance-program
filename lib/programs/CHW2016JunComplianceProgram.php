...
class CHW2016JunCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW2016JunComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $quizLawsView = new CHW2016JunCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365));
        ...
        $quizVitalView = new CHW2016JunCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
    ...
    {
        $printer = new CHW2016JunComplianceProgramReportPrinter();
...
class CHW2016JunComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
