...
class ZellerLearningAlternativeComplianceView extends ComplianceView
{
    ...
    {
        return 'zeller_plastik_alt_'.$this->alias;
    }
...
class ZellerPlastik2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new ZellerPlastik2018ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new CompleteScreeningComplianceView($programStart, '2019-11-29');
        ...
        $screeningView->setAttribute('goal', '11/29/19');
        ...
        $bmiView->overrideTestRowData(null, null, 29.99, null);
        $bmiView->emptyLinks();
        ...
        $gluView->overrideTestRowData(null, null, 99.99, null);
        $gluView->emptyLinks();
        ...
        $hdlRatioView->setAttribute('goal', '< 5.1');
        ...
        $totalCholesterolView->setReportName('5. Total Cholesterol');
        $totalCholesterolView->overrideTestRowData(null, null, 200, 201);
        $totalCholesterolView->emptyLinks();
        $totalCholesterolView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(1, 0, 0, 0));
        $totalCholesterolView->setAttribute('screening_view', true);
        $totalCholesterolView->setAttribute('goal', '< 201');
        $group->addComplianceView($totalCholesterolView);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $biometricStatus = $status->getComplianceViewStatus('biometrics');
        if($screeningStatus->getStatus() == ComplianceViewGroupStatus::COMPLIANT
...
class ZellerPlastik2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right;">
                    <img src="https://static.hpn.com/resources/10182/RPC-Zeller_Libertyville_Logo_2018.jpg" /><br />
                </div>
            </p>
            ...
            <p>Zeller Plastik is committed to encourage and help support the health, care and wellbeing
            ...
            <p>Earning the incentive this year requires completing a wellness screening and getting certain results in a goal range. These requirements, your results
                and incentive status are in the table below.  When you meet the required goals for the incentive,
                your name will be on a list that is sent to Zeller Plastik for everyone earning the
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr>
                        <th rowspan="2">Meet the Goals (Get a Yes) for A1 and B6 <br /> to receive the incentive.</th>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10329/2019_RPC_Zeller_Plastik_AQF_020719.pdf" target="_blank">Alternate Qualification Form</a>
