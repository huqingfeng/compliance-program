...
class MTIActivities2019Q1WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '01/01/2019 through 01/06/2019',
        2 => '01/07/2019 through 01/13/2019',
        3 => '01/14/2019 through 01/20/2019',
        4 => '01/21/2019 through 01/27/2019',
        5 => '01/28/2019 through 02/03/2019',
        6 => '02/04/2019 through 02/10/2019',
        7 => '02/11/2019 through 02/17/2019',
        8 => '02/18/2019 through 02/24/2019',
        9 => '02/25/2019 through 03/03/2019',
        10 => '03/04/2019 through 03/10/2019',
        11 => '03/11/2019 through 03/17/2019',
        12 => '03/18/2019 through 03/24/2019',
        13 => '03/25/2019 through 03/31/2019'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2019-01-01', '2019-03-31');
...
class MTIActivities2019Q1ComplianceProgram extends ComplianceProgram
{
    const MTI_2019Q1_ACTIVITY_START_DATE = '2019-01-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2019Q1WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2019Q1WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2019Q1WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2019Q1_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2019Q1ComplianceProgram::MTI_2019Q1_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
