...
class Kolcraft2019RunWalkComplianceView extends CompleteArbitraryActivityComplianceView
{
...
class Kolcraft2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>We are excited to introduce a Wellness Rewards Program here at Kolcraft, beginning July 1, 2019. We hope this
        ...
        <p>In 2019, employees reaching the necessary number of points will receive a discount on their 2020 health insurance
        ...
        <p>In order to earn a premium discount, you must earn 275 points or more by December 17, 2019. You can earn these
...
class Kolcraft2019ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new Kolcraft2019ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalFirstHalfView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2019-07-01', '2019-12-17'), array(), 275);
        $totalFirstHalfView->setReportName('<strong>By 12/17/2019</strong>');
        $totalFirstHalfView->setName('total_first_half');
        $totalsGroup->addComplianceView($totalFirstHalfView);

        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2019-07-01', '2020-06-30'), array(), 450);
        $totalView->setReportName('<strong>By 06/30/2020</strong>');
    ...
    public function loadGroups()
    {
        ...
        $walkRun = new Kolcraft2019RunWalkComplianceView($startDate, $endDate, 37071, '5k/10k Walk or Run');
        ...
        $triathlon = new Kolcraft2019RunWalkComplianceView($startDate, $endDate, 37071, 'Triathlon/Biathlon');
        ...
        $halfMarathon = new Kolcraft2019RunWalkComplianceView($startDate, $endDate, 37071, 'Half Marathon');
        ...
        $marathon = new Kolcraft2019RunWalkComplianceView($startDate, $endDate, 37071, 'Marathon');
