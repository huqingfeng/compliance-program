...
class ShapeCoaching2017FitnessLogComplianceView extends ComplianceView
{
    ...
    {
        $record = $user->getNewestDataRecord('shape_coaching_2017_new', true);
...
class ShapeCoaching2017FitnessMinutesForm extends BaseForm
{
...
class ShapeCoaching2017ComplianceProgramAdminReportPrinter extends BasicComplianceProgramAdminReportPrinter
{
...
class ShapeCoaching2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new ShapeCoaching2017ComplianceProgramAdminReportPrinter();
    ...
    {
        return new ShapeCoaching2017WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $consultationTwoView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(4, 0, 0, 0));
        ...
        $consultationThreeView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(4, 0, 0, 0));
        ...
        $consultationFourView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(4, 0, 0, 0));
...
//            });
        ...
        foreach(self::getFitnessMonths() as $month) {
            $fitnessView = new ShapeCoaching2017FitnessLogComplianceView($month);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $elearningStartDate = '2017-07-01';
        $elearningEndDate = '2018-03-01';
    ...
    public function executeFitnessLogs(sfActions $actions)
    {
        ...
        $fitnessForm = new ShapeCoaching2017FitnessMinutesForm(array(), array('user' => $user));
        $dates = ShapeCoaching2016ComplianceProgram::getFitnessDates();
        ...
        if($fitnessForm->isValidForRequest($actions->getRequest())) {
            $record = $user->getNewestDataRecord(self::SHAPE_2017_FITNESS_RECORD_TYPE, true);
        ...
        $record = $user->getNewestDataRecord(self::SHAPE_2017_FITNESS_RECORD_TYPE);
        $lastMonth = date('F', strtotime("first day of last month"));
        $thisMonth = date('F');
    ...
    const SHAPE_2017_COACHING_START_DATE = '2015-06-01';
    const SHAPE_2017_COACHING_END_DATE = '2016-05-14';

    const SHAPE_2017_FITNESS_RECORD_TYPE = 'shape_coaching_2017_new';
}


class ShapeCoaching2017WMS2Printer implements ComplianceProgramReportPrinter
{
            ...
            <tr class="picker closed">
                ...
                <td class="pct">
                    <?php if($name == 'Activity Minutes') : ?>
                        <a href="/compliance_programs/localAction?id=1221&local_action=fitness_logs" target="_blank">Log Activity Minutes</a>
                    ...
                    <?php elseif($name == 'Wellness Workshops' || $name == "Documentary") : ?>
                        <a href="/resources/9561/Cheat Sheet - Point Options.pdf" target="_blank">View Details</a>
                    <?php elseif($name == 'Book Club') : ?>
                        <a href="#" class="book-club" target="_blank">View Details</a>
                    <?php elseif($name == 'Wellness Classes') : ?>
                        <a href="/resources/9555/FF_BR July-Oct 2017.pdf" target="_blank">View Details</a>
                    <?php endif ?>
                </td>
            </tr>
...
?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="header-text">
                    <p>You must complete at least 20 points between July 1, 2017 and February 28, 2018 in order to stay compliant.</p>

                    <p>You must have 2 consultations with your Wellness Coach - one between July 1, 2017 and October 31, 2017, and another between November 1, 2017 and February 28, 2018.</p>

                    <p>At least one consultation must be done in person.</p>

                    <p>20 additional points (40 total) are required to earn the $50.00 Wellness Credit.</p>

                    <?php echo $status->getAttribute('coach_name') ? "<p>My coach is {$status->getAttribute('coach_name')}</p>" : '' ?>

                    <p><a href="https://static.hpn.com/wms2/documents/clients/shape/Cheat%20Sheet%20-%20How%20to%20Earn%20Your%20Points%20-%202017.pdf" target="_blank">How do I earn my points?</a></p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-3 text-center">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row hide div-<?php echo $bonus_points; ?>">
                                        <div class="col-xs-8 col-xs-offset-2 col-md-10 col-md-offset-1">
                                            <div class="circle-range">
                                                <div class="circle-range-inner circle-range-inner-success">
                                                    <div style="font-size: 1.3em; line-height: 1.2em;">$50<br/>Wellness<br/>Bonus</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-8 col-xs-offset-2 col-md-10 col-md-offset-1">
                                            <div class="clearfix" style="position: relative">
                                                <div style="position: absolute; z-index: 5000; left:40px; top: 35px; font-size: 1.3em; line-height: 1.2em;" class="hide-at-<?php echo $bonus_points; ?>">$50<br>Wellness<br>Bonus</div>
                                                    <div style="font-size: 150px;" class="c100 p<?php echo $bonus_points; ?>">
                                                        <span></span>
                                                        <div class="slice">
                                                            <div class="bar"></div>
                                                            <div class="fill"></div>
