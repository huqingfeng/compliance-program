...
class ICar2016ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new ICar2016ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $hraScreeningEndDate = '2016-11-30';

        $hraScreening = new CompleteHRAAndScreeningComplianceView($hraScreeningStartDate, $hraScreeningEndDate);
        ...
        $hraScore70 = new HraScoreComplianceView($hraScreeningStartDate, $hraScreeningEndDate, 70);
        ...
        $hraScore80 = new HraScoreComplianceView($hraScreeningStartDate, $hraScreeningEndDate, 80);
        ...
        $hraScore90 = new HraScoreComplianceView($hraScreeningStartDate, $hraScreeningEndDate, 90);
        ...
        $tcView = new ComplyWithTotalCholesterolScreeningTestComplianceView($hraScreeningStartDate, $hraScreeningEndDate);
        ...
        $hdlView = new ComplyWithHDLScreeningTestComplianceView($hraScreeningStartDate, $hraScreeningEndDate);
        ...
        $ldlView = new ComplyWithLDLScreeningTestComplianceView($hraScreeningStartDate, $hraScreeningEndDate);
        ...
        $triglyceridesView = new ComplyWithTriglyceridesScreeningTestComplianceView($hraScreeningStartDate, $hraScreeningEndDate);
        ...
        $glucoseView = new ComplyWithGlucoseScreeningTestComplianceView($hraScreeningStartDate, $hraScreeningEndDate);
        ...
        $phyExam->emptyLinks();
        $phyExam->addLink(new Link('Verification form', '/resources/7727/2016_PreventiveCare Cert (1).pdf'));
        ...
        $prevServ->addLink(new Link('Verification form', '/resources/7727/2016_PreventiveCare Cert (1).pdf'));
        ...
        $fluShot->addLink(new Link('Verification form', '/resources/6821/2015-16_PreventiveCare Cert.pdf'));
        ...
        $Lnl->setMaximumNumberOfPoints(30);
        ...
        $smoking->addLink(new Link('Verification Form', '/resources/7730/2016_WellnessEventCert (1).pdf'));
        ...
        $bikeChallenge->setMaximumNumberOfPoints(15);
        $bikeChallenge->setAttribute('points_per_activity', '15');
        $bikeChallenge->setName('national_bike_challenge');
        $bikeChallenge->setStatusSummary(ComplianceStatus::COMPLIANT, 'Join the I-CAR team and participate in the National Bike Challenge');
        ...
        $fiveK->addLink(new Link('Verification Form', '/resources/7730/2016_WellnessEventCert (1).pdf'));
...
class ICar2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-complete_screening_hra').children('td:eq(5)').html(
                    '<a href="/content/1051">Sign up</a> <br />' +
                    '<a href="/content/989">Results</a> <br />' +
                    '<a href="/content/989">Take HPA</a> <br />' +
                    '<a href="/resources/7724/I-CAR MD Form 2016.pdf" target="_blank">Dr. Option Form</a>'
                );

                $('.view-hra_score_70').children('td:eq(0)').html('');
                $('.view-hra_score_70').children('td:eq(0)').attr('rowspan', 9);
                $('.view-hra_score_70').children('td:eq(5)').html('<a href="/content/989">Results</a>');
                ...
                $('.view-health_documentary').children('td:eq(0)').html('<strong>C</strong>. MultiMedia Learning');
                ...
                $('.view-10_weeks_steps').children('td:eq(0)').html('<strong>A</strong>. Wellness Walking Challenge' +
                    '<br /><br /><span style="font-size:8pt;">Challenge: June 1 – August 31, 2016</span>');
                ...
                $('.view-national_bike_challenge').children('td:eq(0)').html('<strong>B</strong>. National Bike Challenge' +
                    '<br /><br /><span style="font-size:8pt;">Challenge: May - September</span>');
        ...
        <p><strong>All Employees that complete the Wellness Screening and Health Assessment Questionnaire are
            ...
            health activities between <strong>1/1/16 – 11/30/16.</strong></p>
        ...
        <table style="width:100%" id="status-table">
            ...
            <tr>
                ...
                <td>
                    <span style="font-weight: normal;">All QUALIFIED participants will receive an I-CAR Giveaway</span>
                </td>
            </tr>
            <tr>
                <td>June 30, 2016</td>
        ...
        <p style="text-align:center;color:red; padding: 10px 0;">Compliance will be reported monthly.
            All employees achieving recognition status will be announced on the Employee Self Service portal in
            Paylocity and receive a certificate of achievement.
        </p>
