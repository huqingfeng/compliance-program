...
class XrayTechnologiesSpouse2017ComplianceProgram extends ComplianceProgram
{
...
//            $data['Has Biometric Override'] = $status->getAttribute('has_biometric_override') ? 'Yes' : 'No';
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2', true)) {
            return new XrayTechnologiesSpouse2017WMS2Printer();
        } else {
            $printer = new XrayTechnologiesSpouse2017Printer();
    ...
    public function loadGroups()
    {
        ...
        $hraView->setName('hra');
        $hraView->emptyLinks();
        $hraView->setAttribute('deadline', '11/30/2016');
        ...
        $screeningView = new CompleteScreeningComplianceView('2016-06-01', '2016-11-30');
        ...
        $screeningView->setAttribute('deadline', '11/30/2016');
        ...
        $coachingOverall->setAttribute('deadline', '05/31/2017');
        $coachingOverall->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            $notRequired = SelectQuery::create()
                ...
                ->andWhere('compliance_program_record_id = ?', array(XrayTechnologiesSpouse2017ComplianceProgram::XRAYTECHNOLOGIES_SPOUSE_2016_RECORD_ID))
        ...
        $coachingSession1->setAttribute('deadline', '05/31/2017');
        ...
        $coachingSession2->setAttribute('deadline', '05/31/2017');
        ...
        $employeeParticipation->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if(!$employeeUser)  {
                ...
                $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologiesSpouse2017ComplianceProgram::XRAYTECHNOLOGIES_SPOUSE_2016_RECORD_ID)->getComplianceProgram();
                ...
                if($screeningStatus->getStatus() == ComplianceViewStatus::COMPLIANT) {
                    $numCompliant++;
                }
...
//        $biometricsGroup->addComplianceView($smokingView);
        ...
        $fiveForFiveIgnoredUsers = XrayTechnologiesEmployee2017ComplianceProgram::getFiveForFiveIgnoredUsers();

        $getUpAndGO = new PlaceHolderComplianceView(ComplianceViewStatus::NOT_COMPLIANT);
        ...
        $fiveForFiveView = new XrayFiveForFive2016ComplianceView();
    ...
    const XRAYTECHNOLOGIES_SPOUSE_2016_RECORD_ID = 816;
}

class XrayTechnologiesSpouse2017Printer  extends CHPStatusBasedComplianceProgramReportPrinter
{
...
class XrayTechnologiesSpouse2017WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $textForEmployeeStatus = function($status, $isCoaching = false, $comment = null) {
                        ...
                        <?php if($viewStatus->getComplianceView()->getName() == 'employee_participation') : ?>
                            <?php if($viewStatus->getAttribute('has_employee')) : ?>
                                ...
                                <tr class="view-employee_participation_hra">
                                    <td class="name">
                                        <span style="padding-left: 20px;">• Employee HRA</span>
                                    </td>
                                ...
                                <tr class="view-employee_participation_screening">
                                    <td class="name">
                                        <span style="padding-left: 20px;">• Employee Screening</span>
                                    </td>
                                ...
                                <tr class="view-employee_participation_coaching">
                                    ...
                                    <td class="points <?php echo $classForStatus($viewStatus->getAttribute('employee_coaching_status')) ?>"
                                        ...
                                        <?php echo $textForEmployeeStatus($viewStatus->getAttribute('employee_coaching_status'), true, $viewStatus->getAttribute('employee_coaching_comment')) ?>
                                    </td>
                                    <td>05/31/2017</td>
                                    <td class="links text-center">
                                    </td>
            ...
            <div class="col-md-12">
                ...
                <div id="more-info">
                    <div class="row">
                        <div class="col-md-12">
                            <p>
                                Welcome to the 2017 X-Ray Industries Wellness Program. In order to qualify for the $600 incentive in
                                2017, employees who are on the medical plan and are participating in wellness must meet 4 objectives
                                to qualify for the 2017 incentive. Spouses on the medical plan will only be required to meet
                                requirements 1, 2 and 3 to qualify for the 2017 incentive.
                            </p>
                            <ul style="list-style: decimal">
                                <li>Complete an online Health Risk Assessment by <strong>November 30, 2016</strong>.</li>
                                <li>Complete an onsite Health Screening by <strong>November 30, 2016</strong>.*</li>
                                <li><strong>If notified by Circle Wellness</strong>, you must complete 2 coaching contacts by May 31, 2017 or you will lose the incentive effective June 1, 2017.</li>
                            ...
                            <p>
                                ...
                                ELearning lessons must be completed by December 9, 2016. You must have a total of nine points to qualify
                                for the incentive. Please contact the Circle Wellness Hotline if you have any questions: 1-866-682-3020 ext. 204.
                                <br/><br/>
                                OR<br/><br/>
                                • Bring a <a href="/resources/8346/2016 X-RAY Physician Exception Form.pdf" target="_blank">Physician Exception Form</a>
                                    to your physician to complete. The form must be returned by December 9, 2016.
                            </p>
                            ...
                            <p>
                                ...
                                <a href="/resources/8348/2016 X-RAY Pregnancy Exception Form.pdf" target="_blank">Pregnancy Exception Form</a>
