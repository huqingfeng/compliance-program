...
class MedtronicCompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class MedtronicLearningAlternativeComplianceView extends ComplianceView
{
...
class Medtronic2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Medtronic2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView = new MedtronicCompleteScreeningComplianceView($programStart, $programEnd);
        ...
        $screeningView->setAttribute('goal', '11/10/2017');
...
class Medtronic2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                Congratulations for participating in the 2017 Wellness Screening program. Below is a chart that outlines
            ...
            <p style="text-align: center; font-size: 13pt;">Your Healthy Measures Results for 2017</p>
            
            
            <?php echo $this->getTable($status) ?>

            <div id="bottom_notes">
                <p>Visit <a href="http://medtronichealth.com">medtronichealth.com</a> to view your screening
        ...
        <p>
         <img src="/resources/9196/Medtronic Alternate Qualification form-6-page.jpg" />
        </p>
         <?php endif ?>
            ...
            <table id="results">
                <tbody>
                    ...
                    <tr>
                        <td colspan="7">
                            <div>
                            <?php if($healthyGroupStatus->getStatus() == ComplianceStatus::NOT_COMPLIANT) : ?>
                                <p style="color: red;">
                                    You may complete and return the <a href="/resources/9193/Medtronic Alternate Qualification form-6.pdf">Alternate Qualification Form</a>
