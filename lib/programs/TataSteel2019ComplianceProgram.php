...
class TataSteel2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TataSteel2019ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '11/01/19');
        ...
        $hraView->setAttribute('goal', '11/01/19');
...
class TataSteel2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10368/2019_Tata Steel_AQF_071619.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN November 1, 2019</strong>
                            </td>
                         <?php endif ?>
                    </tr>
