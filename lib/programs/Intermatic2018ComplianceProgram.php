...
class Intermatic2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Intermatic2018ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $hraScore->setPreMapCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            $lastHraScore = new HraScoreComplianceView('2017-09-01', '2018-08-31', 65);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $lastStart = new \DateTime('2017-09-01');
        $lastEnd = new \DateTime('2018-08-31');
...
class Intermatic2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>Thank you for participating in the 2018 Wellness Screening. In partnership with Health Maintenance
            ...
            <p>As communicated, a medical premium discount will be offered to those employees who achieve at least 4
                ...
                from your 2017 screening. If you do not meet the requirements, you may still qualify for the incentive by
            ...
            <?php if($status->getStatus() == ComplianceStatus::COMPLIANT) : ?>
                ...
                <p>CONGRATULATIONS! Based on your results of the 2018 wellness screening, you either fall within the
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>Based on your results of the 2018 wellness screening, you <span class="bund">DO NOT</span> fall within
