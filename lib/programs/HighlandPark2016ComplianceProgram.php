...
class HighlandPark2016HomePageComplianceProgram extends ComplianceProgram
{
...
class HighlandPark2016ComplianceProgram extends ComplianceProgram
{
    public function loadEvaluators()
    {
    ...
    public function loadGroups()
    {
        ...
        $one->setAttribute('link_popover', '<span style="font-weight: bold;font-size: 10pt;">Square Off Challenge</span> <br /><br />Time frame: 11/09/15 - 12/11/15<br /><br />The objective of the Square Off Challenge is to cross off individual squares on the game board  as a way to start forming healthy habits in our lives. You can participate in this challenge as part of a team or as an individual to be eligible to earn WIN points and raffle prizes..');
        ...
        $two->setAttribute('link_popover', '<span style="font-weight: bold;font-size: 10pt;">Personalized Health Action Plan</span><br /><br />Time frame: 01/04/16 - 02/26/16<br /><br />Participants will meet with on-site Health Coach and create a personalized Health Action Plan to help achieve their goals. (Ex. Quit smoking, gain muscle, run 5k) Initial meeting with coach to create HAP will not count towards required calls. Subsequent calls/meetings will count though.');
        ...
        $three->setAttribute('link_popover', '<span style="font-weight: bold;font-size: 10pt;">Fruit and Veggie Challenge</span><br /><br />Time frame: 05/23/16 - 06/24/16<br /><br />The Rainbow Challenge is to help employees and their spouses develop the habit of eating more fruits and vegetables. It is highly recommended that half your plate is fruits and vegetables..');
        ...
        $four->setAttribute('link_popover', '<span style="font-weight: bold;font-size: 10pt;">Stress Free Me</span><br /><br />Time frame: 08/15/16 - 09/19/16<br /><br />The Stress Free Me Challenge is to encourage employees to partake in stress reducing activities throughout the day.  Stress affects us in both positive and negative ways, managing and controlling those stressful times in our lives will go a long way in improving our overall health.');
    ...
    {
        return new HighlandPark2016ComplianceProgramReportPrinter();
    }
}

class HighlandPark2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        $this->setShowLegend(true);
        $this->pageHeading = '2016 WIN (Wellness Initiative Program)';
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('tr.view-mine').prev('tr.headerRow').find('td').last().html(
                    'Minimum Points Needed for Incentive By 10/31/2016'
                );
