...
class Active2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Active2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '12/08/17');
        ...
        $hraView->setAttribute('goal', '12/08/17');
...
class Active2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            <img src="/resources/9833/Active IRC 2017 Insurance Contribution 100417-1.png" />
        </div>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/9834/Active_AQF_092117.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 8, 2017</strong>
                            </td>
                         <?php endif ?>
                    </tr>
