...
class VillageOfLemont2015ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your summary page for the 2015 Wellness Rewards benefit at Village of Lemont.
            This year we are continuing our wellness rewards incentive program and have added a few extra incentives.</p>

        <p>In 2015, employees reaching the necessary number of points will receive a discount on
            their 2015 health insurance premium (July-Dec). There will also be prizes for
            those employees who participate but are not on our health plans. Also, monthly
            raffles will be held for all those actively participating.</p>

        <p>The deadline to receive the 275 points (and obtain the premium discount)
            is June 30, 2015 (see below). You can earn these points from actions
            taken for your good health and wellbeing across the action categories below.</p>

        <p style="text-align:center;">
            <a href="/content/1094">
                Click here for more details about the 2015 Wellness Rewards benefit and requirements.
            </a>
        </p>
...
class VillageOfLemont2015ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new VillageOfLemont2015ComplianceProgramReportPrinter();
    ...
    public function loadEvaluators()
    {
        ...
        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2015-12-31'), array(), 275);
        $totalView->setReportName('<strong>By 06/30/2015</strong>');
    ...
    public function loadGroups()
    {
        ...
        $fitbitStep->setAttribute('report_name_link', '/content/1094#efitbit');
        ...
        $donateBlood->setAttribute('report_name_link', '/content/1094#hdonate');
        ...
        $cert->setAttribute('report_name_link', '/content/1094#icpr');
        ...
        $healthy->setAttribute('report_name_link', '/content/1094#kwater');
