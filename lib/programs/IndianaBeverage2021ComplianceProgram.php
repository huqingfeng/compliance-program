...
class IndianaBeverage2021CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class IndianaBeverage2021ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new IndianaBeverage2021WMS2Printer();
    }
...
class IndianaBeverage2021WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul>
                    <li>
                        Complete the <a href="/compliance/indianabeverage/hra/content/my-health">health risk assessment</a> (deadline Sept 10,2021). This must be completed before you can
                        schedule your health screening.
                    </li>
                    <li>Complete a <a href="/compliance/indianabeverage/appointment/content/schedule-appointments">health screening onsite</a> or by ordering an on-demand LabCorp packet (deadline to complete Sept 10,2021). To order a packet call 866-682-3020 ext 204.</li>
                    <li>
