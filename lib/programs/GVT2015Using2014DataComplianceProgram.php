<?php
class GVT2015Using2014DataBFMapper extends ComplianceStatusPointMapper
{
...
class GVT2015Using2014DataComplyWithBodyFatBMIScreeningTestComplianceView extends ComplyWithBodyFatBMIScreeningTestComplianceView
{
...
class GVT2015Using2014DataComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new GVT2015Using2014Printer();
        $printer->showResult(true);
        $printer->setPageHeading('My Incentive Report Card (2014 Results)');
...
//            $data['Point Difference'] = $data['Total Points'] - $data['Total Points (Last Year)'];
    ...
    public function loadGroups()
    {
        ...
        $bodyFatBMIView = new GVT2015Using2014DataComplyWithBodyFatBMIScreeningTestComplianceView($programStart, $programEnd);
        ...
        $bodyFatBMIView->setComplianceStatusPointMapper(new GVT2015Using2014DataBFMapper());
    ...
    {
        $program = new GVT2014ComplianceProgram($startDate, $endDate);
...
class GVT2015Using2014Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
...
//                );
                ...
                $('#legend').hide();
                $('.group-prevention-event').hide();
                $('.view-complete_screening_hra').hide();
                $('.view-complete_private_consultation').hide();
