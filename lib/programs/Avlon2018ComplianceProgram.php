...
class Avlon2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Avlon2018ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '06/15/18');
        ...
        $hraView->setAttribute('goal', '06/15/18');
        ...
        $completeConsultation->setReportName('a. Complete consultation with Dr. Todd by 6/30/18. <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
        ...
        $finalConsultationAlt3->setReportName('d. Complete final consultation with Dr. Todd by 8/31/18. <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
        ...
        $initialConsultation->setReportName('a. Initial consultation with Dr. Todd by 6/30/18. <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
        ...
        $finalConsultation->setReportName('c. Complete consultation with Dr. Todd by 8/31/18.');
        ...
        $tobaccoCoachingView = new PlaceHolderComplianceView(ComplianceViewStatus::NOT_COMPLIANT);
        $tobaccoCoachingView->setReportName('3. Complete the tobacco cessation program by Dr. Todd by 8/31/18.  <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
...
class Avlon2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.status-cotinine').after("<tr><td colspan='4' style='background:#CCFFFF'>Or, complete alternative 2 or 3 below</td></tr>");
            })
        </script>
        ...
        <div class="letter">
            ...
            <div style="clear: both">
                <div style="width: 100%; margin-top: 10px; display: block">
                    ...
                    <p>Employees can save up to $520 for the 2018-19 plan year by participating and attaining certain health
