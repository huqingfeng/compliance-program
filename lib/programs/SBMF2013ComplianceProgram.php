...
class SBMF2013BloodDonationComplianceView extends DateBasedComplianceView
{
...
class SBMF2013BMIMaintainComplianceView extends DateBasedComplianceView
{
...
class SBMF2013BMIReductionBonusComplianceView extends DateBasedComplianceView
{
    public function __construct($start, $end)
    {
        $this->setStartDate($start);
...
class SBMF2013LifestyleProgramOne extends PlaceHolderComplianceView
{
}

class SBMF2013LifestyleProgramTwo extends PlaceHolderComplianceView
{
}

class SBMF2013ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new SBMF2013ComplianceProgramReportPrinter();
        $printer->setPageHeading('My 2013 Incentive Scorecard');
    ...
    public function loadGroups()
    {
        ...
        //$privateConsultationView = new CompletePrivateConsultationComplianceView('2011-02-01', '2011-12-31');
        ...
        $bpLearn = new CompleteELearningGroupSet('2013-05-01', '2013-10-31', 'blood_pressure_compliance');
        ...
        $gcLearn = new CompleteELearningGroupSet('2013-05-01', '2013-10-31', 'blood_sugar');
        ...
        $tcLearn = new CompleteELearningGroupSet('2013-05-01', '2013-10-31', 'cholesterol_compliance');
...
//    $bodyFatBMIView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, null);
        ...
        $bmiReductionView = new SBMF2013BMIReductionBonusComplianceView($programStart, $programEnd);

        $bmiMaintain = new SBMF2013BMIMaintainComplianceView($programStart, $programEnd);
        $bmiMaintain->setReportName('BMI Maintained');
        $bmiMaintain->setName('bmi_maintain');
        $bmiMaintain->setStatusSummary(ComplianceStatus::COMPLIANT, 'BMI Unchanged from 2012');
        ...
        $bmiLearn = new CompleteELearningGroupSet('2013-05-01', '2013-10-31', 'bmi');
        ...
        $physicalView = new CompletePreventionPhysicalExamComplianceView('2012-09-01', '2013-09-01');
        $physicalView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(2, 0, 0, 0));
        $physicalView->addLink(new Link('I did this', '/resources/4407/SBMFVerificationForm082113.pdf'));
        ...
        $completedProgramsView1 = new SBMF2013LifestyleProgramOne();
        ...
        $completedProgramsView2 = new SBMF2013LifestyleProgramTwo();
        ...
        */
        ...
        $bloodView = new SBMF2013BloodDonationComplianceView('2012-09-01', '2013-09-01');
        ...
        $additionalLessons = new CompleteAdditionalELearningLessonsComplianceView('2013-04-11', '2013-10-31');
...
class SBMF2013ComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p>Welcome to The SBMF Wellness Website! This site was developed to:</p>
        ...
        <p>By completing the following steps in 2013 you will be eligible for the Premium health plan effective 01/01/2014:</p>

        <p><strong>Step 1</strong>: Complete your health screening, HRA, and blood draw that will be scheduled in August, 2013.</p>

        <p><strong>Step 2</strong>: You will again have the opportunity to earn incentive points in 2013. You will need to obtain a minimum of 9
            incentive points to be eligible for the Premium health plan in 2014. You are not required to meet the target range for each individual
            ...
            or submit a medical exception form to Circle Wellness. As long as you accumulate a total of 9 points by 10/31/2013, you will be eligible
            for the Premium health plan for the 2014 plan year.


        <p>Incentive Points can be earned in each of the following categories: </p>
        <ol>
            <li><strong>Smoking Status</strong>: Maintain non-smoker status or participate in the Free and Clear Smoking Cessation program.
            </li>
            <li><strong>Health Profile Measurements</strong>: Point values are assigned below in your report card for each measure. Meet the
                ...
                2012 screening. Measurements will be taken at the August 2013 onsite wellness screenings.
            </li>
            <li><strong>Annual Physical Exam</strong>: An annual physical exam will be automatically entered into your record from information received from your health plan. Updates
                ...
                the claim will be updated on the website in April or May. OR you can complete a <a href="/resources/4339/SBMFVerificationForm062013.pdf">verification form</a>
                indicating that you had your physical completed. Physical exams need to be completed between September 1, 2012 and September 1, 2013.
            </li>
            <li><strong>Annual Flu Shot</strong>: Employees and spouses who received a flu vaccination between September 1, 2012 and March 31, 2013
            ...
            <li><strong>Blood Donation</strong>: Employees and spouses who donate blood four times a year will receive two points on their wellness scorecard.
                Those who donate twice a year will earn one point. A double red cell donation will count as two donations. Blood donations must be completed between September 1, 2012 and September 1, 2013.
            </li>
    ...
    public function printClientNotice()
    {
        ...
        ?>
        Your scorecard will be updated throughout the year as incentive points are earned. Smoking status and Health Profile measurements will not be updated until completion of the August 2013 screenings. You may use your 2012 health screening results to give you an indication of your current potential to earn incentive points.
    <br/>
        <?php if($user->gender == Gender::FEMALE) : ?>
          <p><a href="/resources/4329/SBMFPregnancyExceptionForm061313.pdf">Are you pregnant?</a></p>
        <?php endif ?>
       
        <?php
    }
    ...
    <p>
        ...
        an <a href="/resources/4328/SBMFExceptionForm061313.pdf">exception form</a>
