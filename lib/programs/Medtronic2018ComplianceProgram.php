...
class Medtronic2018CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class Medtronic2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Medtronic2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView = new Medtronic2018CompleteScreeningComplianceView($programStart, $programEnd);
        ...
        $screeningView->setAttribute('goal', '12/13/2018');
...
class Medtronic2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                Congratulations for participating in the 2018 Wellness Screening program. Below is a chart that outlines
            ...
            <p style="text-align: center; font-size: 13pt;">Your Healthy Measures Results for 2018</p>
        ...
        <p>
            <img src="/resources/10046/Medtronic_AQF_18-page.jpg" />
        </p>
    <?php endif ?>
                    ...
                    <tr>
                        <td colspan="7">
                            ...
                            <?php if($healthyGroupStatus->getStatus() == ComplianceStatus::NOT_COMPLIANT && $coreStatus->getComplianceViewStatus('complete_screening')->getComplianceView()->getAttribute('has_screening')) : ?>
                                <p style="color: red;">
                                    You may complete and return the <a href="/resources/10035/Medtronic_AQF_18.pdf">Alternate Qualification Form</a>
