...
class IncredibleTechnologiesLearningAlternativeComplianceView extends ComplianceView
{
...
class IncredibleTechnologies2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new IncredibleTechnologies2016ComplianceProgramReportPrinter();
    }
...
class IncredibleTechnologies2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/8419/EHS Incredible Tech IRC Alt To-Do Doctor Support Form rev 092216.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 9, 2016</strong>
                            </td>
                         <?php endif ?>
                    </tr>
