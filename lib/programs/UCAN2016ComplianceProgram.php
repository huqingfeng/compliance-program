...
class UCAN2016ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new UCAN2016ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $scr->setReportName('Employee participates in the 2016 Wellness Screening (onsite/remote)');
        ...
        $phyExam->addLink(new Link('Verification form', '/resources/7898/2016_PreventiveCare Cert.pdf'));
        ...
        $prevServ->addLink(new Link('Verification form', '/resources/7898/2016_PreventiveCare Cert.pdf'));
        ...
        $nutProgram->addLink(new Link('HWAG Certification Form', '/resources/7900/2016_nonHWAG Event Cert.pdf'));
        ...
        $fiveK->addLink(new Link('HWAG Certification Form', '/resources/7900/2016_nonHWAG Event Cert.pdf'));
        ...
        $ranges = array(
            array('2016-06-01', '2016-06-31'),
            array('2016-07-01', '2016-07-31'),
            array('2016-08-01', '2016-08-31'),
            array('2016-09-01', '2016-09-31'),
            array('2016-10-01', '2016-10-30'),
            array('2016-11-01', '2016-11-30'),
            array('2016-12-01', '2016-12-30'),
            array('2017-01-01', '2017-01-31'),
            array('2017-02-01', '2017-02-31'),
            array('2017-03-01', '2017-03-31'),
            array('2017-04-01', '2017-04-31'),
...
class UCAN2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div>
            ...
            ($1.50 per pay period for 20 periods). REGISTRATION IS REQUIRED. <br />
            <ul style="font-size:9pt;">
                ...
                <li>Only the Fitbit Zip device will be available for purchase via payroll deduction. DEADLINE TO ORDER
                 IS FRIDAY, JUNE 17TH, 2016. Cost is $80 and includes the Fitbit Zip device AND tracking for the 1-year
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <div class="page-header">
            <h4>UCAN 2016-17 Wellness Program</h4>
        </div>
        ...
        <p><strong>Employees that complete the 2016 Health Screening and Health Power Assessment (HPA) are
            ...
            Rewards will be based on points earned between 6/1/16 and 5/31/2017.</p>
