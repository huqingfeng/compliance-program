...
class FederatedMedia2013ComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
...
class FederatedMedia2013ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new FederatedMedia2013ComplianceProgramReportPrinter();
