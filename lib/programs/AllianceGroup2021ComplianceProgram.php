...
class AllianceGroup2021CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class AllianceGroup2021ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new AllianceGroup2021WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $bloodPressureView = new ComplyWithBloodPressureScreeningTestComplianceView($programStart, $coreEndDate);
        ...
        $triglView = new ComplyWithTriglyceridesScreeningTestComplianceView($programStart, $coreEndDate);
        ...
        $ha1cView = new ComplyWithHa1cScreeningTestComplianceView($programStart, $coreEndDate);
...
//        $ha1cView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≤ 49 or ≥ 126');
        ...
        $cholesterolView = new ComplyWithTotalCholesterolScreeningTestComplianceView($programStart, $coreEndDate);
        ...
        $totalHDLRatioView = new ComplyWithTotalHDLCholesterolRatioScreeningTestComplianceView($programStart, $coreEndDate);
        ...
        $waistBMIView = new AllianceGroupComplyWithBMIWaistHipRatioScreeningTestComplianceView($programStart, $coreEndDate);
        $waistBMIView->setBmiView($this->getBmiView($programStart, $coreEndDate));
        $waistBMIView->setWaistHipView($this->getWaistHipView($programStart, $coreEndDate));
...
//        $waistBMIView->setUsePoints(true);
        ...
        $smokingView = new ComplyWithSmokingHRAQuestionComplianceView($programStart, $coreEndDate);
...
class AllianceGroup2021WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul>
                    <li>Complete an HRA (complete by 11/15/2021)</li>
                    <li>Complete a health screening (complete by 11/15/2021)</li>
                    <li>Earn a minimum 10 of 15 points for having in-range biometrics, OR complete 1 of the alternative options mentioned in the yellow box below if 10 points aren't earned (complete by 12/10/2021)</li>
                </ul>
                ...
                <div class="alert alert-warning">
                    ...
                    <ol>
                        <li><a href="/resources/10696/2021_Alliance_Physician_Verification_Form.pdf"  target="_blank" style="text-decoration:underline">DOWNLOAD A PHYSICIAN FORM</a> AND TAKE IT TO YOUR DOCTOR AND THEN SUBMIT IT VIA HIPPA SECURE FAX (1-800-887-9579 OR VIA THE UPLOAD DOCUMENT BUTTON.</li>
                        ...
                        <th>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="/resources/10696/2021_Alliance_Physician_Verification_Form.pdf"  target="_blank">Download this physician form</a> and take it to your doctor. Upload it via HIPPA secure fax to 1-800-887-9579 or via the upload documents button.</li>
