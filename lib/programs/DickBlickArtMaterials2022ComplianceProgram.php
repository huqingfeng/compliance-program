...
class DickBlickArtMaterials2022ComplianceProgram extends ComplianceProgram
{
    ...
    public function executeHealthRiskScore(sfActions $actions)
    {
        ...
        <div>
          ...
          <p> Your health risk score focuses on 6 of your screening results.  Having results in the target range
            ...
            getting serious conditions and conditions that can affect your quality of life and other goals. </p>
          <p>        
          <ul>
            <li><span class="bold1">Blood Pressure:</span> 1 point is added per BP unit above 139/89 <span class="bold1">(Systolic/Diastolic)</span>. A credit of -5 points can be earned for EACH of your results that are at or below the incentive goals. Note: Results over 119/79 increases risks for heart attacks, strokes, kidney and other problems.</li>
            <li><span class="bold1">LDL Cholesterol:</span> 1 point is added per LDL unit above 129 mg/dl.  A credit of -5 points can be earned if you are at or below your incentive goals. Note: Results over 99 increases risks for heart attacks, strokes and other problems. </li>
            <li><span class="bold1">Glucose:</span> 1 point is added per Glucose unit above 99 mg/dl. A credit of -5 points can be earned if Glucose is at or below 99 mg/dl.</li>
            <li><span class="bold1">Triglycerides:</span> 1 point is added per 10 Triglyceride units above 149 mg/dl. A credit of -5 points can be earned if Triglycerides are at or below 149 mg/dl.</li>
            <li><span class="bold1">Tobacco Use:</span> 40 points are added for using any tobacco product.</li>
          </ul>
          </p>
          ...
          <p> You may be there already. If not, a reasonable goal is making jumps of progress toward the ideal goal.
            Which of the 4 goals below applies to you?  Whatever your score is now, how fast and far can you jump
            toward and reach the ideal goal?  What actions will help you get there? </p>
          <ol>
          ...
          <p> Empower Health offers a wide variety of helpful resources through this website.  A place to start is by
            clicking on the e-lesson links for each screening result above.  Or, go to the home page and click on Health,
            Care & Wellbeing Resources to explore even 1,000+ e-lessons, 500+ videos, medical decision-making tools and more. </p>
    ...
    {
        return new DickBlickArtMaterials2022ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $systolicView->setReportName('A. Blood pressure – Systolic <br /> <span style="margin-left: 20px;">≤119 = health goal</span>');
        $systolicView->setName('systolic');
        $systolicView->overrideTestRowData(null, null, 139, null);
        $systolicView->setAttribute('goal', '≤ 139');
        ...
        $diastolicView->setReportName('B. Blood Pressure – Diastolic <br /> <span style="margin-left: 20px;">≤79 = health goal</span>');
        $diastolicView->setName('diastolic');
        $diastolicView->overrideTestRowData(null, null, 89, null);
        $diastolicView->setAttribute('goal', '≤ 89');
        ...
        $ldlView->setReportName('C. LDL Cholesterol<br /> <span style="margin-left: 20px;">≤99 = health goal</span>');
        $ldlView->setName('ldl');
        $ldlView->overrideTestRowData(null, null, 129, null);
        $ldlView->setAttribute('goal', '≤ 129');
        $ldlView->emptyLinks();
        ...
        $tobaccoView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            $status->setComment($result);

            if((is_numeric($result) && $result > 15) || $result == 'P' || $result == 'Positive') {
                $status->setStatus(ComplianceStatus::NOT_COMPLIANT);
            } else if((is_numeric($result) && $result <= 15) || $result == 'N' || $result == 'Negative' || trim($result) == '<2') {
...
class DickBlickArtMaterials2022ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width: 48%; text-align: right">
                    <img src="/images/empower/Blick_logo_011121.png" style="height:50px;"  />
                </div>
            </p>
            ...
            <div style="margin-left:10px;">
                ...
                <p>
                    ...
                    participant is provided with an overall health risk score and a personal health goal.
                </p>

                <p>
                    There are two financial incentives linked to the wellness screening program:
                    <ul>
                        <li>The first incentive is based on completing the HRA and screening and achieving an overall health risk score of 0 or less.</li>
                        <li>The second incentive is based on being tobacco free.</li>
                    </ul>
                </p>

                <p>
                    In order to earn the full incentive for next year, participants will need to achieve an overall health
                    risk score of 0 or less or meet their personal health goal.
                </p>
            </div>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 3/11/2022</th>
                    ...
                    <tr class="headerRow">
                        <th style="text-align: left; width: 260px;">2. Some Key Health Measures:</th>
                        <th>Incentive Goals</th>
                        <th>My Result</th>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;">
                            <ol style="list-style-type: upper-alpha;">
                                ...
                                <li>If your score is 1-25 &#8594; Your goal is to reach 0 or less</li>
                                <li>If your score is 26-40 &#8594; Your goal is to reach 25 or less</li>
                                <li>If your score is 41 or more &#8594; Your goal is to reach 40 or less</li>
                            </ol>
                        </td>
                        ...
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >0, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 3/31/2022.  You can
                                 <a href="/resources/10740/Blick_Art_Materials_2022_AQF_010422.pdf" download="2022_AQF">download the form here</a>
                                 and return it to Empower Health any of these ways:
                                 <ul style="margin-left:100px; margin-top:-10px;text-align: left;">
                                    <li>Upload completed form to <a href="http://ehsupload.com">ehsupload.com</a></li>
                            ...
                            <p style="text-align:left; margin-left:50px; width:95%;">F. <a href="/content/company-resources">Click here</a> more information on the Tobacco Incentive.</p>

                            <p>
                                See action links to learn more about each & ways to reach & stay in the ideal range.
                                <a href="/compliance_programs/localAction?id=1718&local_action=dashboardCounts">About the health risk score.</a>
                            </p>
                        </td>
                    </tr>
