...
class CityOfMcKinney2017ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if(sfConfig::get('app_wms2')) {
            return new CityOfMcKinney2017WMS2Printer();
        } else {
            return new CityOfMcKinney2017WMS2Printer();
        }
    }
...
//        $biometricGroup->setPointsRequiredForCompliance(0);
        ...
        $preventative = new CompletePreventionPhysicalExamComplianceView('2017-12-01', $programEnd, $codes);
        ...
        $preventative->setReportName('Preventative Care Exam - must be completed between <br /> &nbsp;&nbsp; 12/1/2017 and 12/1/2018.');
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        if(!CityOfMcKinney2017ComplianceProgram::isOptionTwo($user)) {
            $numCompliant = 0;
            $coreCompliant = false;
...
class CityOfMcKinney2017ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
class CityOfMcKinney2017WMS2Printer implements ComplianceProgramReportPrinter
{
    private function getHeader(ComplianceProgramStatus $status)
    {
        ?>

        <?php if(!CityOfMcKinney2017ComplianceProgram::isOptionTwo($status->getUser())) : ?>
        <div class="row">
            <div class="col-md-12">
                <div>
                    <p>Participants can earn up to $600 Wellness Dollars for completing the three activities/goals below by
                        <strong>December 1, 2018</strong>. Wellness Dollars earned in 2018 will be paid out in a lump-sum payment in January
                        of 2019.</p>
            ...
            <div class="col-md-12">
                <div>
                    <p>Participants electing this option will receive a monthly, employee-only membership to the new McKinney
                        ...
                        Screen by <strong>December 1, 2018</strong>. The $100 lump-sum payout would occur in January of 2019. Memberships will be
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $isOptionTwo = CityOfMcKinney2017ComplianceProgram::isOptionTwo($status->getUser());
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="/compliance/mckinney-2017-interface/my-incentives/compliance_programs?<?php echo str_replace("1304", "882", $_SERVER['QUERY_STRING']) ?>">View Previous Year's Report Card</a>
            </div>
        </div>
