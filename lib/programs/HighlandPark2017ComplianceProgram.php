...
class HighlandPark2017HomePageComplianceProgram extends ComplianceProgram
{
...
class HighlandPark2017ComplianceProgram extends ComplianceProgram
{
    public function loadEvaluators()
    {
    ...
    {
        return new HighlandPark2017ComplianceProgramReportPrinter();
    }
}

class HighlandPark2017ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        $this->setShowLegend(true);
        $this->pageHeading = '2017 WIN (Wellness Initiative Program)';
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('tr.view-mine').prev('tr.headerRow').find('td').last().html(
                    'Minimum Points Needed for Incentive By 10/31/2017'
                );
