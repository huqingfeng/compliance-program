...
class Henniges2021CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class Henniges2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Henniges2021WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new Henniges2021CompleteScreeningComplianceView($screeningStartDate, $programEnd);
        ...
        $cholesterolView = new ComplyWithTotalCholesterolScreeningTestComplianceView($screeningStartDate, $programEnd);
        ...
        $hdlView = new ComplyWithHDLScreeningTestComplianceView($screeningStartDate, $programEnd);
        $hdlView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(1, 0, 0, 0));
        $biometricsGroup->addComplianceView($hdlView);

        $ldlView = new ComplyWithLDLScreeningTestComplianceView($screeningStartDate, $programEnd);
        $ldlView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(1, 0, 0, 0));
        $biometricsGroup->addComplianceView($ldlView);

        $triglView = new ComplyWithTriglyceridesScreeningTestComplianceView($screeningStartDate, $programEnd);
        ...
        $heightView = new ComplyWithHeightScreeningTestComplianceView($screeningStartDate, $programEnd);
        ...
        $weightView = new ComplyWithWeightScreeningTestComplianceView($screeningStartDate, $programEnd);
        ...
        $bodyFatBMIView = new GVT2015ComplyWithBodyFatBMIScreeningTestComplianceView($screeningStartDate, $programEnd);
        $bodyFatBMIView->setIndicateSelfReportedResults(false);
        $bodyFatBMIView->setBmiView($this->getBmiView($screeningStartDate, $programEnd));
        $bodyFatBMIView->setBodyFatView($this->getBodyFatView($screeningStartDate, $programEnd));
...
class Henniges2021WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $tableRow = function($name, ComplianceViewGroupStatus $group) use ($classFor, $classForStatus, $textForStatus, $groupTable, $user) {
            ...
            foreach($group->getComplianceViewStatuses() as $viewStatus) {
                ...
                if(($user->getClientId() != 3421 || $relationship != Relationship::EMPLOYEE) && $viewName == 'tobacco_status') continue;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <?php if($user->getClientId() == 3748) : ?>
                                ...
                                <p>Click on <a href="/compliance/henniges-automotive-2019/program-overview/content/henniges_program_overview_2021">Program Overview</a> link to view your incentive program details and requirements.</p>
