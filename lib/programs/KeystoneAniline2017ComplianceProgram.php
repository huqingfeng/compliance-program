...
class KeystoneAnilineLearningAlternativeComplianceView extends ComplianceView
{
...
class KeystoneAniline2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new KeystoneAniline2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '3/30/2017');
        ...
        $hraView->setAttribute('goal', '3/30/2017');
        ...
        $bpView->overrideSystolicTestRowData(null, null, 140.999, null);
        ...
        $bpView->setAttribute('goal', '< 141 / <91');
        ...
        $tobaccoView->setReportName('3. Tobacco Use Status');
        ...
        $tcView->setReportName('4. Total Cholesterol');
        $tcView->setName('cholesterol');
        $tcView->overrideTestRowData(null, null, 219.999, null);
        $tcView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(1, 0, 0 ,0));
        $tcView->setAttribute('goal', '< 220');
...
class KeystoneAniline2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right;">
                    <img src="/images/empower/keystone_logo.jpg" style="height:80px;"  />
                </div>
            </p>
            ...
            <p>Keystone Aniline is committed to encourage and help support the health, care and wellbeing
            ...
            <p>
                The requirements for earning the wellness incentive this year are in the table below.  When you meet
                the required goals for the incentive, your name will be on a list that is sent to Keystone Aniline
                for everyone earning the incentive.  Note about privacy:  As always, individual screening results
                are not shared with employers and remain confidential.
            </p>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/8980/EHS Keystone Aniline IRC Alt To-Do Doctor Support Form 021517.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN May 15, 2017</strong>
                            </td>
                         <?php endif ?>
                    </tr>
