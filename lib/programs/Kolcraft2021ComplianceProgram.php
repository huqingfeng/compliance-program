...
class Kolcraft2021RunWalkComplianceView extends CompleteArbitraryActivityComplianceView
{
...
class Kolcraft2021ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-complete_hra').next().children('.links').html('<a target="_self" href="/compliance/hmi-2016/schedule/content/wms2-appointment-center">Sign-Up</a> <a target="_self" href="/content/my-health?tab=screening">Results</a>');
        ...
        <p>We are excited to introduce a Wellness Rewards Program here at Kolcraft, beginning July 1, 2021. We hope this program will encourage you to be more aware of your own wellness and increase your daily physical activity to improve your health. The idea is to accumulate points by participating in wellness activities and making healthy choices over the next six months which will earn you a discount on your health insurance premium.</p>

        <p>In 2021, employees reaching the necessary number of points will receive a discount on their 2022 health insurance premium. In order to maintain this discount you will need to continue participation in the wellness program. There will be other incentives for participants throughout the year and for those employees who participate but are not on our health plans.</p>

        <p>In order to earn a premium discount, you must earn 300 points or more by December 17, 2021. You can earn these points from actions taken for your good health and wellbeing across the action categories below.
        </p>
...
class Kolcraft2021ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new Kolcraft2021ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalFirstHalfView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2021-07-01', '2021-12-17'), array(), 300);
        $totalFirstHalfView->setReportName('<strong>By 12/17/2021</strong>');
        $totalFirstHalfView->setName('total_first_half');
        $totalsGroup->addComplianceView($totalFirstHalfView);

        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2021-07-01', '2022-06-30'), array(), 475);
        $totalView->setReportName('<strong>By 06/30/2022</strong>');
    ...
    public function loadGroups()
    {
        ...
        $walkRun = new Kolcraft2021RunWalkComplianceView($startDate, $endDate, 37071, '5k/10k Walk or Run');
        ...
        $triathlon = new Kolcraft2021RunWalkComplianceView($startDate, $endDate, 37071, 'Triathlon/Biathlon');
        ...
        $halfMarathon = new Kolcraft2021RunWalkComplianceView($startDate, $endDate, 37071, 'Half Marathon');
        ...
        $marathon = new Kolcraft2021RunWalkComplianceView($startDate, $endDate, 37071, 'Marathon');
