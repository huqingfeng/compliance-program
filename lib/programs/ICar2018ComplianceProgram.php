...
class ICar2018ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new ICar2018ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $phyExam->emptyLinks();
        $phyExam->addLink(new Link('Verification form', '/resources/9917/2018_PreventiveCare_Cert_I-Car.pdf'));
        ...
        $prevServ->addLink(new Link('Verification form', '/resources/9917/2018_PreventiveCare_Cert_I-Car.pdf'));
        ...
        $fluShot->addLink(new Link('Verification form', '/resources/9917/2018_PreventiveCare_Cert_I-Car.pdf'));
        ...
        $smoking->addLink(new Link('Verification Form', '/resources/9918/2018_WellnessEventCert_I-Car.pdf'));
        ...
        $fiveK->addLink(new Link('Verification Form', '/resources/9918/2018_WellnessEventCert_I-Car.pdf'));
...
class ICar2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
//                $('.view-lnl_presentation').children('td:eq(0)').remove();
                ...
                $('.view-10_weeks_steps').children('td:eq(0)').html('<strong>A</strong>. Wellness Walking Challenge' +
                    '<br /><br /><span style="font-size:8pt;">Challenge: 6/1/18 – 8/31/18</span>');
                ...
                $('.view-national_bike_challenge').children('td:eq(0)').html('<strong>B</strong>. National Bike Challenge' +
                    '<br /><span style="font-size:8pt;">Challenge: May 2018 – September 2018</span>' +
        ...
        <p><strong>All Employees that complete the Wellness Screening and Health Assessment Questionnaire are
            ...
            health activities between <strong>1/1/18 – 11/30/18</strong>.</p>
        ...
        <p style="text-align:center;color:red; padding: 10px 0;">All employees achieving recognition status will be announced on the Employee Self Service portal in
