...
class AlliedWholesale2015ComplianceProgram extends ComplianceProgram
{
  ...
  {
    return new AlliedWholesale2015ComplianceProgramReportPrinter();
  }
}

class AlliedWholesale2015ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
  ...
  <p>Hello <?php echo $status->getUser()->getFullName() ?>,</p>
      ...
      <p>Welcome to the Alled Wholesale Wellness Website! This site was developed not only to track
      ...
      Employees that participate in the 3 steps outlined below will receive an additional vacation day!
  </p>
