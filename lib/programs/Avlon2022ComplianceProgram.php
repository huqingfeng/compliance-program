<?php
  ...
  class Avlon2022ComplianceProgram extends ComplianceProgram {
    ...
    public function getProgramReportPrinter($preferredPrinter = null) {
      return new Avlon2022ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups() {
      ...
      $screeningView->setAttribute('goal', '5/20/22');
      $screeningView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
        $date = SelectQuery::create()
          ...
          ->andWhere('date BETWEEN ? AND ?', array('2022-01-01', '2022-12-31'))
      ...
      $hraView->setAttribute('goal', '5/20/22');
      ...
      $bmiView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user){
        ...
        if (in_array(strtolower($result), array('qns', 'tnp', 'test not taken', "declined"))) {
          $status->setComment('Declined');
      ...
      $waistView->overrideTestRowData(null, null, 37, null, 'M');
      $waistView->overrideTestRowData(null, null, 34.5, null, 'F');
      $waistView->emptyLinks();
      $waistView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user){
        $result = $status->getAttribute('real_result');
      ...
      $completeConsultation->setReportName('a. Complete initial consultation with Dr. Todd by 6/17/22.');
      ...
      $elearningAlt3->setReportName('b. <a href="/content/9420?action=lessonManager&tab_alias=body_fat" target="_blank">Complete 5 e-learning lessons</a> related to BMI by 8/5/22.');
      ...
      $attendSeminarAlt3->setReportName('c. Attend 1 in-person seminar with Dr. Todd on 6/17/22 or 7/22/22.');
      ...
      $finalConsultationAlt3->setReportName('d. Complete final consultation with Dr. Todd by 7/22/22.');
      ...
      $initialConsultation->setReportName('a. Complete initial consultation with Dr. Todd by 6/17/22.');
      ...
      $attendSeminarAlt4->setReportName('b. Attend 2 in-person seminars with Dr. Todd on 6/17/22 or 7/22/22.');
      ...
      $finalConsultation->setReportName('c. Complete final consultation with Dr. Todd by 7/22/22.');
      ...
      $tobaccoElearningView->setReportName('2. <a href="/content/9420?action=lessonManager&tab_alias=tobacco" target="_blank">Complete 5 e-learning lessons</a> related to Tobacco by 8/5/22.');
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status) {
        ...
        if ($alt3Group->getStatus() == ComplianceViewGroupStatus::COMPLIANT ||
            $alt4Group->getStatus() == ComplianceViewGroupStatus::COMPLIANT)
  ...
  class Avlon2022ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter {
      ...
      <div class="letter">
        ...
        <div style="clear: both">
          <div style="width: 100%; margin-top: 10px; display: block">
            <p style="font-size: 1rem; font-weight: 600;">
              <span style="float:left;">Dear <span style="color: #2B1EF5;"><?= $user->first_name ?>:</span></span>
              <span style="float:right; color: #2B1EF5;"><?= date("m/d/Y") ?></span>
            </p>

            <div style="margin-bottom: 10px; clear: both;"></div>

            <p>
              Avlon is committed to supporting the health and wellbeing of its
              employees and their families. The first step in promoting good
              health is awareness. That is why Avlon offers the annual health
              screenings through Empower Health Services. To encourage employees
              to take advantage of this wonderful benefit, Avlon offers 4
              incentives related to the program. 
            </p>

            <p>
              Employees can save up to $520 for the 2022-23 plan year by
              participating and attaining certain health measures or 1 of the
              alternatives. Here’s how: Employees can earn $10 per pay period
              for A (2 actions) <span class="bu">and</span> earn $5 for B
              (meet the BMI or waist goal) <span class="bu">and</span> another
              $5 for C (meet the tobacco goal) – a total of up to $20 per pay
              period. The alternative actions make it possible for everyone to
              succeed with A, B and C!
            </p>

            <p>
              And, spouses can receive a $10 gift card by participating and
              attaining certain health measures or 1 of the alternatives.
            </p>
          </div>
        </div>
        ...
        <div id="not_compliant_notes">
          <div style="width: 56%; float: left">
            <p>
              Login to
              <a href="https://empowerhealthservices.hpn.com/">
                https://empowerhealthservices.hpn.com/</a> any time to:
              <ul>
                <li>
                  View all of your screening results and links in the report; AND
                </li>
                <li>
                  Access powerful tools and resources for optimizing your
                  health, care and wellbeing.
                </li>
              </ul>

              <p>
                Thank you for getting your wellness screening done this year.
                This and many of your other actions reflect how you value your
                own wellbeing and the wellbeing of others at home and work.
              </p>
          ...
          <div style="width: 40%; padding: 10px; float: right; background-color: #DAEEF3;">
            ...
            <div style="font-size: 9pt;">
              <ul>
                ...
                <li>
                    The Healthwise® Knowledgebase for decisions about medical
                    tests, medicines, other treatments, risks and other topics
                </li>
                <li>Over 500 videos</li>
                <li>Decision tools for over 170 elective care decisions</li>
                <li>
                  Cholesterol, body metrics, blood sugars, women's health, men's
                  health and over 40 other learning centers.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div style="padding-top: 20px;">
          <p>
            <strong>Please note:</strong> Avlon is committed to helping you
            achieve your best health. This wellness rewards program is available
            to all employees and spouses. If you are unable to meet a goal for a
            reward under this program based on your wellness screening results
            –or– a current health condition precludes you from participating in
            the program, you will be provided with an alternate means of earning
            the reward. The specific details of the alternate qualification
            process, including requirements and deadlines, are explained in the
            above incentive report sections B and C. If you have additional
            questions regarding the details of this program, please contact
            Empower Health Services at <a href="tel:8663676974">866.367.6974</a>.
          </p>
        </div>
      </div>
          ...
          <tbody>
            <tr class="headerRow">
              <th style="text-align: left; width: 320px;">
                A. Core Actions - meet both goals below to get this incentive:
              </th>
              <th>Goal Deadline</th>
              <th>Date Done</th>
              <th>Goal Met</th>
            ...
            <tr>
              <td class="status-<?= $screeningStatus->getStatus() ?>" style="text-align: left;">
                <?= $screeningStatus->getComplianceView()->getReportName() ?>
              </td>
              <td class="status-<?= $screeningStatus->getStatus() ?>">
                <?= $screeningStatus->getComplianceView()->getAttribute('goal') ?>
              </td>
              <td class="status-<?= $screeningStatus->getStatus() ?>">
                <?= $screeningStatus->getComment() ?>
              </td>
              <td class="status-<?= $screeningStatus->getStatus() ?>">
                <?= determineGoal($screeningStatus->getStatus()) ?>
              </td>
              <td rowspan="2">
                <?= ($coreStatus->getStatus() == ComplianceStatus::COMPLIANT) ? 'Yes' : 'No' ?>
              </td>
            </tr>
            <tr class="status-<?= $hraStatus->getComplianceView()->getName() ?>">
              <td style="text-align: left;">
                <?= $hraStatus->getComplianceView()->getReportName() ?>
              </td>
              <td>
                <?= $hraStatus->getComplianceView()->getAttribute('goal') ?>
              </td>
              <td><?= $hraStatus->getComment() ?></td>
              <td><?= determineGoal($hraStatus->getStatus()) ?></td>
            </tr>
            <tr class="headerRow">
              <th style="text-align: left;" colspan="2">
                B. BMI &amp;/or Waist Incentive – meet 1 or more goal below:
              </th>
              <th>My Result</th>
              <th>Goal Met</th>
              <th></th>
            ...
            <?php foreach ($healthyGroupStatus->getComplianceViewStatuses() as $viewStatus): ?>
              <tr class="status-<?= $viewStatus->getComplianceView()->getName() ?>">
                <td style="text-align: left;"  colspan="2">
                  <?= $viewStatus->getComplianceView()->getReportName() ?>
                </td>
                <td><?= $viewStatus->getComment() ?></td>
                <td><?= determineGoal($viewStatus->getStatus()) ?></td>
                <?php if ($i == 0): ?>
                  <td rowspan="5">
            ...
            <tr class="headerRow">
              <th style="text-align: left;" colspan="2">
                C. Tobacco Incentive – meet 1 or more goal below:
              </th>
              <th>My Result</th>
              <th>Goal Met</th>
              <th></th>
