...
class TransportationRepairServices2020LearningAlternativeComplianceView extends ComplianceView
{
...
class TransportationRepairServices2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TransportationRepairServices2020ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView = new CompleteScreeningComplianceView($programStart, $coreEnd);
        ...
        $lastYearStart = '2019-01-01';
        $lastYearEnd = '2019-12-31';
        ...
        $bmiView->setAttribute('goal', '≤29 or 2 less from 2019 or 3 lessons');
        ...
        $ldlView->setAttribute('goal', '≤130 or 10 less from 2019 or 3 lessons');
        ...
        $trigView->setAttribute('goal', '≤150 or 15 less from 2019 or 3 lessons');
...
class TransportationRepairServices2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
            ...
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        ...
                        <th colspan="2">Goal by 11/11/20</th>
