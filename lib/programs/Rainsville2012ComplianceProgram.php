...
class Rainsville2012ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new Rainsville2012Printer();
...
class Rainsville2012Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p>
        ...
        you will be eligible for the 2012 premium rate in your health plan
    ...
    <p>
        ...
        Screenings will be scheduled again beginning in October of 2012
    ...
    <p>
        ...
        you can contact Lara Little in Human Resources to discuss a
