...
class AbtElectronics2021ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'Get Started - Get these done by January 14, 2022');
        ...
        $pointGroup = new ComplianceViewGroup('points', 'Earn 35 or more points from A&B below by January 14, 2022');
    ...
    {
        $printer = new AbtElectronics2021ComplianceProgramReportPrinter();
...
class AbtElectronics2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <table class="phipTable" border="1">
            ...
            <tr>
                <td colspan="2">
                    B. If needed, work with your primary care doctor/provide to turn in a Completed Alternate Qualification
                    Form (AQF) by February 11, 2022. Download and print the form which has places for both of you to
                    complete, and the fax or address to use.
                </td>
                ...
                <td class="center"><a href="	/resources/10698/Abt Electronics_2021_AQF_091421.pdf" download>If needed, click here to download the AQF pdf</a></td>
            </tr>
