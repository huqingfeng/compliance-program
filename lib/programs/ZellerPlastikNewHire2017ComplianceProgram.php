...
class ZellerPlastikNewHire2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new ZellerPlastikNewHire2017ComplianceProgramReportPrinter();
    }
...
class ZellerPlastikNewHire2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                Thank you for participating in the Zeller Plastik 2017 Wellness Screening. In partnership with Empower
                 Health Services, Zeller Plastik has selected five "Healthy Measures" for you to strive to achieve.
            </p>

            <p>
                As communicated, a medical premium discount will be offered to those employees who achieve at least 3 out
                of the 5 “Healthy Measures” below. If you do not meet the requirements, you may still qualify for the
                incentive by having your doctor complete and sign the Alternate Qualification Form and fax it to Empower
                Health Services at 630.385.0156. If you do not successfully complete either of these options, you will not
                be eligible for the employee medical premium discount this year.
            </p>

            <p>
                Your screening results are below. Your overall achievement is based on the total results passed. Your
                screening test results will remain confidential while your overall achievement (pass or fail) will be
                forwarded to Zeller Plastik.
            </p>
            ...
            <?php if($this->getNumCompliant($status) >= 3) : ?>
                ...
                <p>CONGRATULATIONS! Based on your results of the Zeller Plastik wellness screening, you <span class="bund">DO</span> fall
                    within the acceptable range for at least three “Healthy Measures” and therefore, qualify for the medical
                    premium discount. No further action is required on your part.</p>

                <p>If you have any questions, please contact <a href="mailto:allison@empowerhealthservices.com">allison@empowerhealthservices.com</a>
                     or call 866-367-6974.</p>

            <?php else : ?>
                <div id="not_compliant_notes">
                    <p class="bund">RESULTS:</p>

                    <p>Based on your results of the 2017 Zeller Plastik wellness screening, you <span class="bund">DO NOT</span>
                    ...
                    <p>In order to receive the discount, we <strong>must</strong> have documentation from your Physician
                     acknowledging the "Healthy Measure" areas of concern. This <a href="/resources/9391/Zeller Plastik Alternate Qual. Form.pdf">Alternate Qualification Form</a>
                     will need to be completed by your physician, and returned to Empower Health Services. If your completed
                    ...
                    <p>
                        Fax Number: 630.385.0156 <br />
                        Mailing Address: Empower Health Services - 4255 Westbrook Dr. Suite 223 Aurora, IL 60504 - Attention Allison Hall
                    </p>
                </div>
            <?php endif ?>
