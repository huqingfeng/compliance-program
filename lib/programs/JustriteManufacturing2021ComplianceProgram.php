...
class JustriteManufacturing2021ManufacturingAlternativeComplianceStatusMapper extends ComplianceStatusMapper
{
...
class JustriteManufacturing2021ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $this->setComplianceStatusMapper(new JustriteManufacturing2021ManufacturingAlternativeComplianceStatusMapper());
        ...
        $hraView->emptyLinks();
        $hraView->addLink(new Link('Take HRA', '/compliance/hmi-2016/my-results/content/my-health'));
        ...
        $rasPhysician->addLink(new Link('RAS Physician Verification Form <br />', '/resources/10670/Justrite_2021_RAS_052021.pdf'));
        $rasPhysician->addLink(new Link('Submit Form', 'http://ehsupload.com/', false, "_blank"));
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new JustriteManufacturing2021ComplianceProgramReportPrinter();
        }
    ...
    protected function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        if ($rasPhysicianStatus->getStatus() == ComplianceStatus::COMPLIANT) {
...
class JustriteManufacturing2021ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-comply_with_bmi_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1578">View Result</a>');
                ...
                $('.view-comply_with_blood_pressure_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1578">View Result</a>');

                $('.view-comply_with_glucose_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">• Blood Sugar < 110</span>');
                $('.view-comply_with_glucose_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1578">View Result</a>');
                ...
                $('.view-comply_with_total_cholesterol_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1578">View Result</a>');
        ...
        <p>
            Welcome to your summary page for the 2021 Justrite Screening Criteria and Premium Discounts.
            <strong>
                The deadline to complete all actions is November 19, 2021. For New Hires, the deadline to complete your
                screening is 30 days from your date of hire. If you desire to complete a RAS Physician Verification Form,
                you will have an additional 30 days to submit the form.
            </strong>
         </p>
