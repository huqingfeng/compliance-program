...
class PorterPipe2015ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new PorterPipe2015ComplianceProgramReportPrinter();
    }
...
class PorterPipe2015ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <?php if($this->shouldShowPassTable($status)) : ?>
                <p>Thank you for participating in the 2015 Wellness Screening. Porter Pipe & Supply is committed to helping you
                    achieve your best health. In partnership with Health Maintenance Institute, Inc., Porter Pipe has selected five "Healthy
                Measures" for you to achieve.</p>

                <p>Rewards for participating in the wellness program are available to all employees.
                Participants who complete a verified Non-Tobacco User Affidavit and fall within the acceptable range for at least
                <span class="bund">three</span> out of the five "Healthy Measures" shown below will be eligible for a wellness discount for the 2016 plan year.</p>

                <?php echo $this->getPassTable($status) ?>

                <p>CONGRATULATIONS! Based on your results above, you fall within the acceptable range for at least three "Healthy Measures".
                ...
                <p>If you have any questions, please contact Allison Osoba at Health Maintenance Institute: (847)635-6580 or
                    <a href="mailto:allison@hmihealth.com">allison@hmihealth.com</a></p>
            ...
            <?php else : ?>
                ...
                <p>If you do not fall within the acceptable range for at least three measures, or are medically unable to meet a standard for
                ...
                <p>Based on your results above, you <span class="bund">DO<?php echo $status->getPoints() < 3 ? ' NOT' : '' ?></span> fall within the acceptable
                    range for at least three "Healthy Measures". Although you do not immediately qualify for the maximum wellness discount, you may still
                ...
                <p>Instructions for completing the Alternative Stardard are included in the results packet mailed to your home. You may also
                    contact Allison Osoba at Health Maintenance Institute (<a href="mailto:allison@hmihealth.com">allison@hmihealth.com</a> or (847)635-6580
                ...
                <p><strong>All eLearning and Health Coaching Lessons must be completed by November 30th, 2015.</p></strong>
            <?php endif ?>
