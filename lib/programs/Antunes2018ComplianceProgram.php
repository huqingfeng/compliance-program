<?php
define("ANTUNES_ACTIVITY_RECORD",  "antunes_activities_2018");

class Antunes2018ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $screeningView->addLink(new Link('Results', '/compliance/antunes2018/my-health'));
        ...
        $quarter1->addLink(new Link('Log Activity', '/content/antunes_activities?year=2019'));
        ...
        $quarter2->addLink(new Link('Log Activity', '/content/antunes_activities?year=2019'));
        ...
        $quarter3->addLink(new Link('Log Activity', '/content/antunes_activities?year=2019'));
        ...
        $quarter4->addLink(new Link('Log Activity', '/content/antunes_activities?year=2019'));
    ...
    {
        return new Antunes2018ComplianceProgramReportPrinter();
    }
}

class Antunes2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        $this->setShowLegend(true);
        $this->pageHeading = '2019 Wellness Program';
