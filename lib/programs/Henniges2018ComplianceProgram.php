...
class Henniges2018CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class Henniges2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Henniges2018WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new Henniges2018CompleteScreeningComplianceView('2017-12-01', '2018-11-30');
        ...
        $screeningView->setAttribute('deadline', '11/30/2018');
        ...
        $scavengerHuntGroup = new ComplianceViewGroup('scavenger_hunt_group', 'Scavenger Hunt');

        $scavengerHuntView = new PlaceHolderComplianceView(ComplianceStatus::NOT_COMPLIANT);
        $scavengerHuntView->setName('scavenger_hunt');
        $scavengerHuntView->setReportName('Scavenger Hunt');
        $scavengerHuntGroup->addComplianceView($scavengerHuntView);

        $this->addComplianceViewGroup($scavengerHuntGroup);
    }
...
class Henniges2018WMS2Printer implements ComplianceProgramReportPrinter
{
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if($user->getClientId() == 3748) : ?>
                                ...
                                <p>To earn your 2018 incentives, you must complete the following requirements by <strong>August 31, 2018</strong>:</p>

                                <ul>
                                    <li>Health Risk Assessment questionnaire</li>
                                    <li>MDLive Registration & On-line Scavenger Hunt</li>
                                </ul>

                                <p>
                                    If you do this, you will receive up to $75 (team member only) or $150 (all other tiers)
                                    contribution to your Health Savings Account (HSA) if you are enrolled in the Henniges
                                    Choice PPO Plan with Health Savings Account or the Henniges Basic PPO Plan with Health
                                    Savings Account. This contribution amount will count towards your annual contribution
                                    maximum. Incentives for 2018 will payout after the 1st, 2nd and 3rd quarters of 2018.
                                </p>

                                <p>
                                    To earn your January 2019 incentive, you must complete the following requirements:
                                </p>

                                <ul>
                                    <li>
                                        Submit a completed physician screening form to Circle Wellness (forms can be found
                                        ...
                                        physician by 11/30/2018. You will need to take the Physician Form to your appointment
                                        and have your physician provide results for all listed items. Exams must be completed
                                        between 12/1/2017 and 11/30/2018. Physician Forms must be received by Circle Wellness
                                        no later than <strong>11/30/2018</strong>.
                                    </li>
                                </ul>
                                <p>
                                    The report card outlines your requirements and will help you keep track of your progress
                                    throughout the program. If you choose not to complete the requirements, you will not
                            ...
                            <?php elseif($user->getClientId() == 3751) : ?>
                                ...
                                <p>
                                    Welcome to the 2018 Henniges Automotive wellness program! Complete the wellness steps
                                    in 2018 to receive a prize for participating & be entered into a raffle for a larger prize!
                                    To be entered in the 2018 raffles, please complete the following by <strong>August 31, 2018</strong>:
                                </p>
                                ...
                                <p>To qualify for the January 2019 raffle, you must complete the following requirements:</p>
                                <ul>
                                    <li>
                                        Submit a completed physician screening form to Circle Wellness (forms can be found
                                        on the home page of this site by clicking on the “Physician Form” button or from
                                        ...
                                        completed between 12/1/2017 and 11/30/2018. Physician Forms must be received by
                                        Circle Wellness no later than <strong>11/30/2018</strong>.
                                    </li>
                                </ul>
                                <p>
                                    The report card outlines your requirements and will help you keep track of your progress
                            ...
                            <?php else : ?>
                                ...
                                <p>
                                    If you do this, you will receive up to $175 (team member only) or $350 (all other tiers)
                                    contribution to your Health Savings Account (HSA) if you are enrolled in the Henniges
                                    Choice PPO Plan with Health Savings Account or the Henniges Basic PPO Plan with Health
                                    Savings Account. This contribution amount will count towards your annual contribution
                                    maximum. If you are enrolled in the Henniges PPO plan, you will receive up to $25 (team
                                    member only) or $50 (all other tiers) incentive paid into your paycheck (this is considered
                                    taxable earnings). Incentives for 2018 will payout after the 1st, 2nd and 3rd quarters of 2018.
                                </p>
                                ...
                                <ul>
                                    <li>
                                        Submit a completed physician screening form to Circle Wellness (forms can be found
                                        on the home page of this site by clicking on the “Physician Form” button or from
                                        your HR department). Schedule and complete your physician screening with your
                                        personal physician by 11/30/2018. You will need to take the Physician Form to your
                                        appointment and have your physician provide results for all listed items. Exams must
                                        be completed between 12/1/2017 and 11/30/2018. Physician Forms must be received
                                        by Circle Wellness no later than <strong>11/30/2018</strong>.
                                    </li>
                                </ul>
                                <p>
                                    The report card outlines your requirements and will help you keep track of your progress
