...
class SBC2014ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new SBC2014ComplianceProgramReportPrinter();
    }
}

class SBC2014ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p><strong>Step 4</strong>- Complete 3 e-learning lessons of your choice by 10/1/2014</p>
