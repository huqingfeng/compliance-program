<?php
define("ANTUNES_ACTIVITY_RECORD",  "antunes_activities_2020");

class Antunes2020ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $quarter1->addLink(new Link('Log Activity', '/content/antunes_activities?year=2020'));
        ...
        $quarter2->addLink(new Link('Log Activity', '/content/antunes_activities?year=2020'));
        ...
        $quarter3->addLink(new Link('Log Activity', '/content/antunes_activities?year=2020'));
        ...
        $quarter4->addLink(new Link('Log Activity', '/content/antunes_activities?year=2020'));
    ...
    {
        return new Antunes2020ComplianceProgramReportPrinter();
    }
}

class Antunes2020ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        $this->setShowLegend(true);
        $this->pageHeading = '2020 Wellness Program';
