...
class MizkanAmerica2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new MizkanAmerica2020ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '8/31/2020');
        ...
        $ldlView->setReportName('A. Achieve <strong>LDL Cholesterol</strong> of 120 or less <strong>–OR–</strong> have your 2020 result be at least 15 mg/dL lower than your 2019 LDL result');
        ...
        $trigView->setReportName('B. Achieve <strong>Triglycerides</strong> of 150 or less <strong>–OR–</strong> have your 2020 result be at least 15 mg/dL lower than your 2019 Triglycerides result');
        ...
        $gluView->setReportName('C. Achieve <strong>Blood Glucose</strong> of 110 or less <strong>–OR–</strong> have your 2020 result be at least 15 mg/dL lower than your 2019 Glucose result');
        ...
        $bmiView->setReportName('D. Achieve a <strong>Body-Mass Index (BMI)</strong> of 27.5 or less <strong>–OR–</strong> have your 2020 result be at least 3 points lower than your 2019 BMI result');
        ...
        $view->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use($alias, $test, $calculationMethod, $threshold) {
            ...
            if ($cache['this'] || $cache['last']) {
                ...
                if ($thisVal && $lastVal) {
                    ...
                    $status->setAttribute('2019_2020_change', round($change, 1));
...
class MizkanAmerica2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                Thank you for participating in the 2020 Mizkan America Wellness Screening. In partnership with Empower
            ...
            <p style="font-weight: bold;">2020 Wellness-Screening Results</p>
            ...
            <p>
                <ul>
                    ...
                    <li>The Wellness Credits earned during the 2020 Wellness Screening will be effective on 1/1/2021</li>
                </ul>
            </p>

            <p style="font-weight: bold; color:red; text-align: center">
                <u>
                    For existing employees/spouses - The deadline for completing the e-learning lessons in order to <br/>
                    retain your wellness credits for the 2021 plan year was Monday, September 20,2020.<br/><br/>
            ...
            <p style="font-weight: bold; text-align: center; font-size:10pt;">
                Thank you again for your participation in the 2020 Mizkan America Wellness Screening.  Should you have any
            ...
            <table id="results">
                <tbody>
                    ...
                    <tr class="status-<?php echo $viewStatus->getStatus() ?>">
                        <td style="text-align: left; padding-left: 10px;">Complete the 2020 Mizkan Wellness Screening <br /> <span style="font-size:10pt;">(on-site or at an approved lab)</span></td>
