...
class CHW2016MARCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW2016MARComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $week1View->setReportName('Week 1 M-F - March 14-18');
        ...
        $week2View->setReportName('Week 2 MWF - May 11-14');
        ...
        $quizLawsView = new CHW2016MARCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365));
        ...
        $quizVitalView = new CHW2016MARCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
    ...
    {
        $printer = new CHW2016MARComplianceProgramReportPrinter();
...
class CHW2016MARComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
