...
class GVT2011ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new GVT2011Printer();
...
class GVT2011Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p>
        <a href="/compliance_programs/index?id=7">
            View your 2010 Program
        </a>
    </p>
    <p>
        ...
        fulfilling your requirement. By completing the following steps in 2011
        you will be eligible for a premium reduction in your health plan
        effective 01/01/2012.</p>
    <p>
        ...
        Screenings will be scheduled again beginning in August/September of 2011
    ...
    <p>
        ...
        based on your 2011 health screening results. If you have a medical reason
        for not being able to reach one or more of the requirements listed below,
        you can contact Casey Frazee in Human Resources to discuss a
