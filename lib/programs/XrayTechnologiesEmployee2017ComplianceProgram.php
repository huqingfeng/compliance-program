...
define('XRAY_FIVE_FOR_FIVE_CAMPAIGN', 'chp_five_for_five_campaign_2016');

class XrayFiveForFive2016ComplianceView extends ComplianceView
{
...
class XrayTechnologiesEmployee2017ComplianceProgram extends ComplianceProgram
{
...
//            $data['Has Biometric Override'] = $status->getAttribute('has_biometric_override') ? 'Yes' : 'No';
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2', true)) {
            return new XrayTechnologiesEmployee2017WMS2Printer();
        } else {
            $printer = new XrayTechnologiesEmployee2017Printer();
    ...
    public function loadGroups()
    {
        ...
        $coachingOverall->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            $notRequired = SelectQuery::create()
                ...
                ->andWhere('compliance_program_record_id = ?', array(XrayTechnologiesEmployee2017ComplianceProgram::XRAYTECHNOLOGIES_EMPLOYEE_2016_RECORD_ID))
        ...
        $spouseParticipation->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if(!$spouseUser)  {
                ...
                $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologiesEmployee2017ComplianceProgram::XRAYTECHNOLOGIES_EMPLOYEE_2016_RECORD_ID)->getComplianceProgram();
...
//        $biometricsGroup->addComplianceView($smokingView);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $priorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($user, '2016-01-01', '2016-12-31');
    ...
    const XRAYTECHNOLOGIES_EMPLOYEE_2016_RECORD_ID = 813;
}

class XrayTechnologiesEmployee2017Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
...
class XrayTechnologiesEmployee2017WMS2Printer implements ComplianceProgramReportPrinter
{
