...
class XrayTechnologies2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new XrayTechnologies2021WMS2Printer();
    }
    ...
    function getRisk(User $user) {
        ...
        $hra = HRA::getNewestHRABetweenDates($user, '2021-08-01', '2021-11-02', false, false);
        $hraData = $hra->getHRA();
        ...
        $risk = getChpExtendedRiskForUser($user, array_unique(array_merge(array_keys($riskIdentifiers), array_keys($resultIdentifiers))), !empty($hraData['id']) ? $hraData['id'] : false, !empty($screeningData['id']) ? $screeningData['id'] : false, '2021-08-01', '2021-11-02');
    ...
    public function loadGroups()
    {
        ...
        $spouseParticipation->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if(!$spouseUser || (isset($this->options['in_spouse']) && $this->options['in_spouse']))  {
                ...
                $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologies2021ComplianceProgram::XRAYTECHNOLOGIES_2021_RECORD_ID)->getComplianceProgram(array('in_spouse' => true));
    ...
    const XRAYTECHNOLOGIES_2021_RECORD_ID = 1605;
}


class XrayTechnologies2021WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div id="">
            <h3>2021 X-Ray Report Card</h3>
            <div class="main-content">
                <p>Due to the many unknowns of the COVID 19 Pandemic and the challenges we may continue to face, the 2021 wellness program will offer the same simplified requirements this year while giving you a more in-depth picture of your well-being.</p>
            ...
            <div class="basic-report-card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 actions">
                        <a class="btn btn-primary btn-sm" href="/compliance/xray-industries-2021/hra/content/my-health">Take HRA</a>
                    </div>
                    <div class="col-sm-2 icon hra"><?= $hra_status; ?></div>
                </div>
                <div class = "alert alert-norisk" style="display: inline-block;">Complete between 8/1/2021 & 11/2/2021</div>
                <div class="row">
                    <div class="col-sm-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 actions">
                        ...
                        <a class="btn btn-primary btn-sm top-buffer-10" href="/resources/10676/Xray_Industries_2021_Physician_Form.pdf" target="_blank">Download Physician Form</a>
                    </div>
                    <div class="col-sm-2 icon screening"><?= $screening_status; ?></div>
                </div>
                <div class = "alert alert-norisk">Request an on-demand packet to take to a local LabCorp location or download the physician form and bring it to your doctor. Complete between 8/1/2021 & 11/2/2021</div>
                <div class="row">
                    <div class="col-sm-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 actions">
                        <a class="btn btn-primary btn-sm" href="http://www.static.hpn.com	/resources/10675/2021_X-RAY_Physician_Verification_Form.pdf" target="_blank">Download Form</a>
                    </div>
