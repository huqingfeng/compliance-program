...
class WMSDEMOALT2020ReportCardVisitHealthUComplianceView extends ComplianceView
{
...
class WMSDEMOALT2020ReportCardCompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class WMSDEMOALT2020CoreReportCardComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $wms1Id = $user->getId();
        $wms2Id = $user->getWms2UserId();//$_GET['wms2Id'];
        $wms2Account = $user->getWms2AccountId();//$_GET['wms2AccountId'];
        ...
        if ($_GET['view'] == "ajax") {
            $url = $domain."wms3/public/wmsdemoaltcore?bypass=true&clientId=ucmc&token=7bc9b94d-8a55-410c-bec8-4787d02c0e7b&view=ajax&wms1Id=$wms1Id&action=".$_GET['action']."&value=".$_GET['value']."&category=".$_GET['category'];
            ...
            $url = $domain."wms3/public/wmsdemoaltcore?bypass=true&&view=".$_GET['view']."&relationship=".$relationship($_GET['relationship'])."&wms1Id=".$wms1Id."&wms2Id=".$wms2Id."&wms2Account=".$wms2Account."&contactInfoUpdated=".$lastUpdated;
        ...
        $url.='&program_id='.$program;
        $url.='&reportcard_year='. $program_year;

        if(isset($_GET['template_test'])) {
            $url.='&template_test=true';
        }
        ...
        echo '<script src="https://master.hpn.com/wms3/public/assets/plugins/datepicker/datepicker.js"></script>';
        echo $result;
        return ;
    }
...
class WMSDEMOALT2020ReportCardComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
class WMSDEMOALT2020ReportCardScreeningTestPrinter extends ScreeningProgramReportPrinter
{
