...
class Midland2018TobaccoFormComplianceView extends ComplianceView
{
...
class Midland2018ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'Core Actions to get done by 1/31/19 for your Core Reward and toward your Bonus Reward:');
        ...
        $screeningView->addLink(new Link('Results', '/compliance/midland-paper-2018/my-results'));
        ...
        $hraView->setName('hra');
        $hraView->emptyLinks();
        $hraView->addLink(new Link('Take HRA', '/compliance/midland-paper-2018/my-health'));
        $hraView->addLink(new Link('Results', '/compliance/midland-paper-2018/my-health'));
        $coreGroup->addComplianceView($hraView);

        $this->addComplianceViewGroup($coreGroup);

        $numbers = new ComplianceViewGroup('points', 'And, earn at least 350 points by 1/31/19 through the opportunities below for your Bonus Reward:');
...
//        $hdlCholesterolView->overrideTestRowData(0, 0, 4.499, 4.499);
        ...
        $nonSmokerView = new Midland2018TobaccoFormComplianceView($programStart, $programEnd);
        ...
        // $physicalActivityView->addLink(new Link('Sync/Enter Steps', '/compliance/midland-paper-2018/fitness-tracking-wms3/compliance_programs?id=1358&forceRefresh=true&wms1Id='.$wms1ID.'&wms2AccountId='.$wms2AcctID.'&prefix=midland-paper-2018&device=1'));
        ...
        $physicalActivityView->setReportName('Get Regular Physical Activity - use one or both below to sync or update for exercise/activity points between 2/1/18 and 1/31/19');
        $physicalActivityView->setMaximumNumberOfPoints(250);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinterMidland' && $this->getActiveUser() !== null) {
            ...
            $printer = new Midland2018ComplianceProgramReportPrinter();
        }
...
class Midland2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your summary page for the 2019 Midland Paper Wellness Rewards benefit.</p>

        <p><em>Do you have medical benefit coverage through Midland Paper?</em> If yes, you can earn rewards of $480 to $1,080 ($40-$90 per month) in savings toward your 2019 medical plan premium contribution.</p>

        <p>
            Here’s how:
        <ol>
            <li><strong>Core Reward</strong> – complete the Wellness Screening and Health Power Assessment by 1/31/19 and get:
                <ol type="a">
            ...
            <li><atrong>And a Bonus Reward</atrong> – get the core actions (above) done <strong>PLUS</strong> earn at least 350 points by 1/31/19 and:
                <ol type="a">
        ...
        <p>
            ...
            <span style="font-size: 14pt; text-align: center; display: block;"><a href="/content/1094_midlandpaper_2018">Click here for more details about each action and point-earning option.</a> </span>
        </p>
    ...
    { 
        ...
        $light_map = [
            ComplianceStatus::NOT_COMPLIANT => "/compliance/midland-paper-2018/my-rewards/images/lights/redlight.gif",
            ComplianceViewStatus::PARTIALLY_COMPLIANT => "/compliance/midland-paper-2018/my-rewards/images/lights/yellowlight.gif",
            ComplianceViewStatus::NA_COMPLIANT => "/compliance/midland-paper-2018/my-rewards/images/lights/whitelight.gif",
            ComplianceViewStatus::COMPLIANT => "/compliance/midland-paper-2018/my-rewards/images/lights/greenlight.gif"
        ];
           ...
           <thead id="legend">
              <tr>
                 <td colspan="6">
                    ...
                    <div class="legendEntry"><img src="/compliance/midland-paper-2018/my-rewards/images/lights/greenlight.gif" class="light" alt="">= Criteria Met</div>
                    <div class="legendEntry"><img src="/compliance/midland-paper-2018/my-rewards/images/lights/whitelight.gif" class="light" alt="">= N/A</div>
                    <div class="legendEntry"><img src="/compliance/midland-paper-2018/my-rewards/images/lights/yellowlight.gif" class="light" alt="">= Working on It</div>
                    <div class="legendEntry"><img src="/compliance/midland-paper-2018/my-rewards/images/lights/redlight.gif" class="light" alt="">= Not Started</div>
                 </td>
              </tr>
           </thead>
           <tbody>
              <tr class="headerRow headerRow-core">
                 <th><strong>1</strong>. Core Actions to get done by 1/31/19 for your Core Reward and toward your Bonus Reward:</th>
                 <td></td>
                 <td>Completed</td>
                 <td>Status</td>
                 <td>Links</td>
              ...
              <tr class="headerRow headerRow-points">
                 <th><strong>2</strong>. And, earn at least 350 points by 1/31/19 through the opportunities below for your Bonus Reward:</th>
                 <td>My Steps</td>
                 <td># Points Earned</td>
              ...
              <tr>
                 ...
                 <td></td>
                 <td></td>
                 <td style="text-align: center;"><a href="/compliance/midland-paper-2018/my-rewards/compliance_programs?preferredPrinter=ScreeningProgramReportPrinterMidland&amp;id=1227">View Results &amp; point scale</a></td>
              </tr>
