...
class MattersightCorporationLearningAlternativeComplianceView extends ComplianceView
{
...
class MattersightCorporation2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new MattersightCorporation2016ComplianceProgramReportPrinter();
    }
...
class MattersightCorporation2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/8475/EHS Mattersight Corp IRC Alt To-Do Doctor Support Form rev 093016.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 7, 2016</strong>
                            </td>
                         <?php endif ?>
                    </tr>
