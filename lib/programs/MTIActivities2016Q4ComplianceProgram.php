...
class MTIActivities2016Q4WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validQ4Weeks = array(
        1 => '10/03/2016 through 10/09/2016',
        2 => '10/10/2016 through 10/16/2016',
        3 => '10/17/2016 through 10/23/2016',
        4 => '10/24/2016 through 10/30/2016',
        5 => '10/31/2016 through 11/06/2016',
        6 => '11/07/2016 through 11/13/2016',
        7 => '11/14/2016 through 11/20/2016',
        8 => '11/21/2016 through 11/27/2016',
        9 => '11/28/2016 through 12/04/2016',
        10 => '12/05/2016 through 12/11/2016',
        11 => '12/12/2016 through 12/18/2016',
        12 => '12/19/2016 through 12/25/2016',
        13 => '12/26/2016 through 01/01/2017'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2016-10-01', '2016-12-31');
    ...
    public function getStatus(User $user)
    {
        ...
        foreach (self::$validQ4Weeks as $text) {
...
class MTIActivities2016Q4ComplianceProgram extends ComplianceProgram
{
    const MTI_2016_ACTIVITY_START_DATE = '2016-10-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2016Q4WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2')) {
            ...
            $printer = new MTIActivities2016Q4ComplianceProgramPrinter();
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2016Q4WeeklyLogComplianceView::$validQ4Weeks[$w])) {
                    $text = MTIActivities2016Q4WeeklyLogComplianceView::$validQ4Weeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2016_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2016Q4ComplianceProgram::MTI_2016_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
...
class MTIActivities2016Q4ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
