<?php
class Culver2014ScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class Culver2014CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class CulverWorkshop2014 extends AttendCompanyWorkshopComplianceView
{
...
class Culver2014LifetimeActivityView extends CompleteActivityComplianceView
{
...
class Culver2014ComplianceProgram extends ComplianceProgram
{
...
//
        ...
        $preventiveExamsView = new Culver2014LifetimeActivityView(
        ...
        $fluVaccineView = new Culver2014LifetimeActivityView(
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new Culver2014ScreeningPrinter();
            ...
            $printer = new Culver2014ComplianceProgramReportPrinter();
        }
...
class Culver2014ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
    ...
    <p></p>
    <p>Welcome to your summary page for the 2013-2014 Culver Academies Wellness Rewards.</p>
    ...
    <ol>
        ...
        <ol style="list-style-type:lower-alpha;">
            <li>Complete ALL core actions listed in table below by December 31, 2013: AND</li>
            <li>Earn at least 200 points through the options in the table below by July 31, 2014.
        </ol>
        <li>Spouses must complete the Health Power Assessment (1A) and Wellness Screening (1B) by December 31, 2013</li>
    </ol>
