...
class WTTW2013ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
   ...
   < <tr>
    ...
    <p>
        Welcome to your summary page for the 2013 Wellness Rewards benefit at WWCI.
        This year, we are introducing a new wellness rewards incentive program.
    </p>

    <p>In 2013, the wellness rewards will be gift cards.</p>
    ...
    <p>
        ...
        Silver and Gold levels of achievement and success where you join with
...
class WTTW2013ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new WTTW2013ComplianceProgramReportPrinter();
    ...
    public function loadEvaluators()
    {
        ...
        $q2Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2013-06-30'), array(), 150);
        ...
        /*$q3Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2013-09-30'), array(), 200);
        ...
        $q4Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2013-12-31'), array(), 250);
