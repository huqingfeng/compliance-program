...
class HMI2011ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    <p>
        Welcome to your summary page for the 2012 Wellness Rewards benefit at WTTW.
...
class HMI2011ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new HMI2011ComplianceProgramReportPrinter();
    ...
    public function loadEvaluators()
    {
        ...
        $q4Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2012-12-31'), array(), 300);
        $q4Deadline->setReportName('Q4 Status - By <strong>12/31/2012</strong>');
        $q4Deadline->setName('q4');
        $totalsGroup->addComplianceView($q4Deadline);

        $goldView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2012-12-31'), array(), 500);
    ...
    public function loadGroups()
    {
        ...
        $workshopView = new AttendCompanyWorkshopComplianceView($startDate, $endDate, 10);
