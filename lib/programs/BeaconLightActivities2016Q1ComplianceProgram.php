...
class BeaconActivities2016Q1DailyLogComplianceView extends CompleteActivityComplianceView
{
...
class BeaconLightActivities2016Q1ScreeningConfirmationComplianceView extends ComplianceView
{
...
class BeaconLightActivities2016Q1ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2016Q1DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q1ComplianceProgram::LIGHT_SPECTRUM_2015_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q1ComplianceProgram::LIGHT_ACTIVITIES_2016_Q1_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2016Q1ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2016Q1ScreeningConfirmationComplianceView($startDate, $endDate);
    ...
    const LIGHT_ACTIVITIES_2016_Q1_RECORD_ID = 710;
    const LIGHT_SPECTRUM_2015_RECORD_ID = 533;
}



class BeaconLightActivities2016Q1ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
