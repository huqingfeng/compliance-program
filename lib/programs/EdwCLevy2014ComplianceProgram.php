...
class EdwCLevy2014ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new EdwCLevy2014ComplianceProgramReportPrinter();
    }
}

class EdwCLevy2014ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    <p>Welcome to The Edw. C. Levy Co. Wellness Website! This site was developed not only to track
        ...
        in the Levy Medical Plan or beginning January 1, 2015 you and family will be enrolled in the Standard Plan
