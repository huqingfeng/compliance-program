...
class Medtronic2019CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class Medtronic2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Medtronic2019ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView = new Medtronic2019CompleteScreeningComplianceView($programStart, $programEnd);
        ...
        $screeningView->setAttribute('goal', '12/9/19');
...
class Medtronic2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                Congratulations for participating in the 2019 Wellness Screening program. Below is a chart that outlines
            ...
            <p style="text-align: center; font-size: 13pt;">Your Healthy Measures Results for 2019</p>
        ...
        <p>
            <img src="/resources/10330/Medtronic_AQF_19-page.jpg" />
        </p>
    <?php endif ?>
                    ...
                    <tr>
                        <td colspan="7">
                            ...
                            <?php if($healthyGroupStatus->getStatus() == ComplianceStatus::NOT_COMPLIANT && $coreStatus->getComplianceViewStatus('complete_screening')->getComplianceView()->getAttribute('has_screening')) : ?>
                                <p style="color: red;">
                                    You may complete and return the <a href="/resources/10326/2019_Medtronic_AQF_032519.pdf">Alternate Qualification Form</a>
