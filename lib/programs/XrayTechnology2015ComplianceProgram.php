...
class XrayTechnologies2015BFMapper extends ComplianceStatusPointMapper
{
...
class XrayTechnologies2015ComplyWithBodyFatBMIScreeningTestComplianceView extends ComplyWithBodyFatBMIScreeningTestComplianceView
{
...
class XrayTechnologies2015ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new XrayTechnologies2015Printer();
    ...
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView('2015-09-01', '2015-11-30');
        $hraView->setReportName('Health Risk Assessment(HRA)');
        $preventionEventGroup->addComplianceView($hraView);

        $screeningView = new CompleteScreeningComplianceView('2015-05-01', '2015-11-30');
...
class XrayTechnologies2015Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    public function printClientNote()
    {
        ?>
        <p>
            <a href="/compliance_programs/index?id=248">
...
public function printClientMessage()
{
    ...
    <ol>
        <li>
            Complete an online Health Risk Assessment by <strong>November 30, 2015</strong>.
        </li>
        <li>
            Complete an onsite Health Screening by <strong>November 30, 2015.*</strong>
        </li>
        <li>
