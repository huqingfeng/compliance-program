...
class HighlandPark2018HomePageComplianceProgram extends ComplianceProgram
{
...
//                $status->setStatus(ComplianceStatus::COMPLIANT);
        ...
        $winView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if($activeProgramRecord->id == 1345) {
...
class HighlandPark2018ComplianceProgram extends ComplianceProgram
{
    public function loadEvaluators()
    {
    ...
    {
        return new HighlandPark2018ComplianceProgramReportPrinter();
    }
}

class HighlandPark2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        $this->setShowLegend(true);
        $this->pageHeading = '2018 WIN (Wellness Initiative Program)';
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('tr.view-mine').prev('tr.headerRow').find('td').last().html(
                    'Minimum Points Needed for Incentive By 10/31/2018'
                );
