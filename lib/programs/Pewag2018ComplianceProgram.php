...
class Pewag2018ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new Pewag2018ComplianceReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $required = new ComplianceViewGroup('required', 'A & B are required by March 23, 2018.');

        $hraScreeningEndDate = '2018-03-23';
        ...
        $pointsGroup = new ComplianceViewGroup('points', 'Gain points through actions taken in option areas C - L below by the Dec 17, 2018 deadline in order to be put in the raffle for the quarterly $20 gift cards.');
...
class Pewag2018ComplianceReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function(){
                ...
                $('.view-ldl').children('.links').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1317">Click here for the 3 results</a>');
        ...
        <p>Welcome to your summary page for the 2018 Wellness Rewards benefit at pewag.</p>

        <p>You MUST register with HMI, complete the annual wellness screening and complete the Health Power Assessment
            by March 23, 2018. (Section 1 below).</p>
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <p style="margin-top: 20px; margin-left: 200px;">
            <strong>Quarter 1:</strong> Earn at least 75 pts by March 31, 2018 <br/>
            <strong>Quarter 2:</strong> Earn at least 150 pts by June 30, 2018 <br/>
            <strong>Quarter 3:</strong> Earn at least 250 pts by September 30, 2018 <br/>
            <strong>Quarter 4:</strong> Earn at least 350 pts by December 17, 2018 <br />
        </p>
        <?php
    }
}