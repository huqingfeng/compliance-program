<?php
class Culver2012ScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class Culver2012CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class Culver2012LifetimeActivityView extends CompleteActivityComplianceView
{
...
class Culver2012ComplianceProgram extends ComplianceProgram
{
...
//
        ...
        $preventiveExamsView = new Culver2012LifetimeActivityView(
        ...
        $fluVaccineView = new Culver2012LifetimeActivityView(
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new Culver2012ScreeningPrinter();
            ...
            $printer = new Culver2012ComplianceProgramReportPrinter();
        }
...
class Culver2012ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
    ...
    <p></p>
    <p>Welcome to your summary page for the 2011-2012 Culver Academies Wellness Rewards.</p>

    <p>To receive the incentives, eligible employees and spouses MUST take certain actions and meet the criteria
        specified below:</p>
    <ol>
        <li>Complete ALL core actions listed in table below by March 1, 2012: AND</li>
        <li>Earn at least 200 points through the options in the table below by July 31, 2012.</li>
    </ol>
    ...
    <p>Important: The incentive requirements apply to eligible employees with medical benefits through Culver.
        The employee must meet all criteria above for the employee to receive incentives A and B (above).</p>
    ...
    <tr>
        <td style="text-align: right;"><?php echo $aprilStatus->getComplianceView()->getReportName() ?></td>
        <td class="center"><?php echo $aprilStatus->getPoints(); ?></td>
        <td class="center"><img src="<?php echo $aprilStatus->getLight(); ?>" class="light"/></td>
        <td class="center"></td>
    </tr>
    </tbody>
    </table>
    <p style="margin-top:4px;font-style:italic;">* To qualify for the Early Bird Raffle you must: 1) Be an employee or
        spouse in the Culver health plan; 2) Have all actions in section 1 done
        by 3/1/12; and 3) Have 200 or more points in section 2 by 4/15/12.</p>
    <?php
    }
}
