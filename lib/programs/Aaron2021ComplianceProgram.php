...
class Aaron2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Aaron2021ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '10/01/2021');
        ...
        $hraView->setAttribute('goal', '10/01/2021');
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        foreach($healthGroupStatus->getComplianceViewStatuses() as $viewStatus) {
            ...
            $noncompliant_values = ['QNS', 'TNP', "DECLINED"];
            if (in_array(strtoupper($viewStatus->getAttribute('real_result')), $noncompliant_values)) {
...
class Aaron2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10679/Aaron_Equipment_2021_AQF_080421.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN October 31, 2021</strong>
                            </td>
                         <?php endif ?>
                    </tr>
