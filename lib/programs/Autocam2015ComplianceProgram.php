...
class Autocam2015ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView($programStart, '2015-09-30');
        $hraView->setName('hra');
        ...
        $physicianForm->setAlternativeComplianceView(
            new CompleteScreeningComplianceView('2014-09-01', '2015-09-30')
        );
    ...
    {
        return new Autocam2015ComplianceProgramReportPrinter();
    }
}

class Autocam2015ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <tbody>
            ...
            <tr class="requiredrow">
                <td class="requirementscolumn">
                    ...
                    <a href="/content/11358" class="moreinfo">- more info</a>
                    <br/>
                    Receive from your Primary Care Physician (Exam must be completed between 04/1/14 - 09/30/15)<a
                    href="/resources/5368/2015-Physician-Form-Autocam-medical-with91deadline.022015.pdf">Download Physician Form</a>
                </td>
                <td class="myrequirementscolumn">
                    Yearly, Due 09/30/2015
                </td>
                <td class="statuscolumn">
