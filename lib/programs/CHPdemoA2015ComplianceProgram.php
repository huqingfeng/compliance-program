...
class CHPDemoA2015Printer extends CHPShapeComplianceProgramReportPrinter
{
    public function printHeader(ComplianceProgramStatus $status)
    {
        ?>
        <p><img src="/resources/5594/chpDemoAbanner.png" /></p>
    ...
    public function  printFooter(ComplianceProgramStatus $status)
    {
        ...
        <p>This program is designed to promote good health and disease prevention. The program
            applies to all employees of this organization. If it is unreasonably
            ...
            administering the reasonable alternative. Please contact wellness coordinators for more information on reasonable alternatives.</p>
        <?php
    }
}
...
class CHPDemoA2015ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new CHPDemoA2015Printer();
    }
