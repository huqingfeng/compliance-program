...
class Medpro2015ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
...
class Medpro2015ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new Medpro2015ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $newCotinineView = new ComplyWithCotinineScreeningTestComplianceView('2015-01-01', '2015-12-31');
        $newCotinineView->setReportName('Cotinine 2015');
        $newCotinineView->setName('cotinine_2015');
        $newCotinineView->setPostEvaluateCallback(
            $this->setNaIfCompliant(array($cotinine2011View, $cotinine2012View, $cotinine2013View, $cotinine2014View))
        );
