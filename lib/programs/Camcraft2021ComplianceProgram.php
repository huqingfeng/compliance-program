...
class Camcraft2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Camcraft2021ComplianceProgramReportPrinter();
    }
...
class Camcraft2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>In order to receive the discount, we must have documentation from your Physician acknowledging the
                     "Health Standard" areas of concern. This <a href="/resources/10618/Camcraft_Matrix_2020_AQF_112520.pdf" target="_blank">
