...
class HMI2018CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class HMI2018ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $screening = new HMI2018CompleteScreeningComplianceView($startDate, $endDate);
