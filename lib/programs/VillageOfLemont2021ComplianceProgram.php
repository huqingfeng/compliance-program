...
class VillageOfLemont2021TobaccoFormComplianceView extends ComplianceView
{
...
class VillageOfLemont2021ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>
            Welcome to your summary page for the 2021 Wellness Rewards benefit at Village of Lemont. This is the eighth
            year of the Village of Lemont's wellness rewards program.
        </p>

        <p>
            In 2021, employees reaching the necessary number of points will receive a discount on their 2021 health
            insurance premium. There will also be incentives for those employees who participate but are not on our
            health plans.
        </p>

        <p>
            In order to earn the first premium discount, you must earn at least 325 points by June 11th, 2021. In order
            to continue to receive a premium discount, you will need to have earned at least a total of 525 points by
            December 15, 2021. You can earn these points from actions taken for your good health and wellbeing across
...
class VillageOfLemont2021ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new VillageOfLemont2021ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalFirstHalfView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2021-01-01', '2021-06-11'), array(), 325);
        $totalFirstHalfView->setReportName('<strong>By 06/11/2021</strong>');
        $totalFirstHalfView->setName('total_first_half');
        $totalsGroup->addComplianceView($totalFirstHalfView);

        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2021-01-01', '2021-12-15'), array(), 525);
        $totalView->setReportName('<strong>By 12/15/2021</strong>');
    ...
    public function loadGroups()
    {
        ...
        $nonSmokerView = new VillageOfLemont2021TobaccoFormComplianceView($startDate, $endDate);
