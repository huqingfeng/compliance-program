...
class BeaconActivities2016Q3DailyLogComplianceView extends CompleteActivityComplianceView
{
...
class BeaconLightActivities2016Q3ScreeningConfirmationComplianceView extends ComplianceView
{
...
class BeaconLightActivities2016Q3ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2016Q3DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q3ComplianceProgram::LIGHT_SPECTRUM_2015_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q3ComplianceProgram::LIGHT_ACTIVITIES_2016_Q3_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2016Q3ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2016Q3ScreeningConfirmationComplianceView($startDate, $endDate);
    ...
    const LIGHT_ACTIVITIES_2016_Q3_RECORD_ID = 807;
    const LIGHT_SPECTRUM_2015_RECORD_ID = 533;
}



class BeaconLightActivities2016Q3ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
