...
class AbtElectronics2019ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'Get Started - Get these done by November 15, 2019');
        $coreEndDate = '2019-11-15';
    ...
    {
        $printer = new AbtElectronics2019ComplianceProgramReportPrinter();
...
class AbtElectronics2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <table class="phipTable" border="1">
            ...
            <tr>
                <td colspan="2">B. If needed, work with your primary care doctor/provide to turn in a Completed
                    Alternate Qualification Form (AQF) by November 15, 2019. Download and print the form which has places
                ...
                <td class="center"><a href="/resources/10402/ABT_AQF_082819.pdf" download>If needed, click here to download the AQF pdf</a></td>
            </tr>
