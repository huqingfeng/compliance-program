...
class MTI2017ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2')) {
            return new MTI2017WMS2Printer();
        } else {
            $printer = new MTI2017Printer();
    ...
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView('2016-10-01', $programEnd);
        ...
        $tobaccoView = new ComplyWithSmokingHRAQuestionComplianceView('2016-12-01', $programEnd);
        ...
        $bloodPressureView = new EvaluateScreeningTestResultComplianceView($screeningModel, 'blood_pressure', $screeningStartDate, $programEnd, $screeningTestAlias);
        ...
        $triglView = new EvaluateScreeningTestResultComplianceView($screeningModel, 'triglycerides', $screeningStartDate, $programEnd, $screeningTestAlias);
        ...
        $glucoseView = new EvaluateScreeningTestResultComplianceView($screeningModel, 'glucose', $screeningStartDate, $programEnd, $screeningTestAlias);
        ...
        $totalHDLRatioView = new EvaluateScreeningTestResultComplianceView($screeningModel, 'total_hdl_cholesterol_ratio', $screeningStartDate, $programEnd, $screeningTestAlias);
        ...
        $bmiView = new EvaluateScreeningTestResultComplianceView($screeningModel, 'bmi', $screeningStartDate, $programEnd, $screeningTestAlias);
...
class MTI2017Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
...
class MTI2017WMS2Printer implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
