...
class Fabrik2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Fabrik2020ComplianceProgramReportPrinter();
    }
...
class Fabrik2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">Get Started – Get these done by <?php echo date('m/d/Y') ?></th>
                        ...
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >0, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 11/06/20.  You can
                                 <a href="/resources/10589/2020_Fabrik_AQF_091820.pdf" download="2020_Fabrik_AQF">download</a>
                            ...
                            <p>
                                ...
                                <a href="/compliance_programs/localAction?id=1542&local_action=dashboardCounts">About the health risk score.</a>
                            </p>
                        </td>
                    </tr>
