...
class GeneralConverting2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new GeneralConverting2021ComplianceProgramReportPrinter();
    }
    ...
    public function configViewForPreEvaluate(ComplianceView $view) {
        $view->setPreMapCallback(function(ComplianceViewStatus $status){
            ...
            if((string) $result == 'declined' || (string) $result == 'Declined') {
...
class GeneralConverting2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <div style="clear: both">
                <div style="width: 100%; margin-top: 10px; display: block">
                    ...
                    <ol type="A">
                        <li><strong>Health Action Reward:</strong> Earn 1,000 points out of the 1,900 possible points by 7/9/21. <strong>Discount = $100/month</strong>.</li>
                        <li><strong>Tobacco Free Reward:</strong> Test negative or complete 5 online tobacco cessation lessons by 8/24/21. <strong>Discount = $100/month</strong>.</li>
                    </ol>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th style="text-align: left; width: 320px;" colspan="2">A. Earn 1,000 or more points by 7/9/21 in any of the ways below:</th>
                    ...
                    <tr>
                        <td style="text-align: left; width: 320px;" colspan="3">
                            ...
                            <em style="color: red;">*  #9 and #10 can be done anytime from 1/1/2021 to 8/24/21 for points – just use the related
