...
class Avlon2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Avlon2019ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '06/18/19');
        ...
        $hraView->setAttribute('goal', '06/18/19');
        ...
        $completeConsultation->setReportName('a. Complete consultation with Dr. Todd by 7/17/19. <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
        ...
        $finalConsultationAlt3->setReportName('d. Complete final consultation with Dr. Todd by 8/14/19. <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
        ...
        $initialConsultation->setReportName('a. Initial consultation with Dr. Todd by 7/17/19. <a href="http://www.inspirecorporatewellness.com/avlon">Click here for details.</a>');
        ...
        $finalConsultation->setReportName('c. Complete consultation with Dr. Todd by 8/14/19.');
...
class Avlon2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <div style="clear: both">
                <div style="width: 100%; margin-top: 10px; display: block">
                    ...
                    <p>Employees can save up to $520 for the 2019-20 plan year by participating and attaining certain health
