...
class NSK2017CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class NSK2017ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new NSK2017WMS2Printer();
    }
    ...
    protected function getPhoneConsultShowed($user)
    {
        $row = SelectQuery::create()
            ...
            ->andWhere('a.date BETWEEN ? AND ?', array('2017-05-01', '2017-12-31'))
    ...
    public function loadGroups()
    {
        ...
        $screeningBiometric = new NSK2017CompleteScreeningComplianceView($programStart, $programEnd);
    ...
    protected function configureViewForElearningAlternative(ComplianceView $view, $alias, $allAliases)
    {
        ...
        $view->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use(&$callCache, $alias, $allAliases, $userIdsToIgnore) {
            ...
            if($view->getStartDate('Y-m-d') != '2017-04-01') {
                return;
            }
    ...
    protected function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $priorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($status->getUser(), '2016-05-01', '2016-12-31');
        $priorPriorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($status->getUser(), '2015-04-01', '2015-12-31');
    ...
    const RECORD_ID = 1135;
}


class NSK2017WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="row">
            <div class="col-md-12">
                <h1>2017 Incentive Report Card</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <a href="/compliance/nsk-2016/overview">Full Program Details</a><br/>
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="activities">
                    ...
                    <tr class="point-totals">
                        <th>2017 Without Alternatives</th>
                        <td><?php echo $maxPriorPoints ?></td>
                ...
                <p>
                    ...
                    <a href="https://static.hpn.com/wms2/documents/clients/nsk/NSK%202017%20Pregnancy%20Exception%20Form.pdf">pregnancy exception form</a>
