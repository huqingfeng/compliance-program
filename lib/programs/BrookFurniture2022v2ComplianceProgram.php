...
class BrookFurniture2022v2ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new BrookFurniture2022v2ComplianceProgramReportPrinter();
    }
...
class BrookFurniture2022v2ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                For participating in the wellness screenings, you have earned the <strong>Wellness Participant Discount</strong> and
                will pay less for medical coverage during 2022.
            </p>

            <p>
                In addition, Team members that <strong>meet 4 of the 6 Health Standards outlined below</strong>,
                will <strong>also receive the Wellness Healthy Discount</strong> and earn the <strong>maximum discount</strong>
                available for your 2022 medical premiums.
            </p>
            ...
            <?php if($core_points >= 4) : ?>
                ...
                <p>CONGRATULATIONS! You have earned the <strong>Healthy Wellness Discount for 2022</strong>. Based on your wellness screening results,
                    you met at least four of the required Health Standards.</p>
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>Based on your results of the wellness screening results, you <strong>DID NOT meet at least 4 of the 6 Health Standards.</strong>
                        You may still earn the <strong>Wellness Healthy Discount</strong> by completing the <strong>ALTERNATE PROCESS</strong> requirements.</p>

                    <p class="bund">ALTERNATE QUALIFIER:</p>

                    <p style="color:red">Complete Alternate Qualification Form & submit to HMI by November 19, 2021 or within 30 days of hire date:</p>

                    <p>
                        Team members that satisfy the designated ‘Alternate Process’ requirement
                        <a href="/resources/10680/Brook_Furniture_2021_AQF_071421.pdf">and submit the qualification form</a>
                        will also earn the Wellness Healthy Discount. To earn the <strong>Wellness Healthy Discount</strong>,
                        Health Maintenance Institute (HMI) <strong>must</strong> have documentation from your Physician
                        acknowledging the "Health Standard" areas of concern. Please follow-up with your Physician and
                        submit the Alternate Qualification Form included in your results packet, <span style="color:red">complete with your
                        Physician's signature</span>. If your completed form is not received by HMI on or before November 19, 2021 or within 30 days of hire date,
                        you will NOT qualify for the <strong>Wellness Healthy Discount</strong>.
                    </p>
                </div>
            <?php endif ?>
