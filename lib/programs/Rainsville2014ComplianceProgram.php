...
class Rainsville2014ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new Rainsville2014Printer();
    ...
    public function loadGroups()
    {
        ...
        $biometricsGroup->setPointsRequiredForCompliance(5);

        $smokingView = new ComplyWithSmokingByBeingNonSmokerHRAQuestionComplianceView($programStart, $programEnd);
        $smokingView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(3, 0, 0, 0));
...
class Rainsville2014Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p>
        ...
        you will be eligible for the 2014 premium rate in your health plan
    ...
    <p>
        ...
        Screenings will be scheduled again beginning in October of 2014
        and consultations will follow in November.</p>
    <p>
        <strong>Step 2</strong>- Accumulate 5 points from the incentive report
