...
class Active2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Active2016ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '01/01/17');
        ...
        $hraView->setAttribute('goal', '01/01/17');
        ...
        $bmiView->overrideTestRowData(null, null, 28.099, null);
        $bmiView->emptyLinks();
        $bmiView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(1, 0, 0, 0));
        $bmiView->setAttribute('goal', '< 28.1');
...
class Active2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>Earning the incentive this year requires completing a wellness screening, the Empower Health
                ...
                your name will be on a list that is sent to Active for everyone earning the
        ...
        <div class="letter">
            <img src="/resources/8473/Page 2 Active 2017 incentive $ EHS FINAL 100616-1.png" />
        </div>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr>
                        <th rowspan="2">Meet the Goals (Get a Yes) for A1, A2 and B7 <br /> to receive the incentive.</th>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/8471/EHS Active Printing IRC Alt To-Do Doctor Support Form rev 100316.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN January 1, 2017</strong>
                            </td>
                         <?php endif ?>
                    </tr>
