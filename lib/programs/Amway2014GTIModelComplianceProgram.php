...
class Amway2014GTIModelComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new Amway2014GTIModelPrinter();
...
class Amway2014GTIModelPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    public function printClientMessage()
    {
        ...
        <p>
            ...
            Screenings will be scheduled again beginning in July/August of 2013
