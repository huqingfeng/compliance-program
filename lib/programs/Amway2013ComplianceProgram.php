...
class Amway2013ComplianceProgram extends ComplianceProgram
{
    /**
    ...
    {
        return new Amway20132013ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new CompleteScreeningComplianceView($programStart, '2013-10-01');
        $screeningView->setReportName('Onsite Health Screening');
        $requiredGroup->addComplianceView($screeningView);

        $hraView = new CompleteHRAComplianceView($programStart, '2013-10-31');
        $hraView->setReportName('Health Questionnaire');
        $requiredGroup->addComplianceView($hraView);

        $consultationView = new CompletePrivateConsultationComplianceView($programStart, '2013-11-27');
...
class Amway20132013ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    <ol>
        ...
        <li>Deadline for screening participation October 1, 2013.</li>
        <li>Deadline for coaching completion November 27, 2013 in order to be eligible for the incentive to be paid in
            2014.
        </li>
    </ol></p>

    <p style="color:#ff4500;">Other highlights to the 2013 program include:
    </p>
    <p>
    <ul>
        <li>The on-site health screenings and blood panels will occur in August – September in Michigan and in July in
