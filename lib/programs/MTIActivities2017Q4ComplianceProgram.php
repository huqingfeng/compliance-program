...
class MTIActivities2017Q4WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '10/02/2017 through 10/08/2017',
        2 => '10/09/2017 through 10/15/2017',
        3 => '10/16/2017 through 10/22/2017',
        4 => '10/23/2017 through 10/29/2017',
        5 => '10/30/2017 through 11/05/2017',
        6 => '11/06/2017 through 11/12/2017',
        7 => '11/13/2017 through 11/19/2017',
        8 => '11/20/2017 through 11/26/2017',
        9 => '11/27/2017 through 12/03/2017',
        10 => '12/04/2017 through 12/10/2017',
        11 => '12/11/2017 through 12/17/2017',
        12 => '12/18/2017 through 12/24/2017',
        13 => '12/25/2017 through 12/31/2017'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2017-10-03', '2017-12-31');
...
class MTIActivities2017Q4ComplianceProgram extends ComplianceProgram
{
    const MTI_2017Q4_ACTIVITY_START_DATE = '2017-10-03';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2017Q4WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2017Q4WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2017Q4WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2017Q4_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2017Q4ComplianceProgram::MTI_2017Q4_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
