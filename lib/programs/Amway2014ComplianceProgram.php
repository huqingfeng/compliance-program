...
class Amway2014ComplianceProgram extends ComplianceProgram
{
    /**
    ...
    {
        return new Amway2014ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new CompleteScreeningComplianceView($programStart, '2014-09-30');
        $screeningView->setReportName('Onsite Health Screening');
        $requiredGroup->addComplianceView($screeningView);

        $hraView = new CompleteHRAComplianceView($programStart, '2014-10-31');
        $hraView->setReportName('Health Questionnaire');
        $requiredGroup->addComplianceView($hraView);

        $consultationView = new CompletePrivateConsultationComplianceView($programStart, '2014-11-25');
...
class Amway2014ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    <p style="color:#ff4500;">To be eligible for the Optimal You incentive, participants must:<p>
    <p>
    <ol>
    ...
    <p style="color:#ff4500;">Key dates to remember and complete in order to be eligible for the incentive to be paid in 2015:</p>
    <p>
    <ol>
        <li>Dates to complete the HRA questionnaire: July 1 – October 31.</li>
        <li>Deadline for screening participation: September 30, 2014.</li>
        <li>Deadline for coaching completion: November 25, 2014.
        </li>
    </ol></p>

    <p style="color:#ff4500;">Other highlights to the 2014 program include:
    </p>
    <p>
    <ul>
        <li>The on-site health screenings and blood panels will occur in August – September in Michigan and in July in California.
        </li>
        <ul>
            <li>On-demand packets will be sent to service center employees starting in August.</li>
        </ul>
        <li>The on-site coaching sessions will begin in October in Michigan and August in California.
        </li>
            <ul>
                <li>Telephonic coaching sessions will start in September for the service centers.</li>
            </ul>
    </ul></p>

    <p style="color:#ff4500;">Participants who meet all of the requirements will receive $384 toward healthcare costs.</p>
