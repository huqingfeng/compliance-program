...
/**
 * Contains all classes for AFSCME 2015 compliance program. Depends on classes
 * in the 2013 program that are unchanged for 2015.
 */
...
class AFSCME2015AssignedElearningComplianceView extends CompleteAssignedELearningLessonsComplianceView
{    
...
class AFSCME2015HealthCoachingEvaluationComplianceView extends PlaceHolderComplianceView
{
    public function getStatus(User $user)
    {
...
class AFSCME2015ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new AFSCME2015ScreeningPrinter();
...
//        }
    ...
    public function loadGroups()
    {
        ...
        $hraScreeningEndDate = strtotime('2015-04-01');

        $startEndDate = strtotime('2015-04-25');

        $keyEndDate = strtotime('2015-10-15');
        ...
        $scr = new CompleteScreeningComplianceView('2014-12-01', $hraScreeningEndDate);
        ...
        $doc = new UpdateDoctorInformationComplianceView($startDate, '2015-05-15');
        ...
        $updateInfo = new UpdateContactInformationComplianceView($startDate, '2015-05-15');
        ...
        $workbook = new AFSCMEViewWorkbookComplianceView($startDate, '2015-05-15');
        ...
        $elearn = new CompleteRequiredELearningLessonsComplianceView('2014-11-01', '2015-08-30');
        ...
        $tobView->setAttribute('deadline', '07/01/2015');
        $tobView->emptyLinks();
        $tobView->addLink(new Link('Learn More', '/content/1094#1gtobacco'));
        ...
        $callsThree = new AFSCME2015AssignedElearningComplianceView($startDate, $keyEndDate);
        ...
        $healthCoachEvaluation = new AFSCME2015HealthCoachingEvaluationComplianceView(ComplianceStatus::NA_COMPLIANT);
        ...
        $otherRes->setAttribute('report_name_link', '/content/1094#4bactions');
        $otherRes->setName('other_resources');
        $otherRes->addLink(new Link('Click here', '/content/1094#4bactions'));
...
class AFSCME2015Printer extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your new 2015 PHIP. As you know, all adult HIP participants must
...
class AFSCME2015ScreeningPrinter extends ScreeningProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ?>
