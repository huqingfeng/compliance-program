...
class CarloGavazziIP2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new CarloGavazziIP2017ComplianceProgramReportPrinter();
    }
...
class CarloGavazziIP2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/9864/Carlo Gavazzi_AQF_110317.pdf" target="_blank">Alternate Qualification Form</a>
