...
class Semblex2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Semblex2020ComplianceProgramReportPrinter();
    }
...
class Semblex2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 11/13/2020</th>
                        ...
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >0, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 12/11/20.  You can
                                 <a href="/resources/10596/2020_Semblex_AQF_100520.pdf" download="2020_AQF">download</a>
                            ...
                            <p>
                                ...
                                <a href="/compliance_programs/localAction?id=1550&local_action=dashboardCounts">About the health risk score.</a>
                            </p>
                        </td>
                    </tr>
