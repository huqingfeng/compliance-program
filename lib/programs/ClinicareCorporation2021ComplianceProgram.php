<?php
  class ClinicareCorporation2021ComplianceProgram extends ComplianceProgram {
    ...
    public function getProgramReportPrinter($preferredPrinter = null) {
      return new ClinicareCorporation2021ComplianceProgramReportPrinter();
    }
  ...
  class ClinicareCorporation2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter {
    ...
    private function getTable($status) {
      ...
      <p style="text-align:center">
        <table id="results">
          <tbody>
            <tr><td colspan="6" style="text-align: left"><?= $user->first_name.' '.$user->last_name ?></td></tr>
            <tr class="headerRow">
              <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 1/28/2022</th>
            ...
            <tr class="status-<?= $hraStatus->getStatus() ?>">
              <td colspan="2" style="text-align: left;" class="activity_name"><?= $hraStatus->getComplianceView()->getReportName() ?></td>
              ...
              <td colspan="6">
                <p style="margin:10px; width:95%;">
                  E. If you did not earn the full incentive based on your most current screening results, you
                   ...
                   <a href="pdf/clients/clinicare/2022_AQF.pdf" download="2022_Clinicare_AQF">download</a>
                ...
                <p>
                  ...
                  <a href="/compliance_programs/localAction?id=1635&local_action=dashboardCounts">About the health risk score.</a>
                </p>
              </td>
            </tr>
          </tbody>
