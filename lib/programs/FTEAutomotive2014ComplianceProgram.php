...
class FTE2014AutomotiveComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new FTE2014AutomotiveComplianceProgramReportPrinter();
    }
...
class FTE2014AutomotiveComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <!--<p style="font-weight:bold"><a href="/compliance_programs?id=203">How would I have scored in 2012 with the new 2014 criteria?</a></p>-->
        <p>
    ...
    <p>In addition to being a great resource for health-related topics, this site allows you to review the results from
        your 2014 wellness screening as well as previous screening year’s results. </p>
    <p>When you complete your health screening in the fall of 2014, your results will be updated, and you will be able
        to determine
        if you qualify for the premium discount. </p>
    <p>You must complete the following steps in the fall of 2014 to receive your premium incentive of up to $90.00 per
        month ($1080.00 per year) beginning 1/1/2015.
    ...
    <p>Your health plan is committed to helping you achieve your best health.  Rewards for participating in a
        ...
        <a href="/content/12088?course_id=2740">Living Free</a> course by December 15, 2014 for credit. For all other biometric measures in your report card
        you may complete a <a href="/resources/5054/FTE-Medical-Exception-form.090914.pdf">Medical Exception Form </a>at your personal physician and submit to Circle Wellness via info
        on the form no later than November 1, 2014. </p>


    <p><a href="/resources/5055/Pregnancy-exception-form-2014.090914.pdf">Are you pregnant or 6 months postpartum?</a></p>
