...
class BeaconActivities2016Q2DailyLogComplianceView extends CompleteActivityComplianceView
{
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints)
    {
        ...
        parent::__construct('2016-04-01', '2016-06-30');
...
class BeaconLightActivities2016Q2ScreeningConfirmationComplianceView extends ComplianceView
{
...
class BeaconLightActivities2016Q2ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2016Q2DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q2ComplianceProgram::LIGHT_SPECTRUM_2015_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q2ComplianceProgram::LIGHT_ACTIVITIES_2016_Q2_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2016Q2ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2016Q2ScreeningConfirmationComplianceView($startDate, $endDate);
    ...
    const LIGHT_ACTIVITIES_2016_Q2_RECORD_ID = 804;
    const LIGHT_SPECTRUM_2015_RECORD_ID = 533;
}



class BeaconLightActivities2016Q2ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
