...
class Autocam2014ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView($programStart, '2015-01-09');
        $hraView->setName('hra');
    ...
    {
        return new Autocam2014ComplianceProgramReportPrinter();
    }
}

class Autocam2014ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    <div id="program_information">
        <p>
            ...
            requirements to maintain compliance in 2014.
        </p>
        ...
        <tbody>
            ...
            <tr class="requiredrow">
                <td class="requirementscolumn">
                    ...
                    <a href="/content/11358" class="moreinfo">- more info</a>
                    <br/>
                    Receive from your Primary Care Physician (Exam must be completed between 04/1/13 - 12/31/14)<a
                    href="/resources/4677/2014-Physician-Form-Autocam-013114.pdf">Download Physician Form</a>
                </td>
                <td class="myrequirementscolumn">
                    Yearly, Due 12/31/14
                </td>
