...
class BedelFinancialWMS3StepsComplianceViewQ2 extends DateBasedComplianceView
{
...
class BedelFinancial2021ComplianceProgramQ2 extends ComplianceProgram
{
    ...
    {
        return new BedelFinancial2021WMS2Q2ComplianceProgramPrinter();
    }
...
//        $totalHDLRatioView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≥ 7');
        ...
        $beingVideo->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            ->andWhere('tbk.completion_date BETWEEN ? AND ?', array('2021-07-01', '2021-12-31'))
            ->hydrateSingleRow()
            ->execute();
...
//        $steps = new PlaceHolderComplianceView(null, 0);
        $steps = new BedelFinancialWMS3StepsComplianceViewQ2($startDate, $endDate, 42000, 3);
        ...
        $nutritionElearningView = new CompleteELearningGroupSet($startDate, $endDate, 'foods_nutrition');
...
class BedelFinancial2021WMS2Q2ComplianceProgramPrinter implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
            	$.ajax({
            		url: '/compliance/bedelfinancial-2021/covid19/compliance_programs?id=1577&points_only=true',
            		success: function(reply) {

            			$('span.quarter-1').html(reply);
            			$('span.quarter-2').html(<?php echo $totalPoints; ?>);
            		}
            	})
                ...
                <div class="row">
                        ...
                        <div class="row">
                        	...
                        	<div class="circle-range">
				                <div class="circle-range-inner circle-range-inner-danger">
				                    <div style="font-size: 1.3em; line-height: 1.0em;"><span class="circle-points quarter-1"></span><br/><br/>1/1/2021 - 6/30/2021</div>
				                </div>
				            </div>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                        	...
                        	<div class="circle-range">
				                <div class="circle-range-inner circle-range-inner-danger">
				                    <div style="font-size: 1.3em; line-height: 1.0em;"><span class="circle-points quarter-2"></span><br/><br/>7/1/2021 - 12/31/2021</div>
				                </div>
				            </div>
                                ...
                                // echo $circle(
                                //     $totalPoints,
                                //     '<span class="circle-points">'.$totalPoints. '</span><br/><br/>7/1/2021 - 12/31/2021'
                                // ) 
                                ?>
                                <br/>
