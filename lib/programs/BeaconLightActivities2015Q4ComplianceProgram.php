...
class BeaconActivities2015Q4DailyLogComplianceView extends CompleteActivityComplianceView
{
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints)
    {
        ...
        parent::__construct('2015-10-01', '2015-12-31');
...
class BeaconLightActivities2015Q4ScreeningConfirmationComplianceView extends ComplianceView
{
...
class BeaconLightActivities2015Q4ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2015Q4DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2015Q4ComplianceProgram::LIGHT_SPECTRUM_2014_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2015Q4ComplianceProgram::LIGHT_ACTIVITIES_2015_Q3_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2015Q4ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2015Q4ScreeningConfirmationComplianceView($startDate, $endDate);
...
class BeaconLightActivities2015Q4ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
