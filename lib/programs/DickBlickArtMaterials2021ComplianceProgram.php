...
class DickBlickArtMaterials2021ComplianceProgram extends ComplianceProgram
{
...
.title1 {                font-size: 13pt;
    ...
    {
        return new DickBlickArtMaterials2021ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $tobaccoView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            } else if((is_numeric($result) && $result <= 15) || $result == 'N' || $result == 'Negative') {
...
class DickBlickArtMaterials2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 3/12/2021</th>
                        ...
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >0, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 03/31/21.  You can
                                 <a href="/resources/10627/Blick_Art_Materials_2021_AQF_011121.pdf" download="2021_AQF">download the form here</a>
