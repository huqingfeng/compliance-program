...
class ShelteredWings2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new ShelteredWings2016ComplianceProgramReportPrinter();
    }
}

class ShelteredWings2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p> <a href="<?php echo url_for('/compliance_programs/?id=415') ?>">2015 Incentive Report Card</a></p>
