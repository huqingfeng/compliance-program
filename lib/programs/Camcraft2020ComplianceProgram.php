...
class Camcraft2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Camcraft2020ComplianceProgramReportPrinter();
    }
...
class Camcraft2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <?php if($this->getNumCompliant($status) >= 2 && $cotinineCompliant) : ?>
                ...
                <p>CONGRATULATIONS! Based on your results of the wellness screening, you <span class="bund">DO</span> fall
                    within the acceptable rage for at least two "Health Standards" and therefore, qualify for the medical
            ...
            <?php elseif($this->getNumCompliant($status) >= 2 && !$cotinineCompliant) : ?>
                ...
                <p>Based on your results of the wellness screening, you do fall within the acceptable range for at least
                    ...
                    by November 6, 2020</span> and complete thereafter.</p>
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>In order to receive the discount, we must have documentation from your Physician acknowledging the
                     "Health Standard" areas of concern. This <a href="/resources/10574/2020_Camcraft_Matrix_AQF_070120.pdf" target="_blank">
                     Alternative Qualification Form</a> will need to be completed by your physician and returned to Health
                      Maintenance Institute. If your completed form is not received by November 6, 2020, you will not qualify for the discount.</p>
                    ...
                    <p>Specifically for those who did not fall within the acceptable range for the cotinine test, it is
                        ...
                        <span class="bund">by November 6, 2020</span> and complete thereafter. </p>
