...
class HighlandParkPoliceEmployee2016ComplianceProgram extends ComplianceProgram
{
    const SPOUSE_RECORD_ID = 599;
    ...
    {
        return new HighlandParkPoliceEmployee2016ComplianceProgramReportPrinter();
    }
}

class HighlandParkPoliceEmployee2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
