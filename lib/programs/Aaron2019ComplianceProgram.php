...
class Aaron2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Aaron2019ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '10/31/2019');
        ...
        $hraView->setAttribute('goal', '10/31/2019');
...
class Aaron2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10383/2019_Aaron_Equipment_AQF_073019.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN October 31, 2019</strong>
                            </td>
                         <?php endif ?>
                    </tr>
