...
class VillageofBuffaloGrove2021ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'Get Started – Complete by April 23, 2021:');
        ...
        $pointGroup = new ComplianceViewGroup('points', 'Earn 35+ points from your screening results OR submit a completed Alternate Qualification Form by May 15, 2021');
    ...
    {
        $printer = new VillageofBuffaloGrove2021ComplianceProgramReportPrinter();
...
class VillageofBuffaloGrove2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <table class="phipTable" border="1">
            ...
            <tr>
                <td colspan="2" style="width: 600px;">
                    B. If needed, work with your primary care provider to complete <a href="/resources/10630/Village_of_Buffalo_Grove_2021_AQF_020921.pdf" target="_blank">Alternate Qualification Form (AQF)</a>.
                    Download the form from the link to the right and submit it to Empower Health Services by <span style="font-weight: bold; text-decoration: underline;">May 15, 2021</span> via:
                ...
                <td class="center"><a href="/resources/10630/Village_of_Buffalo_Grove_2021_AQF_020921.pdf" download>Click here to download the AQF pdf</a></td>
            </tr>
