<?php
class ChamberlainGroup2016WeighInComplianceView extends CompleteActivityComplianceView
{
    ...
    {
        $this->setDateRange('2016-01-01', $endDate);
        ...
        $this->weightInWeek = 'Week1: 06/20/2016 through 06/26/2016';
        $this->weightOutWeek = 'Week12: 09/05/2016 through 09/11/2016';
    }
    ...
    public function getStatus(User $user)
    {
        ...
        if(!empty($weight)) {
            ...
            if($this->isWeightInWeek($this->week)) {
                ...
                $bmi = ($weight * 703.0) / ($weighInData['height'] * $weighInData['height']);

                if($weighInData['bmi'] > 24.9 && $weight <= $goalWeight) {
                    $goalStatus = "Goal Met";
                } elseif ($weighInData['bmi'] < 18.5 && $weight >= $goalWeight) {
                    $goalStatus = "Goal Met";
                } elseif ($weighInData['bmi'] >= 18.5 && $weighInData['bmi'] <= 24.9 && $bmi >= 18.5 && $bmi <= 24.9) {
                    $goalStatus = "Goal Met";
                } else {
                    $goalStatus = "Not Met";
                }
...
class ChamberlainGroup2016ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $week1 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week1: 06/20/2016 through 06/26/2016');
        ...
        $week2 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week2: 06/27/2016 through 07/03/2016');
        ...
        $week3 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week3: 07/04/2016 through 07/10/2016');
        ...
        $week4 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week4: 07/11/2016 through 07/17/2016');
        ...
        $week5 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week5: 07/18/2016 through 07/24/2016');
        ...
        $week6 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week6: 07/25/2016 through 07/31/2016');
        ...
        $week7 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week7: 08/01/2016 through 08/07/2016');
        ...
        $week8 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week8: 08/08/2016 through 08/14/2016');
        ...
        $week9 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week9: 08/15/2016 through 08/21/2016');
        ...
        $week10 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week10: 08/22/2016 through 08/28/2016');
        ...
        $week11 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week11: 08/29/2016 through 09/04/2016');
        ...
        $week12 = new ChamberlainGroup2016WeighInComplianceView($startDate, $endDate, 'Week12: 09/05/2016 through 09/11/2016');
    ...
    protected function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        if($weighInStatus->getStatus() == ComplianceViewStatus::COMPLIANT
            && $weightOutStatus->getStatus() == ComplianceViewStatus::COMPLIANT
            && $numCompliant>= 9) {
    ...
    {
        return new ChamberlainGroup2016ComplianceProgramReportPrinter();
    }
}

class ChamberlainGroup2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
