...
class DCMH2011LearningAlternativeComplianceView extends ComplianceView
{
...
class DCMH2011ComplianceStatusPointMapper extends ComplianceStatusPointMapper
{
...
class DCMH2011RequiredBodyFatBMIComplianceView extends ComplyWithBodyFatBMIScreeningTestComplianceView
{
    /**
...
class DCMH2011RequiredCholesterolComplianceView extends ComplianceView
{
...
class DCMH2011ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new DCMH2011Printer();
    ...
    public function loadGroups()
    {
        ...
        $smokingView->setAlternativeComplianceView(new DCMH2011LearningAlternativeComplianceView($programStart, $programEnd, 'smoking_2011'));
        ...
        $bloodPressureView->setAlternativeComplianceView(new DCMH2011LearningAlternativeComplianceView($programStart, $programEnd, 'blood_pressure_2011'));

        $resourceGroup->addComplianceView($bloodPressureView);

        $cholesterolView = new DCMH2011RequiredCholesterolComplianceView($programStart, $programEnd);
        $cholesterolView->setComplianceStatusPointMapper($this->statusPointMapper);
        $cholesterolView->setAlternativeComplianceView(new DCMH2011LearningAlternativeComplianceView($programStart, $programEnd, 'cholesterol_2011'));
        ...
        $bmiBodyFatView = new DCMH2011RequiredBodyFatBMIComplianceView($programStart, $programEnd);
        $bmiBodyFatView->setUseHraFallback(true);
        $bmiBodyFatView->setAlternativeComplianceView(new DCMH2011LearningAlternativeComplianceView($programStart, $programEnd, 'weight_management_2011'));
...
class DCMH2011Printer extends CHPComplianceProgramReportPrinter
{
