...
class RiverViewFarms2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new RiverViewFarms2020ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new CompleteScreeningComplianceView($programStart, '2020-08-07');
        ...
        $screeningView->setAttribute('deadline', '7/24/20');
        ...
        $tobaccoAlternative->setReportName('2. OR - Confirm you are working with your doctor on these goals. Just complete the <a href="/resources/10565/2020_River_View_Farms_AQF_043020.pdf">Alternative Qualification Form</a> then fax or mail to EHS by deadline.');
        ...
        $tobaccoAlternative->setAttribute('goal', 'Fax or mail completed form by 8/19/20 -> <a href="/resources/10565/2020_River_View_Farms_AQF_043020.pdf" download>Download Form</a>');
        ...
        $bmiView->setAttribute('goal', '< 30 or 2 less from 2019');
        ...
        $hdlView->setAttribute('goal', '>40 or 4 more from 2019');
        ...
        $ldlView->setAttribute('goal', '<130 or 10 less from 2019');
        ...
        $triglyceridesView->setAttribute('goal', '<160 or 15 less from 2019');
        ...
        $glucoseView->setAttribute('goal', '<110 or 20 less from 2019');
        ...
        $alternativeMeetDrView->setReportName('6. OR - Confirm you are working with your doctor on these goals. Just complete the <a href="/resources/10565/2020_River_View_Farms_AQF_043020.pdf">Alternative Qualification Form</a> then fax or mail to EHS by deadline.');
        ...
        $alternativeMeetDrView->setAttribute('goal', 'Fax or mail completed form by 8/19/20 -> <a href="/resources/10565/2020_River_View_Farms_AQF_043020.pdf" download>Download Form</a>');
        ...
        return function(ComplianceViewStatus $status, User $user) use ($test, $programStart, $programEnd, $lastStart, $lastEnd, $calculationMethod, $threshold) {
            ...
            if ($cache['this'] || $cache['last']) {
                ...
                if ($thisVal && $lastVal) {
                    ...
                    $status->setAttribute('2019_2020_change', $change);
...
class RiverViewFarms2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                ...
                <div>
                    To encourage wellbeing, the use of this benefit and other related actions, River View Farms offers 2
                     ...
                     <ul style="list-style-type: upper-alpha">
                        <li><strong>Health Action Reward:</strong> A.Get $5 per pay reward (up to $130/year) by meeting 3 of 5 screening result goals noted below -OR- by achieving better results than in 2019.</li>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 320px;">A. Tobacco Free Reward – Meet the 1 of these goals by 8/19/20:</th>
                        <th>Goal</th>
                    ...
                    <tr class="headerRow">
                        ...
                        <th>Y1: 2019 Result</th>
                        <th>Y2: 2020 Result</th>
                        <th>Change Y2-Y1</th>
                        <th>Met Goal</th>
                        <th></th>
                    </tr>
