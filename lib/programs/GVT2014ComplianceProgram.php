...
class GVT2014ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new GVT2014Printer();
    ...
    public function loadGroups()
    {
        ...
        $bloodPressureView->overrideSystolicTestRowData(0, 0, 119, 140);
        ...
        $triglView->overrideTestRowData(-1, 0, 149, 200);
        ...
        $glucoseView->overrideTestRowData(50, 65, 99, 125, 'M');
        $glucoseView->overrideTestRowData(40, 65, 99, 125, 'F');
        ...
        $cholesterolView->overrideTestRowData(90, 100, 199, 240);
        ...
        $totalHDLRatioView->overrideTestRowData(-1, 0, 5, 7);
        ...
        $bodyFatBMIView->overrideBMITestRowData(17, 18.5, 25, 30);
        $bodyFatBMIView->overrideBodyFatTestRowData(14, 0, 25, 32, 'F');
        $bodyFatBMIView->overrideBodyFatTestRowData(6, 0, 18, 25, 'M');
...
class GVT2014Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    public function printClientMessage()
    {
       ...
       <p>
        <a href="/compliance_programs/index?id=212">
            View your 2012 Program
        </a>
    </p>
        <p>
            <a href="/compliance_programs/index?id=274">
        ...
        <p>
            ...
            fulfilling your requirement. By completing the following steps in 2014
            you will be eligible for a premium reduction in your health plan
            effective 01/01/2015.</p>
        <p>
            ...
            Screenings will be scheduled in July of 2014 and consultations will follow.</p>
        <p>
            ...
            based on your 2014 health screening results. If you have a medical reason
            for not being able to reach one or more of the requirements listed below,
            you can contact Kamara Means in Human Resources to discuss a
