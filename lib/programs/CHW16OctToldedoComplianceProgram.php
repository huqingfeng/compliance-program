...
class CHW16OctToldedoCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW16OctToldedoComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $quizLawsView = new CHW16OctToldedoCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365));
        ...
        $quizVitalView = new CHW16OctToldedoCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
    ...
    {
        $printer = new CHW16OctToldedoComplianceProgramReportPrinter();
...
class CHW16OctToldedoComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
