...
class Bepex20132014Printer extends BasicComplianceProgramReportPrinter
{
    public function printHeader(ComplianceProgramStatus $status)
    {
        $endDateText = 'Needed By 09/30/2014';

        $this->tableHeaders['total_status'] = 'Status of 1ABCD + ≥ '.Bepex20132014ComplianceProgram::POINTS_REQUIRED.' points as of:';
...
class Bepex20132014ComplianceProgram extends ComplianceProgram
{
    const POINTS_REQUIRED = 250;

    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new Bepex20132014Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $completeMission->setReportName('Complete the “Clarify How I align with Bepex’s Mission/Vision” exercise');
        ...
        $completeMission->addLink(new Link('/ Form', '/resources/4787/Align-with-Bepex-Mission-and-Vision-Exercise.032114.pdf'));
        ...
        $meet->setReportName('Meet with your Manager to discuss the “Clarify How I align with Bepex’s Mission/Vision” exercise');
        ...
        $fluVaccineView = new FluVaccineActivityComplianceView('2013-09-01', $endDate);
        $fluVaccineView->setReportName('Have Annual Flu Vaccine on September 1st, 2013');
        ...
        $physicalActivityView->setAttribute('report_name_link', '/content/1094#tPhysAct');
