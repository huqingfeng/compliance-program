...
class Selig2019ComplianceProgram extends ComplianceProgram
{
    public function getAdminProgramReportPrinter()
    {
        ...
        $printer->addStatusFieldCallback('03/01/2019 - 11/30/2019 - Points', function(ComplianceProgramStatus $status) {
            $user = $status->getUser();

            $program = $this->cloneForEvaluation('2019-03-01', '2019-11-30');
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $hraScreeningView->setAttribute('requirement', 'Employee completes the wellness screening & health assessment <strong>BEFORE 6/28/19</strong>');
        ...
        $physicalExam->setAttribute('requirement', 'Follow-up with your medical provider and receive your Annual Physical Exam <strong>BEFORE 11/30/19</strong>');
        $physicalExam->setAttribute('points_per_activity', '50');
        $physicalExam->emptyLinks();
        $physicalExam->setAllowPointsOverride(true);
        $physicalExam->addLink(new Link('Verification Form <br />', '/resources/10284/Selig Healthcare Provider Form 2019.pdf'));
        ...
        $spouseScreening->setAttribute('requirement', 'Eligible Spouse or Domestic Partner, completes the Wellness Screening & Health Assessment <strong>BEFORE 6/28/19</strong>');
        ...
        $dependentScreening->setAttribute('requirement', 'Dependent 18 + completes 2019 Wellness Screening and Health Assessment <strong>BEFORE 6/28/19</strong>');
        ...
        $preventiveServiceView->addLink(new Link('Verification Form <br />', '/resources/10284/Selig Healthcare Provider Form 2019.pdf'));
        ...
        $spousePreventiveServiceView->addLink(new Link('Verification Form', '/resources/10284/Selig Healthcare Provider Form 2019.pdf'));
        ...
        $runRaceView->addLink(new Link('Verification form', '/resources/10285/Selig 2019 WellnessEventCert.pdf'));
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new Selig2019ComplianceProgramReportPrinter();
        }
    ...
    private $ranges = array(
        'jan' => array('2019-01-01', '2019-01-31'),
        'feb' => array('2019-02-01', '2019-02-28'),
        'mar' => array('2019-03-01', '2019-03-31'),
        'apr' => array('2017-04-01', '2019-04-30'),
        'may' => array('2019-05-01', '2019-05-31'),
        'jun' => array('2019-06-01', '2019-06-30'),
        'jul' => array('2019-07-01', '2019-07-31'),
        'aug' => array('2019-08-01', '2019-08-31'),
        'sep' => array('2019-09-01', '2019-09-30'),
        'oct' => array('2019-10-01', '2019-10-31'),
        'nov' => array('2019-11-01', '2019-11-30'),
        'dec' => array('2019-12-01', '2019-12-31')
    );

}


class Selig2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <p>
            ...
            <div style="text-align: center; width: 62%; float: right; border: 1px solid #000000;">
                <div style="padding: 20px 10px;">
                    <span style="font-size: 12pt; font-weight: bold; color: #6e9de5">2019 Wellness Program Calendar</span> <br />
        ...
        <p>
            <strong>HOW DOES THE PROGRAM WORK?</strong> To participate in the Selig Group Wellness Program, employees are required to complete the spring 2019 Health Screening & Assessment.  Participation in the screening and other wellness activities (outlined here) will earn points that will be tracked through the HMI website.
        </p>
        ...
        <p>
            <strong>You must complete the Health Screening by June 28, 2019 AND complete the Follow-Up Physical Exam by November 30, 2019 to earn an incentive.</strong>
        </p>
        ...
        #programTable td ul { padding: 30px; margin: 0; }
            ...
            the lump-sum payment received in August and/or December will depend on the number of points earned as of July 31, 2019 and November 30, 2019.
            </p>
            <p>
                Haley Shaw (<a href="mailto:haleyshaw@axionrms.com">haleyshaw@axionrms.com</a>) will update the points on the 15th and 30th of each month.
            </p>
            <p style="color: red;">
        ...
        <table class="phipTable">
            <tbody>
            <tr><th colspan="6" style="height:36px; text-align:center; color: white; background-color:#436EEE; font-size:11pt">2019 Wellness Rewards Program</th></tr>
            ...
            <tr><th colspan="6" class="section"><span style="font-weight:bolder; font-size: 12pt;">Selig Fitness Program: May 20, 2019 – July 28, 2019</span></th></tr>
