...
class LCMH2018ElearningComplianceView extends ComplianceView
{
...
class LCMH2018ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new LCMH2018ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $annualPhysicalExamView->addLink(new Link('Verification Form', '/resources/10146/HMI_2017-18_Certification_Form.pdf'));
        ...
        $preventiveExamsView->addLink(new Link('Verification Form', '/resources/10146/HMI_2017-18_Certification_Form.pdf'));
        ...
        $healthAcademyView->addLink(new Link('Verification Form <br />', '/resources/9899/LCM 2018_HealthEdCert.pdf'));
        ...
        $freeScreenings->setReportName('Free Screenings');
        $freeScreenings->setName('free_screenings');
        $freeScreenings->setAttribute('requirements', 'Free Screenings');
        $freeScreenings->setAttribute('points_per_activity', '5');
        $freeScreenings->setMaximumNumberOfPoints(5);
        ...
        $annualEventNightOut->setReportName('Annual Event - Men\'s Wellness Event or Girls\' Night Out');
        $annualEventNightOut->setName('annual_event_night_out');
        $annualEventNightOut->setAttribute('requirements', 'Annual Event - Men\'s Wellness Event or Girls\' Night Out');
        ...
        $stepsSyncingView->setReportName('Syncing Activity (validated methods only: Fitbit and Moves)');
        ...
        $walk15k = new UcanMultipleAverageStepsComplianceView(10000, 2);
    ...
    private $ranges = array(
            array('2017-08-01', '2017-11-30'),
            array('2017-12-01', '2017-12-31'),
            array('2018-01-01', '2018-01-31'),
            array('2018-02-01', '2018-02-28'),
            array('2018-03-01', '2018-03-31'),
            array('2018-04-01', '2018-04-30'),
            array('2018-05-01', '2018-05-31'),
            array('2018-06-01', '2018-06-30'),
            array('2018-07-01', '2018-07-31'),
            array('2018-08-01', '2018-08-31'),
            array('2018-09-01', '2018-09-30'),
            array('2018-10-01', '2018-10-31')
    );

}

class LCMH2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
//        }
        ...
        <p>
            ...
            <div style="border: 1px solid black; float: right; width:70%; margin-top: 20px;">
                <div style="margin: 10px;">
                    <div style="font-weight: bold; font-size: 12pt;">Time out for Wellness 2017-18</div>
        ...
        <p>Recognition will be based on points earned between 11/1/2017 and 10/31/18.</p>
        ...
        <table style="width:100%" id="status-table">
            ...
            <tr>
                ...
                <td>Qualified</td>
                <td>1st Quarter Premium Reward will reduce the Employee's Insurance Premium (1/18/18 Pay date*)</td>
            </tr>
            <tr>
                <td>March 31, 2018</td>
                <td>100 points (50 points from prior period plus 50 points in current period)</td>
                <td>BRONZE</td>
                <td> 2nd Quarter Premium Reward will reduce the Employee's Insurance Premium (5/10/18 Pay date*) AND 5 Raffle Prizes valued at $40 each</td>
            </tr>
            <tr>
                <td>June 30, 2018</td>
                <td>150 points (100 points from prior periods plus 50 points in current period)</td>
                <td>SILVER</td>
                <td>3rd Quarter Premium Reward will reduce the Employee's Insurance Premium (8/16/18 Pay date*) AND 5 Raffle Prizes valued at $60 each</td>
            </tr>
            <tr>
                <td>October 31, 2018</td>
                <td>200 points (150 points from prior periods plus 50 points in current period)</td>
                <td>GOLD</td>
                <td>4th Quarter Premium Reward will reduce the Employee's Insurance Premium (12/6/18 Pay date*) AND 5 Raffle Prizes valued at $100 each</td>
            </tr>
        ...
        <table class="phipTable">
            ...
            <tr>
                <td>
                    <strong>I</strong>. <?php echo $lcmBenefitFairStatus ->getComplianceView()->getReportName() ?>
                </td>
                <td class="requirement"><?php echo $lcmBenefitFairStatus ->getComplianceView()->getAttribute('requirements') ?></td>
                <td class="center"><?php echo $lcmBenefitFairStatus ->getComplianceView()->getAttribute('points_per_activity') ?></td>
                <td class="center"><?php echo $lcmBenefitFairStatus ->getComplianceView()->getMaximumNumberOfPoints() ?></td>
                <td class="center"><?php echo $lcmBenefitFairStatus ->getPoints() ?></td>
                <td class="center">
                    Sign in at Event
                </td>
            </tr>
