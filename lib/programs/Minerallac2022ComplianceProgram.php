...
class Minerallac2022ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coaching->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            $hra = HRA::getNewestHRABetweenDates($user, '2022-01-01', '2022-11-01', false, false);
            $hraData = $hra->getHRA();
    ...
    {
        return new Minerallac2022ComplianceProgramReportPrinter();
    }
}

class Minerallac2022ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>2022 Minerallac Wellness Program</h1>
        </div>
    </div>
    ...
    <h3><strong>1:</strong> Complete a free, confidential health screening between February 2 – April 2, 2022.<br><br>An onsite screening will be offered at the Hampshire location on March 2, 2022. If an onsite screening is not offered at your location or if you are unable to attend the onsite screening, you can call Circle Wellness Customer Support at 1-866-682-3020 ext 204 to request an on-demand packet for a LabCorp location.</h3>
    ...
    <div class="basic-report-card thick">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <span class="label grey-label">Complete between 2/2/2022- 4/2/2022</span>
            </div>
