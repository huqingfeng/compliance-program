...
class Midland2017ComplianceScreening extends ComplianceProgram
{
...
//        $totalCholesterolView->setAttribute('_screening_printer_hack', 6);
        ...
        // $totalCholesterolView->setComplianceStatusPointMapper($screeningTestMapper);
        // $totalCholesterolView->overrideTestRowData(0, 199.999, 199.999, 239.999);
        ...
        // $hdlCholesterolView->overrideTestRowData(0, 0, 24.999, 4.499);
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.headerRow-points').after('<tr><td><strong>A. </strong>Biometric Results: Gain points by having biometrics in the healthier ranges –OR– complete a related e-learning lesson to receive the points.</td><td></td><td></td><td style="text-align: center;"><a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinterMidland&id=1105">View Results & point scale</a></td></tr>');
                $('.view-comply_with_total_cholesterol_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">A. Total Cholesterol</span>');
                $('.view-comply_with_total_cholesterol_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=4401">Complete 1 Blood Fat Lesson</a>');

                $('.view-comply_with_hdl_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">B. HDL Cholesterol</span>');
                $('.view-comply_with_hdl_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=4190">Complete 1 Blood Fat Lesson</a>');

                $('.view-comply_with_ldl_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">C. LDL Cholesterol</span>');
                $('.view-comply_with_ldl_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=4190">Complete 1 Blood Fat Lesson</a>');


                $('.view-comply_with_triglycerides_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">D. Triglycerides</span>');
                $('.view-comply_with_triglycerides_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=3638">Complete 1 Blood Fat Lesson</a>');
                $('.view-comply_with_glucose_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">E. Glucose</span>');
                $('.view-comply_with_glucose_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=4015">Complete 1 Blood Sugar Lesson</a>');
                $('.view-comply_with_blood_pressure_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">F. Blood Pressure</span>');
                $('.view-comply_with_blood_pressure_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=5028">Complete 1 BP Lesson</a>');
                $('.view-comply_with_bmi_screening_test').children(':eq(0)').html('<span style="padding-left:16px;">G. Body Mass Index (BMI)</span>');
                $('.view-comply_with_bmi_screening_test').children(':eq(3)').html('<a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=4769">Complete 1 Body Metric Lesson</a>');
                ...
                if(points >= 350) {
                    bonus = '/compliance/midland-paper-2017/my-rewards/images/lights/greenlight.gif';
                    bonusStatus = 'Congrats!';
                }
                $('tr.headerRow').last().parent().append('<tr><td colspan="2" style="text-align: right;">Core Reward Status: </td><td style="text-align: center;"><img src="' + compliance + '" class="light"></td><td>' +  status + '</td></tr><tr><td colspan="2" style="text-align: right;">Bonus Reward Status: Core actions done + &#8805; 350 points</td><td style="text-align: center;"><img src="' + bonus + '" class="light"></td><td>' +  bonusStatus + '</td></tr>');
                // $('.points').last().html('');
        ...
        <p>
            ...
            <ol>
                ...
                <li><strong>And a Bonus Reward</strong> – get the core actions (above) done <strong>PLUS</strong> earn at least 350 points by 1/31/18 and:
                    <ol type="a">
        ...
        <p>
            Login anytime to see your Well Rewards To-Do summary below. The action links make it easy to get things done and earn your rewards.
        </p>
