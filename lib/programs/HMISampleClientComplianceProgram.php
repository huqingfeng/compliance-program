...
class HMISampleClientIndividualActivityStepsComplianceView extends DateBasedComplianceView
{
...
class HMISampleClientBeatCFOComplianceView extends DateBasedComplianceView
{
    ...
    public function getStatus(User $user)
    {
        ...
        $fitbitData = get_all_fitbit_data(
            $user->id,
            '2017-01-01', // For "This Month" data when program hasn't started
...
class HMISampleClientComplianceProgram extends ComplianceProgram
{
    public function getAdminProgramReportPrinter()
    {
        ...
        $printer->addStatusFieldCallback('03/01/2017 - 05/31/2017 - Points', function(ComplianceProgramStatus $status) {
            ...
            $program = $this->cloneForEvaluation('2017-03-01', '2017-05-31');
        ...
        $printer->addStatusFieldCallback('06/01/2017 - 08/31/2017 - Points', function(ComplianceProgramStatus $status) {
            ...
            $program = $this->cloneForEvaluation('2017-06-01', '2017-08-31');
        ...
        $printer->addStatusFieldCallback('09/01/2017 - 11/30/2017 - Points', function(ComplianceProgramStatus $status) {
            ...
            $program = $this->cloneForEvaluation('2017-09-01', '2017-11-30');
        ...
        $printer->addStatusFieldCallback('12/01/2017 - 02/28/2018 - Points', function(ComplianceProgramStatus $status) {
            ...
            $program = $this->cloneForEvaluation('2017-12-01', '2018-02-28');
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $HMISampleWellnessEventsView = new PhysicalActivityComplianceView($programStart, $programEnd);
        $HMISampleWellnessEventsView->setReportName('Wellness Events');
        $HMISampleWellnessEventsView->setName('hmi_sample_wellness_events');
        $HMISampleWellnessEventsView->setMaximumNumberOfPoints(150);
        $HMISampleWellnessEventsView->setAttribute('requirement', 'Participate in a designated wellness activity or lunch and learn');
        $HMISampleWellnessEventsView->setAttribute('points_per_activity', '10');
        $HMISampleWellnessEventsView->emptyLinks();
        $HMISampleWellnessEventsView->addLink(new FakeLink('Admin will Enter', '#'));
        $HMISampleWellnessEventsView->setUseOverrideCreatedDate(true);
        $wellnessGroup->addComplianceView($HMISampleWellnessEventsView);
        ...
        $stepOne = new HMISampleClientIndividualActivityStepsComplianceView($programStart, $programEnd, 7500, 2);
        ...
        $stepTwo = new HMISampleClientIndividualActivityStepsComplianceView($programStart, $programEnd, 12000, 2);
        ...
        $stepThree = new HMISampleClientIndividualActivityStepsComplianceView($programStart, $programEnd, 15000, 2);
        ...
        $ATBeatCfoJuly = new HMISampleClientBeatCFOComplianceView($programStart, $programEnd, 414, 110);
        ...
        $ATBeatCfoJuly->addAttributes(array(
            ...
            'requirement' =>
                '15 point each month you exceed the number of steps logged by CFO'
        ));
        ...
        $ATBeatCfoOct = new HMISampleClientBeatCFOComplianceView($programStart, $programEnd, 414, 110);
        ...
        $ATBeatCfoOct->addAttributes(array(
            ...
            'requirement' =>
                '5 point each month you exceed the number of steps logged by CFO'
        ));
        $ATBeatCfoOct->setUseOverrideCreatedDate(true);
        $walkingGroup->addComplianceView($ATBeatCfoOct);

        $ATBeatCfoJanuary = new HMISampleClientBeatCFOComplianceView($programStart, $programEnd, 414, 110);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new HMISampleClientComplianceProgramReportPrinter();
        }
...
class HMISampleClientComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $hmiSampleWellnessEvents = $wellnessGroupStatus->getComplianceViewStatus('hmi_sample_wellness_events');
        ...
        <p style="text-align:center; font-size: 13pt; font-weight: bolder;">The Sample Client Comprehensive Wellness Program</p>
        <p>Dear <?php echo $status->getUser()->getFullName() ?>,</p>

        <p>
            Your health and your family’s health is important not only to you but to Sample Client as well! We are expanding and enhancing our wellness program for employees and their families and want to reward you for participating. We have partnered with HMI Health to implement our Wellness Program. The wellness program provides you with fun, robust programming options geared towards specific areas of your health that need improvement. This Wellness Program is your way to better, healthier living.
        </p>
        ...
        <p>
            ...
            Participation in the program will earn wellness points that will be tracked in the table below. Rewards will be
            based on points earned between 1/1/2017 and 12/31/2022 so plan your point accumulation accordingly.
        </p>
        ...
        <table class="phipTable">
            ...
            <tr>
                ...
                <td class="requirement">Attend Wellness Fair & Complete Survey</td>
            ...
            <tr>
                ...
                <td class="requirement">Receive a flu shot</td>
            ...
            <tr>
                <td>
                        <strong>K</strong>. <?php echo $hmiSampleWellnessEvents->getComplianceView()->getReportName() ?>
                </td>
                <td class="requirement"><?php echo $hmiSampleWellnessEvents->getComplianceView()->getAttribute('requirement') ?></td>
                <td class="center"><?php echo $hmiSampleWellnessEvents->getComplianceView()->getAttribute('points_per_activity') ?></td>
                <td class="center"><?php echo $hmiSampleWellnessEvents->getPoints() ?></td>
                <td class="center"><?php echo $hmiSampleWellnessEvents->getComplianceView()->getMaximumNumberOfPoints() ?></td>
            ...
            <tr>
                ...
                <td class="requirement">15 point each month you exceed the number of steps logged by CFO</td>
