...
class Bison2016ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView($programStart, '2016-08-30');
        ...
        $hraView->setAttribute('deadline', '08/05/2016');
        $hraView->emptyLinks();
        $hraView->addLink(new Link('Take HRA', '/content/989'));
        $coreGroup->addComplianceView($hraView);

        $screeningView = new CompleteScreeningComplianceView($programStart, '2016-08-30');
        $screeningView->setReportName('2016 Wellness Screening');
        ...
        $screeningView->setAttribute('deadline', '07/22/2016');
        ...
        $onsiteThree = new PlaceHolderComplianceView(ComplianceViewStatus::NOT_COMPLIANT);
        $onsiteThree->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(3, 0, 0, 0));
        $onsiteThree->setName('onsite_three');
        $onsiteThree->setReportName('Complete 3 onsite or telephonic health coaching calls');
        $onsiteThree->setAttribute('requirement', 'Complete 3 onsite or telephonic health coaching calls');
        $optionalCostGroup->addComplianceView($onsiteThree);

        $onsiteNPThree = new PlaceHolderComplianceView(ComplianceViewStatus::NOT_COMPLIANT);
        $onsiteNPThree->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(3, 0, 0, 0));
        $onsiteNPThree->setName('onsite_np_three');
        $onsiteNPThree->setReportName('Complete 3 onsite visits with NP or work with your physician on your health care plan');
        $onsiteNPThree->setAttribute('requirement', 'Complete 3 onsite visits with NP or work with your physician on your health care plan');
        $optionalCostGroup->addComplianceView($onsiteNPThree);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new Bison2016ComplianceProgramReportPrinter();
    ...
    public function getFinalIndividualCalculatedTier(User $user)
    {
        ...
        $onsiteThreeStatus = $status->getComplianceViewStatus('onsite_three');
        $onsiteNPThreeStatus = $status->getComplianceViewStatus('onsite_np_three');
        ...
        if($onsiteThreeStatus->getStatus() == ComplianceStatus::COMPLIANT
            && $onsiteNPThreeStatus->getStatus() == ComplianceStatus::COMPLIANT) {
            $threeLevelUp = true;
        }
        ...
        if($employeeHraCompleted && $employeeScreeningCompleted && $employeeNumTarget >= 5) {
            ...
            if($oneLevelUp || $twoLevelUp || $threeLevelUp) {
                return 'Tier 4 Basic (Increased Savings)';
            } else {
                return 'Tier 3 Basic (Savings)';
            }
...
class Bison2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $onsiteThreeStatus = $optionalGroupStatus->getComplianceViewStatus('onsite_three');
        $onsiteNPThreeStatus = $optionalGroupStatus->getComplianceViewStatus('onsite_np_three');
        ...
        <div class="pageHeading">2016 Bison Cares for You Program</div>
        ...
        <p>
            ...
            their 2016 Health Risk Assessment as shown below.
        </p>
            ...
            <div><br />
                ...
                <table class="phipTable">
                    ...
                    <tr class="headerRow headerRow-core">
                        <th class="center">1. Core Actions Required By 07/22/2016</th>
                    ...
                    <tr>
                        <td rowspan="2">
                            <strong>1</strong>. Move Up 1 Tier Level
                        </td>
                    ...
                    <tr>
                        <td rowspan="2">
                            <strong>2</strong>. Move Up 2 Tier Levels
                        </td>
                    ...
                    <tr>
                        <td rowspan="2">
                            <strong>2</strong>. Move Up 3 Tier Levels
                        </td>
                        <td class="result"><?php echo $onsiteThreeStatus->getPoints() ?></td>
                        <td class="requirement"><?php echo $onsiteThreeStatus->getComplianceView()->getAttribute('requirement') ?></td>
                        <td class="status"><img src="<?php echo $onsiteThreeStatus->getLight() ?>" class="light" /></td>
                        <td class="links">
                            <?php foreach($onsiteThreeStatus->getComplianceView()->getLinks() as $link) {
                                echo $link->getHTML()."\n";
                            }?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="result"><?php echo $onsiteNPThreeStatus->getPoints() ?></td>
                        <td class="requirement"><?php echo $onsiteNPThreeStatus->getComplianceView()->getAttribute('requirement') ?></td>
                        <td class="status"><img src="<?php echo $onsiteNPThreeStatus->getLight() ?>" class="light" /></td>
                        <td class="links">
                            <?php foreach($onsiteNPThreeStatus->getComplianceView()->getLinks() as $link) {
                                echo $link->getHTML()."\n";
                            }?>
                        </td>
                    </tr>
