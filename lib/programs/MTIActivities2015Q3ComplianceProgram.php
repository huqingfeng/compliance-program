...
class MTIActivities2015Q3WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validQ3Weeks = array(
        15 => '07/06/2015 through 07/12/2015',
        16 => '07/13/2015 through 07/19/2015',
        17 => '07/20/2015 through 07/26/2015',
        18 => '07/27/2015 through 08/02/2015',
        19 => '08/03/2015 through 08/09/2015',
        20 => '08/10/2015 through 08/16/2015',
        21 => '08/17/2015 through 08/23/2015',
        22 => '08/24/2015 through 08/30/2015',
        23 => '08/31/2015 through 09/06/2015',
        24 => '09/07/2015 through 09/13/2015',
        25 => '09/14/2015 through 09/20/2015',
        26 => '09/21/2015 through 09/27/2015'
    );
    ...
    public function getStatus(User $user)
    {
        ...
        foreach($records as $record) {
            ...
            if(isset($answers[144]) && !in_array($answers[144]->getAnswer(), self::$validQ3Weeks)) continue;
...
class MTIActivities2015Q3ComplianceProgram extends ComplianceProgram
{
    const MTI_2014_ACTIVITY_START_DATE = '2015-07-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null)
    {
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $points
        );
    ...
    protected function getSummableActivityView($name, $activityId, $questionId, $pointsPer, $divisor, $maxPoints, $reportName = null)
    {
      ...
      $view = new MTIActivities2015Q3WeeklyLogComplianceView($questionId, $pointsPer, $divisor, $additional);
    ...
    {
        $printer = new MTIActivities2015Q3ComplianceProgramPrinter();
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2015Q3WeeklyLogComplianceView::$validQ3Weeks[$w])) {
                    $text = MTIActivities2015Q3WeeklyLogComplianceView::$validQ3Weeks[$w];
    ...
    {
        $start = strtotime(MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        $learningView->setReportName('Complete an e-learning module');
        $learningView->setNumberRequired(1);
        $learningView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(5, 0, 0, 0));
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'light_activities');
        $learningView->setReportName('Complete an e-learning module');
        $learningView->setNumberRequired(1);
        $learningView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(5, 0, 0, 0));
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q3ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        $learningView->setReportName('Complete an e-learning module');
        $learningView->setNumberRequired(1);
        $learningView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(5, 0, 0, 0));
...
class MTIActivities2015Q3ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
