...
class CityOfMcKinney2019ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if(sfConfig::get('app_wms2')) {
            return new CityOfMcKinney2019WMS2Printer();
        } else {
            return new CityOfMcKinney2019WMS2Printer();
        }
    }
...
//        $biometricGroup->setPointsRequiredForCompliance(0);
        ...
        $preventative = new CompletePreventionPhysicalExamComplianceView('2018-12-01', '2019-11-30', $codes);
        ...
        $preventative->setReportName('Preventative Care Exam - must be completed between <br /> &nbsp;&nbsp; 12/1/2018 and 11/30/2019.');
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        if(!CityOfMcKinney2019ComplianceProgram::isOptionTwo($user)) {
            $numCompliant = 0;
            $coreCompliant = false;
...
class CityOfMcKinney2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <p>
            ...
            <strong>December 1, 2019</strong>.  Wellness Dollars earned in 2019 will be paid out in a lump-sum payment
            in January of 2020 (taxable income).
...
class CityOfMcKinney2019WMS2Printer implements ComplianceProgramReportPrinter
{
    private function getHeader(ComplianceProgramStatus $status)
    {
        ?>

        <?php if(!CityOfMcKinney2019ComplianceProgram::isOptionTwo($status->getUser())) : ?>
        <div class="row">
            <div class="col-md-12">
                <div>
                    <p>Participants can earn up to $600 Wellness Dollars for completing the three activities/goals below by
                        <strong>December 1, 2019</strong>. Wellness Dollars earned in 2019 will be paid out in a lump-sum payment in January
                        of 2020.</p>
            ...
            <div class="col-md-12">
                <div>
                    <p>Participants electing this option will receive a monthly, employee-only membership to the new McKinney
                        ...
                        Screen by <strong>December 1, 2019</strong>. The $100 lump-sum payout would occur in January of 2020. Memberships will be
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $isOptionTwo = CityOfMcKinney2019ComplianceProgram::isOptionTwo($status->getUser());
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="/compliance/mckinney-2019-interface/my-incentives/compliance_programs?<?php echo str_replace("1387", "1304", $_SERVER['QUERY_STRING']) ?>">View Previous Year's Report Card</a>
            </div>
        </div>
