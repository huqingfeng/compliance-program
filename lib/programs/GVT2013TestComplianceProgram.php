...
class GVT2013TestComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new GVT2013TestPrinter();
...
class GVT2013TestPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
