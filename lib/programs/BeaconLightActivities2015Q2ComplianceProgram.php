...
class BeaconActivities2015Q2DailyLogComplianceView extends CompleteActivityComplianceView
{
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints)
    {
        ...
        parent::__construct('2015-04-01', '2015-06-30');
...
class BeaconLightActivities2015Q2ScreeningConfirmationComplianceView extends ComplianceView
{
...
class BeaconLightActivities2015Q2ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2015Q2DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2015Q2ComplianceProgram::LIGHT_SPECTRUM_2014_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2015Q2ComplianceProgram::LIGHT_ACTIVITIES_2015_Q2_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2015Q2ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2015Q2ScreeningConfirmationComplianceView($startDate, $endDate);
    ...
    const LIGHT_ACTIVITIES_2015_Q2_RECORD_ID = 475;
    const LIGHT_SPECTRUM_2014_RECORD_ID = 335;
}



class BeaconLightActivities2015Q2ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
