...
class VillageOfDeerfieldPark2020WalkingComplianceView extends CompleteActivityComplianceView
{
...
class VillageOfDeerfieldPark2020TobaccoComplianceView extends ComplianceView
{
...
class VillageOfDeerfieldPark2020VacationTimeComplianceView extends ComplianceView
{
    public function __construct($startDate, $endDate)
    {
        $this->start_date = $startDate;
...
class VillageOfDeerfieldPark2020BiometricComplianceView extends ComplianceView
{
    public function __construct($startDate, $endDate)
    {
        $this->start_date = $startDate;
...
class VillageOfDeerfieldPark2020ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your summary page for the third year of the Wellness Rewards incentive program. Use this page to
        ...
        <p>Earn $1.00 for each point that you log. There is no minimum required. Earn up to $300.00 throughout the year
            (Nov 11, 2020 - October 31, 2021). Plus, earn 100 bonus dollars by participating in the 2021 Wellness
            Screening event that will take place in early October of next year. Log points by October 31, 2021 for your
            reward in 2021.</p>
...
class VillageOfDeerfieldPark2020ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new VillageOfDeerfieldPark2020ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2020-11-11', '2021-10-31'), array(), 525);
        $totalView->setReportName('<strong>By 10/31/2021</strong>');
    ...
    public function loadGroups()
    {
        ...
        $screening->addLink(new Link('Results', '/compliance/hmi-2016/my-health/content/my-health?tab=screening'));
        ...
        $cert = new CompleteArbitraryActivityComplianceView('2019-10-01', $endDate, 341, 15);
        $cert->setName('cert');
        ...
        $nonSmokerView = new VillageOfDeerfieldPark2020TobaccoComplianceView($startDate, $endDate);
        ...
        $vacationTime = new VillageOfDeerfieldPark2020VacationTimeComplianceView($startDate, $endDate);
        ...
        $improveBiometric = new VillageOfDeerfieldPark2020BiometricComplianceView($startDate, $endDate);
        ...
        $lunchWalkingView->addLink(new Link("Enter/Update Info", "/compliance/hmi-2016/my-rewards/wms1/content/12048?action=showActivity&activityidentifier=61061"));
        ...
        $loseWeightView->addLink(new Link("Enter/Update Info", "/compliance/hmi-2016/my-rewards/wms1/content/12048?action=showActivity&activityidentifier=61062"));
