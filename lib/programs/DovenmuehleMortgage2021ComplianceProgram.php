...
class DovenmuehleMortgage2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new DovenmuehleMortgage2021ComplianceProgramReportPrinter();
    }
...
class DovenmuehleMortgage2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width: 48%; text-align: right">
                    <img src="/images/empower/dovenmuehle_logo.png" style="height:50px;"  />
                </div>
            </p>
            ...
            <div style="margin-left:10px;">
                ...
                <p>
                    To earn the full incentive for this year, participants must complete the biometric screening and online health risk assessment.
                </p>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by April 30, 2021</th>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;">
                            <ol style="list-style-type: upper-alpha;">
                                <li>
                                    If your score is 0 or less &#8594; <span class="bold" style="color: green">Congratulations!  The lower the better!</span> <br />
                                    <span style="margin-left:160px;">&#8594; Your goal is to maintain 0 or less in 2022</span>
                                </li>
                                <li>If your score is 1-25 &#8594; Your goal is to reach 0 or less in 2022</li>
                                <li>If your score is 26-40 &#8594; Your goal is to reach 25 or less in 2022</li>
                                <li>If your score is 41 or more &#8594; Your goal is to reach 40 or less in 2022</li>
                            </ol>
                        </td>
