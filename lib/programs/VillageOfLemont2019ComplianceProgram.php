...
class VillageOfLemont2019TobaccoFormComplianceView extends ComplianceView
{
...
class VillageOfLemont2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your summary page for the 2019 Wellness Rewards benefit at Village of Lemont. This is the sixth year of the Village of
            Lemont's wellness rewards program and 2019 brings with it a few extra incentives to achieve your premium discount.</p>

        <p>In 2019, employees reaching the necessary number of points will receive a discount on their 2019 health insurance premium. There
            will also be incentives for those employees who participate but are not on our health plans.</p>

        <p>In order to earn the first premium discount, you must earn at least 325 points by June 21st, 2019. In order to continue to receive a
            premium discount, you will need to have earned at least a total of 525 points by December 16, 2019. You can earn these points
...
class VillageOfLemont2019ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new VillageOfLemont2019ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalFirstHalfView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2019-01-01', '2019-06-21'), array(), 325);
        $totalFirstHalfView->setReportName('<strong>By 06/21/2019</strong>');
        $totalFirstHalfView->setName('total_first_half');
        $totalsGroup->addComplianceView($totalFirstHalfView);

        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2019-01-01', '2019-12-16'), array(), 525);
        $totalView->setReportName('<strong>By 12/16/2019</strong>');
    ...
    public function loadGroups()
    {
        ...
        $nonSmokerView = new VillageOfLemont2019TobaccoFormComplianceView($startDate, $endDate);
