...
class AllianceGroup2020CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class AllianceGroup2020ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new AllianceGroup2020WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $scr = new CompleteScreeningComplianceView($screeningStart, $programEnd);
        ...
        $bloodPressureView = new ComplyWithBloodPressureScreeningTestComplianceView($screeningStart, $programEnd);
        ...
        $triglView = new ComplyWithTriglyceridesScreeningTestComplianceView($screeningStart, $programEnd);
        ...
        $ha1cView = new ComplyWithHa1cScreeningTestComplianceView($screeningStart, $programEnd);
...
//        $ha1cView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≤ 49 or ≥ 126');
        ...
        $cholesterolView = new ComplyWithTotalCholesterolScreeningTestComplianceView($screeningStart, $programEnd);
        ...
        $totalHDLRatioView = new ComplyWithTotalHDLCholesterolRatioScreeningTestComplianceView($screeningStart, $programEnd);
        ...
        $waistBMIView = new AllianceGroupComplyWithBMIWaistHipRatioScreeningTestComplianceView($screeningStart, $programEnd);
        $waistBMIView->setBmiView($this->getBmiView($screeningStart, $programEnd));
        $waistBMIView->setWaistHipView($this->getWaistHipView($screeningStart, $programEnd));
...
//        $waistBMIView->setUsePoints(true);
        ...
        $smokingView = new ComplyWithCotinineScreeningTestComplianceView($screeningStart, $programEnd);
        ...
        $smokingView->setStatusSummary(ComplianceStatus::COMPLIANT, 'Negative');
        $smokingView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, 'Positive');
...
class AllianceGroup2020WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul>
                    <li>Complete an HRA (complete by 11/30/2020)</li>
                    <li>Complete a health screening (complete by 11/30/2020)</li>
                    <li>Earn a minimum 10 of 15 points for having in-range biometrics, OR complete 1 of the alternative options mentioned in the yellow box below if 10 points aren't earned (complete by 12/11/2020)</li>
                </ul>

                If you are unable to attend the onsite screening, please contact the Circle Wellness Customer Service Department for alternative options at 866-682-3020 x 204
                </p>
                ...
                <div class="alert alert-warning">
                    ...
                    <ol>
                        <li><a href="/resources/10601/2020_Alliance_Physician_Verification_Formv2.pdf"  target="_blank" style="text-decoration:underline">DOWNLOAD A PHYSICIAN FORM</a> AND TAKE IT TO YOUR DOCTOR AND THEN SUBMIT IT VIA HIPPA SECURE FAX (1-800-887-9579 OR VIA THE UPLOAD DOCUMENT BUTTON.</li>
                        <li><a href="/content/9420?action=lessonManager&tab_alias=all_lessons"  target="_blank" style="text-decoration:underline">COMPLETE 5 E-LEARNING LESSONS</a>.</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <th>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="/resources/10601/2020_Alliance_Physician_Verification_Formv2.pdf"  target="_blank">Download this physician form</a> and take it to your doctor. Upload it via HIPPA secure fax to 1-800-887-9579 or via the upload documents button.</li>
                                        <li><a href="/content/9420?action=lessonManager&tab_alias=all_lessons" target="_blank">Complete 5 elearning lessons.</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </th>
