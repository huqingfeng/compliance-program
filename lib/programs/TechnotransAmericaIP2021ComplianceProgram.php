...
class TechnotransAmericaIP2021LearningAlternativeComplianceView extends ComplianceView
{
...
class TechnotransAmericaIP2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TechnotransAmericaIP2021ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/05/21');
        ...
        $hraView->setAttribute('goal', '11/05/21');
...
class TechnotransAmericaIP2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                        ...
                        <?php if($status->getStatus() == ComplianceStatus::COMPLIANT) : ?>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                ...
                                <strong>NO LATER THAN December 2, 2021</strong>
                            </td>
                         <?php endif ?>
                    </tr>
