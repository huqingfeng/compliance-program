...
class Intermatic2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Intermatic2019ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $hraScore->setPreMapCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            $lastHraScore = new HraScoreComplianceView('2018-09-01', '2019-08-31', 65);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $lastStart = new \DateTime('2018-09-01');
        $lastEnd = new \DateTime('2019-08-31');
...
class Intermatic2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>Thank you for participating in the 2019 Wellness Screening. In partnership with Health Maintenance
             Institute, Intermatic has selected five "Healthy Measures" for you to strive to achieve.</p>

            <p>As communicated, a medical premium discount will be offered to those employees who achieve at least 4 out
                of the 5 "Healthy Measures" below OR achieve a 10% improvement in any two of the "Healthy Measures" from
                your 2018 screening. If you do not meet the requirements, you may still qualify for the incentive by
                having your doctor complete and sign the Alternate Qualification Form and fax it to Health Maintenance
                Institute at 630-385-0156. If you do not successfully complete either of these options, you will not be
            ...
            <?php if($status->getStatus() == ComplianceStatus::COMPLIANT) : ?>
                ...
                <p>CONGRATULATIONS! Based on your results of the 2019 wellness screening, you either fall within the
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>Based on your results of the 2019 wellness screening, you <span class="bund">DO NOT</span> fall within
                    ...
                    <p>In order to receive the discount, we <strong>must</strong> have documentation from your Physician
                        ...
                        <a href="/resources/10399/2019_AQF_Intermatic.pdf">Alternate Qualification Form</a> will need
