...
class EdwCLevy2012ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new EdwCLevy2012ComplianceProgramReportPrinter();
    }
}

class EdwCLevy2012ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    <p>Welcome to The Edw. C. Levy Co. Wellness Website! This site was developed
        not only to track your wellness participation requirements, but also to be
        used as a great resource for health related topics and questions. We
        encourage you to explore the site while also fulfilling your requirements.
        Employees and Spouses must participate in the following steps if you are
        enrolled in the Levy Medical Plan or beginning January 1, 2013 you and
        <your></your>
        family will be enrolled in the Standard Plan (this plan has higher
        deductibles, higher co-pays, higher out-of-pocket costs and higher
        prescription co-pays).
    </p>

    <p><strong>Step 1</strong>- Complete your Health Risk Appraisal (HRA) at least one month prior
        to your health screening. Screenings are scheduled April through June, see
        your Wellness Coordinator for your location's date(s) and details.</p>
