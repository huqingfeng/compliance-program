...
class Autocam2011Coaching extends PlaceHolderComplianceView
{
...
class Autocam2011ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $physicianForm = new CompleteScreeningComplianceView('2011-04-01', '2011-06-30');
    ...
    {
        return new Autocam2011ComplianceProgramReportPrinter();
    }
}

class Autocam2011ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    <div id="program_information">
        ...
        <p>
            ...
            sharing. Currently the annual differential is $1,896 per employee. This rate may change for 2012.
        </p>
    </div>
        ...
        <tbody>
            ...
            <tr class="requiredrow">
                <td class="requirementscolumn">
                    ...
                    <a href="/content/11358" class="moreinfo">- more info</a>
                    <br/>
                    Receive from your Primary Care Physician (Exam must be completed between 4/1/10 - 6/30/11.)<a
                    href="/resources/3322/Autocam2011PhysicianForm.pdf">Download Physician Form</a>
                </td>
                <td class="myrequirementscolumn">
                    Yearly, Due <?php echo $complianceProgram->getEndDate('m/d/Y') ?>
                </td>
