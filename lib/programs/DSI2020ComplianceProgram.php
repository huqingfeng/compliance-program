...
class DSI2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new DSI2020ComplianceProgramReportPrinter();
    }
...
class DSI2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                        ...
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >0, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 3/15/2021.  You can
                                 <a href="/pdf/clients/dsi/2020_DSI_AQF.pdf" download="2020_DSI_AQF">download</a>
                            ...
                            <p>
                                ...
                                <a href="/compliance_programs/localAction?id=1551&local_action=dashboardCounts">About the health risk score.</a>
                            </p>
                        </td>
                    </tr>
