...
class BrookFurniture2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new BrookFurniture2019ComplianceProgramReportPrinter();
    }
...
class BrookFurniture2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                ...
                will pay less for medical coverage during 2020.
            </p>
            ...
            <p>
                ...
                available for your 2020 medical premiums.
            </p>
            ...
            <?php if($core_points >= 4) : ?>
                ...
                <p>CONGRATULATIONS! You have earned the <strong>Healthy Wellness Discount for 2020</strong>. Based on your wellness screening results,
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p style="color:red">Complete Alternate Qualification Form & submit to HMI by November 22, 2019:</p>

                    <p>
                        Team members that satisfy the designated ‘Alternate Process’ requirement
                        <a href="/resources/10398/Brook_Furniture_AQF_2019.pdf">and submit the qualification form</a>
                        ...
                        Physician's signature</span>. If your completed form is not received by HMI on or before November
                        22, 2019, you will NOT qualify for the <strong>Wellness Healthy Discount</strong>.
                    </p>
                </div>
            <?php endif ?>
