...
class TechnotransAmericaIPLearningAlternativeComplianceView extends ComplianceView
{
...
class TechnotransAmericaIP2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TechnotransAmericaIP2016ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/22/16');
        ...
        $hraView->setAttribute('goal', '11/22/16');
...
class TechnotransAmericaIP2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>Earning the incentive this year requires completing a wellness screening, the Empower Health
                ...
                your name will be on a list that is sent to Technotrans America for everyone earning the
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/8449/EHS Technotrans America IRC Alt To-Do Doctor Support Form 1007 101016.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 23, 2016</strong>
                            </td>
                         <?php endif ?>
                    </tr>
