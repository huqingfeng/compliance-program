...
class IncredibleTechnologies2017LearningAlternativeComplianceView extends ComplianceView
{
...
class IncredibleTechnologies2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new IncredibleTechnologies2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/10/17');
        ...
        $hraView->setAttribute('goal', '11/10/17');
...
class IncredibleTechnologies2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/9760/Incredible Tech_AQF_082817.pdf" target="_blank">Alternate Qualification Form</a>
