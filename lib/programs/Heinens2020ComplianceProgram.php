...
class Heinens2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Heinens2020ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $affidavitView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user){
            $affidavit_record = UserDataRecord::getNewestRecord($user, 'heinens_tobacco_2020', true);
        ...
        $elearningView = new CompleteELearningGroupSet($programStart, "2021-05-31", 'tobacco');
...
class Heinens2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <div class="pad20">
                ...
                <p>Let's get healthy, Heinen's! All associates and spouses can complete the Wellness Biometric Screening to earn up to a 50% contribution rate reduction for medical coverage in the 2020-2021 benefit year.</p>
            ...
            <div>
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td class="action_link">
                                            <a href="/compliance/heinens-2020/my-health">Take HPA</a><br>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <?php else: ?>
                                            <td class="text-center incorrect"><i class="far fa-times"></i></td>
                                        <?php endif; ?>
                                        <td class="action_link"><a href="/compliance/heinens-2020/tobacco-affidavit/content/heinens-tobacco-affidavit?year=2020">Tobacco Affidavit</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                ...
                <div style="padding: 20px; padding-top: 0px;">
                    <p><span class="bund">RESULTS APPEALS PROCESS</span><br>If you would like to participate in the Appeals process, please take <a href="https://static.hpn.com/resources/10515/2020_Heinen_s_Appeals Form_011320.pdf" target="_blank">this form</a> to be completed and signed by your primary care physician. You can fax the completed form or submit an electric copy which you can upload <a href="/compliance/heinens-2020/screening-incentive/content/chp-document-uploader">here</a>.</p>
