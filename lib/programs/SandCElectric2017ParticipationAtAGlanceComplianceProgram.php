...
class SandCElectric2017ParticipationAtAGlanceCompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class SandCElectric2017ParticipationAtAGlanceComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $screening = new SandCElectric2017ParticipationAtAGlanceCompleteScreeningComplianceView($startDate, '2017-05-05');
    ...
    {
        return new SandCElectric2017ParticipationAtAGlanceComplianceProgramReportPrinter();
    }
    ...
    public function getAdminProgramReportPrinter() {
        ...
        $printer->setShowUtilization(true);
        ...
        $printer->addCallbackField('Weigh In Screening Date', function (User $user) {
            $data = SandCElectric2017ComplianceProgram::getScreeningData($user, '2016-10-01', '2017-09-30');
        ...
        $printer->addCallbackField('Weigh In - Program Goal', function (User $user) {
            $data = SandCElectric2017ComplianceProgram::getScreeningData($user, '2016-10-01', '2017-03-31');
...
class SandCElectric2017ParticipationAtAGlanceComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
