...
class FederatedMedia2016ComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    public function printClientMessage()
    {
        ...
        <p>In order to receive your HSA incentive, you will be required to
            ...
            Appraisal. You will have until February 5, 2016 to complete your
            Health Risk Appraisal (HRA), the HRA will be available beginning December 21, 2015</p>
...
class FederatedMedia2016ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new FederatedMedia2016ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView($programStart, '2016-02-15');
    ...
    protected function checkReduction(array $tests) {
        ...
        $lastStart = new \DateTime('2015-01-01');
        $lastEnd = new \DateTime('2015-04-15');
