...
class Maitland2014ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new Maitland2014ComplianceProgramReportPrinter;
    }
...
class Maitland2014ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
    ...
    <p><strong>Step 2</strong>- Complete your Health Risk Assessment (HRA) Questionnaire by July 30, 2014. <a href="/content/1006">Click here </a> to complete your HRA if you have not done so already. Your current status for each are summarized below.</span></p>
