...
class RockfordParkDistrict2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new RockfordParkDistrict2021ComplianceProgramReportPrinter();
    }
...
class RockfordParkDistrict2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="1" style="text-align: left; width: 430px;">1. Get Started - Get these done by October 8, 2021</th>
                    ...
                    <tr class="headerRow">
                        <th colspan="1" style="text-align: left; width: 430px;">2. Earn 80 or more points from A&B below by October 8, 2021</th>
                        ...
                        <td colspan="2" style="text-align: left; ">
                            ...
                            <div style="display: block; width: 96%; float:right;">
                                <p>
                                    ...
                                    incentive by completing the required number of lessons noted below by 11/8/21:
                                </p>
                    ...
                    <tr class="rewards status-<?php echo $status->getStatus() ?>">
                        <td colspan="3" style="text-align: left; ">
                            ...
                            <div style="display: block; width: 96%; float:right;">
                                ...
                                <p>
                                    To do so, <a href="/resources/10683/Rockford_Park_District_2021_AQF_081021.pdf" target="_blank">download the AQF form here</a>. Complete the form working with your provider and return it to EHS by 11/08/21.
