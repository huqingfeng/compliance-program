...
class TransportationRepairServices2018LearningAlternativeComplianceView extends ComplianceView
{
...
class TransportationRepairServices2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TransportationRepairServices2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '10/01/18');
        ...
        $hraView->setAttribute('goal', '10/01/18');
        ...
        $cotinineView->setAttribute('goal', 'Negative or 3 lessons');
        ...
        $bmiView->setAttribute('goal', '≤29 or 2 lessons');
        ...
        $ldlView->setAttribute('goal', '≤130 or 2 lessons');
        $ldlView->setAttribute('screening_view', true);
        $ldlView->setAttribute('value', '$240');
        $ldlView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use ($programStart, $programEnd) {
            $view = $status->getComplianceView();
        ...
        $trigView->setAttribute('goal', '≤150 or 2 lessons');
        $trigView->setAttribute('screening_view', true);
        $trigView->setAttribute('value', '$240');
        $trigView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use ($programStart, $programEnd) {
            $view = $status->getComplianceView();
        ...
        $formView->setReportName('4. Or, if needed, turn-In a Completed Alternate Qualification Form <a href="/resources/10152/TRS Transportation Repair & Services_AQF_082018.pdf">Click here</a> to	download the form and details.');
...
class TransportationRepairServices2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                ...
                <ul>
                    <li>
                        Tobacco Free Reward: If results are negative for cotinine, it is worth $40 monthly for employees
                    ...
                    <li>
                        B.Healthy Measures Rewards: This includes incentives for 3 key measures: Body Mass Index, LDL
            ...
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        ...
                        <th>Goal by 11/23/18</th>
                        <th>My Result</th>
                        <th style="width:150px;">Lessons Completed</th>
                        <th>$Value / Year / Family</th>
                        <th>Goal Met</th>
                    </tr>
