...
class SBMF2019ActivitiesFlushotComplianceView extends DateBasedComplianceView
{
...
class SBMF2019ActivitiesBloodDonationComplianceView extends DateBasedComplianceView
{
    public function __construct($startDate, $endDate)
    {
        $this->setDateRange($startDate, $endDate);
...
class SBMF2019ActivitiesComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new SBMF2019ActivitiesComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $physicalView = new CompletePreventionPhysicalExamComplianceView($programStart, '2019-08-31');
        $physicalView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(2, 0, 0, 0));
        $physicalView->addLink(new Link('I did this', 'https://static.hpn.com/wms2/documents/clients/sbmf/2019_Physician_Biometric_Consent_Form.pdf'));
        $otherMeasurementsGroup->addComplianceView($physicalView);


        $flushotView = new SBMF2019ActivitiesFlushotComplianceView($programStart, '2019-03-31');
        ...
        $bloodView = new SBMF2019ActivitiesBloodDonationComplianceView($programStart, $programEnd);
        ...
        $additionalLessons = new CompleteAdditionalELearningLessonsComplianceView($programStart, "2019-10-31");
...
class SBMF2019ActivitiesComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    public function printClientMessage()
    {
        ...
        <ol><li><strong>Annual Physical Exam: </strong>
                ...
                Physical exams need to be completed between September 1, 2018 and August 31, 2019.
            </li><li><strong>Annual Flu Shot: </strong>
                Employees and spouses who received a flu vaccination between September 1, 2018 and March 31, 2019 will
                ...
                September 1, 2018 and December 31, 2019.
            </li></ol>
...
<!--        <div id="clientNotice">--><?php //$this->printClientNotice() ?><!--</div>-->
    ...
    public function printClientNote()
    {
        ?>
        <p>
            A maximum of 7 points are attainable through additional incentive activities.
        </p>
        <p>
            Note: You must complete the physician’s biometric screening, health risk appraisal and wellness laboratory
            testing for the wellness incentive offered in 2020. Points will be awarded for completing the annual physical
            exam and successfully meeting the biometric benchmarks.
        </p>
        <p>
