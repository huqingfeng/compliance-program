...
class UCAN2013WalkingSunshineView extends ComplianceView
{    
...
class UCAN2013PresidentialChallengeView extends ComplianceView
{
    public function getDefaultName()
    {
        return 'presidential_challenge';
    }

    public function getDefaultReportName()
    {
        return 'Presidential Challenge';
    }
    ...
    public function getStatus(User $user)
    {
        ...
        $presidentialChallengeTeamData = get_walking_teams('presidential_challenge_team');

        $participated = false;
        foreach($presidentialChallengeTeamData as $team) {
            if(in_array($user->getId(), array_keys($team))) $participated = true;
        }
...
class UCAN2013HolidayHustleView extends ComplianceView
{    
    public function getDefaultName()
    {
...
class UCAN2013TeamWalkingChallengeWinnerView extends ComplianceView
{
    public function getDefaultName()
    {
        return 'team_winner';
...
class UCAN2013SemesterWrapperView extends ComplianceView
{
...
class UCAN2013ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $elearn->setAttribute('report_name_link', '/content/1094#2aelearn');
        ...
        $regularFitnessTrainingView->setAttribute('report_name_link', '/content/1094#2bphysact');
        ...
        $flushotView->setAttribute('report_name_link', '/content/1094#2cflushot');
        ...
        $preventiveExamsView->setAttribute('report_name_link', '/content/1094#2dexams');
        $preventiveExamsView->emptyLinks();
        $preventiveExamsView->addLink(new Link('Click here for the verification form.', '/resources/4381/UCAN_PreventiveCare_Cert_81213.pdf'));
        ...
        $doctorView->setAttribute('report_name_link', '/content/1094#2edoc');
        ...
        $workWithHealthCoachView->setAttribute('report_name_link', '/content/1094#2fcoach');
        ...
        $HWAGLnlPrograms->setAttribute('report_name_link', '/content/1094#2gLnL');
        ...
        $HWAGQuizView->setAttribute('report_name_link', '/content/1094#2hquiz');
        ...
        $healthAnnualMembershipView->setAttribute('report_name_link', '/content/1094#2imember');
        $healthAnnualMembershipView->emptyLinks();
        $healthAnnualMembershipView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $runWalk5kView->setAttribute('report_name_link', '/content/1094#2j5k');
        $runWalk5kView->emptyLinks();
        $runWalk5kView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $runWalk10kView->setAttribute('report_name_link', '/content/1094#2k10k');
        $runWalk10kView->emptyLinks();
        $runWalk10kView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $runWalkHalfMarathonView->setAttribute('report_name_link', '/content/1094#2lhalfman');
        $runWalkHalfMarathonView->emptyLinks();
        $runWalkHalfMarathonView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $runWalkFullMarathonView->setAttribute('report_name_link', '/content/1094#2mfullman');
        $runWalkFullMarathonView->emptyLinks();
        $runWalkFullMarathonView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $tournamentParticipationView->setAttribute('report_name_link', '/content/1094#2ntourn');
        $tournamentParticipationView->emptyLinks();
        $tournamentParticipationView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $sportTeamParticipationView->setAttribute('report_name_link', '/content/1094#2oteam');
        $sportTeamParticipationView->emptyLinks();
        $sportTeamParticipationView->addLink(new link('Certification Form', '/resources/4467/UCANnonHWAGEventCert.090413.pdf'));
        ...
        $fitnessClubParticipationView->setReportName('UCAN Fitness Club Participation');
        $fitnessClubParticipationView->setAttribute('report_name_link', '/content/1094#2pfitclub');
        ...
        $miscPointsView->setAttribute('report_name_link', '/content/1094#2qmisc');
        $wellnessGroup->addComplianceView($miscPointsView, false, $healthTrainingEventsSection);

        $UCANTeamWalkingChallengeWinnerView = new UCAN2013TeamWalkingChallengeWinnerView();
        ...
        $UCANIndividualWalkingChallenge6kView = new HMIIndividualWalkingChallengeSixThousandSteps('2014-01-01', '2014-05-31', 276, 25);
        $UCANIndividualWalkingChallenge6kView->setReportName('HMI Individual Walking Challenge (6,000 steps)');
        $UCANIndividualWalkingChallenge6kView->setAttribute('report_name_link', '/content/1094#2r6kchall');
        ...
        $UCANIndividualWalkingChallenge8kView = new HMIIndividualWalkingChallengeEightThousandSteps('2014-01-01', '2014-05-31', 277, 10);
        $UCANIndividualWalkingChallenge8kView->setReportName('HMI Individual Walking Challenge (8,000 steps)');
        $UCANIndividualWalkingChallenge8kView->setAttribute('report_name_link', '/content/1094#2s8kchall');
        ...
        $UCANIndividualWalkingChallenge10kView = new HMIIndividualWalkingChallengeTenThousandSteps('2014-01-01', '2014-05-31', 278, 15);
        $UCANIndividualWalkingChallenge10kView->setReportName('HMI Individual Walking Challenge (10,000 steps)');
        $UCANIndividualWalkingChallenge10kView->setAttribute('report_name_link', '/content/1094#2t10kchall');
        ...
        $walkingOnSunshineView = new UCAN2013WalkingSunshineView();
        $walkingOnSunshineView->setAttribute('report_name_link', '/content/1094#walking_program');
        ...
        $holidayHustleView = new UCAN2013HolidayHustleView();
        $holidayHustleView->setAttribute('report_name_link', '/content/1094#walking_program');
        ...
        $presidentialChallengeView = new UCAN2013PresidentialChallengeView();
        $presidentialChallengeView->setAttribute('report_name_link', '/content/1094#3vteamwin');
        $presidentialChallengeView->setMaximumNumberOfPoints(40);
        $presidentialChallengeView->addLink(new Link('Enter/Update Info', '/content/ucan-fitbit-individual'));
        $wellnessGroup->addComplianceView($presidentialChallengeView, false, $walkingProgramsSection);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new UCAN2013ComplianceProgramReportPrinter();
...
class UCAN2013ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    <p>By participating in the incentive program you are not only earning an incentive in the form of reduced payments to your premium but you are also receiving benefits from improvement in your health and wellbeing.  Your efforts can help you avoid health problems and related expenses each year.  </p>
