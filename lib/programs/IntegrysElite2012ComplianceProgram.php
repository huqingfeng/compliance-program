<?php
class IntegrysEliteScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class IntegrysElite2012CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class IntegrysEliteWorkshop2012 extends AttendCompanyWorkshopComplianceView
{
...
class IntegrysElite2012ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $coreGroupEnd = strtotime('2012-03-31');

        $coreGroup = new ComplianceViewGroup('core', 'All Core Actions Required by Deadlines');
        ...
        $doctorView = new UpdateContactInformationComplianceView($programStart, $coreGroupEnd);
        ...
        $ongoingHealthCoachingView = new IntegrysElite2012CoachingView($programStart, $coreGroupEnd);
        $ongoingHealthCoachingView->setReportName('Return Health Coach calls within 5 days of being called -- If applicable');
        ...
        $extraGroup = new ComplianceViewGroup('points', 'And, earn 150 or more points from A-K below by '.date('F d, Y', $programEnd));
...
//
        ...
        $attendWorkshopView->setReportName('Participation In Integrys/Community Health Programs/Events');
        ...
        $weightProgramView = new PlaceHolderComplianceView(ComplianceStatus::NOT_COMPLIANT);
        $weightProgramView->setReportName('Participate In A Qualified Weight Management Program');
        $weightProgramView->setName('weight_program');
        $weightProgramView->setMaximumNumberOfPoints(50);
        $extraGroup->addComplianceView($weightProgramView);

        $tobFreeView = new PlaceHolderComplianceView(ComplianceStatus::NOT_COMPLIANT);
        $tobFreeView->setReportName('Participate In A Qualified Program to Become Tobacco Free');
        $tobFreeView->setName('tob_free');
        $tobFreeView->setMaximumNumberOfPoints(50);
        $extraGroup->addComplianceView($tobFreeView);

        $shareView = new PlaceHolderComplianceView(ComplianceStatus::NOT_COMPLIANT);
        $shareView->setReportName('Share Wellness Screening results with main doctor');
        $shareView->setName('share');
        $shareView->setMaximumNumberOfPoints(20);
        $extraGroup->addComplianceView($shareView);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new IntegrysEliteScreeningPrinter();
            ...
            $printer = new IntegrysElite2012ComplianceProgramReportPrinter();
        }
...
class IntegrysElite2012ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $weightStatus = $pointGroupStatus->getComplianceViewStatus('weight_program');
        $tobaccoStatus = $pointGroupStatus->getComplianceViewStatus('tob_free');
        $workshopStatus = $pointGroupStatus->getComplianceViewStatus('attend_workshop');
        $shareStatus = $pointGroupStatus->getComplianceViewStatus('share');
        ?>
    <style type="text/css">
    ...
    <p></p>
    <p>Welcome to your summary page for the 2012 Wellness Incentives.
    ...
    <p style="text-align:center;">
        <a href="content/1175">Details about the 2012 Wellness Rewards benefit and requirements</a>
    </p>
    <p></p>
    ...
    <tr>
        ...
        <td class="center">
            <?php
            if($completeScreeningStatus->getComplianceView() instanceof DateBasedComplianceView) {
                echo $completeScreeningStatus->getComplianceView()->getEndDate('m/d/Y');
            }
            ?>
        </td>
        <td class="center">
    ...
    <tr>
        ...
        <td class="center">
            <?php
            if($completeHRAStatus->getComplianceView() instanceof DateBasedComplianceView) {
                echo $completeHRAStatus->getComplianceView()->getEndDate('m/d/Y');
            }
            ?>
        </td>
        <td class="center">
    ...
    <tr>
        <td><a href="/content/1094#1cGHW">C. <?php echo $doctorStatus->getComplianceView()->getReportName() ?></a></td>
        <td class="center">
            <?php
            if($doctorStatus->getComplianceView() instanceof DateBasedComplianceView) {
                echo $doctorStatus->getComplianceView()->getEndDate('m/d/Y');
            }
            ?>
        </td>
        <td class="center">
    ...
    <tr>
        <td><a href="/content/1094#1dHC">D. <?php echo $infoStatus->getComplianceView()->getReportName() ?></a></td>
        <td class="center">
            <?php
            if($infoStatus->getComplianceView() instanceof DateBasedComplianceView) {
                echo $infoStatus->getComplianceView()->getEndDate('m/d/Y');
            }
            ?>
        </td>
        <td class="center">
    ...
    <tr>
        <td><a href="/content/1094#1dHC">E. <?php echo $coachStatus->getComplianceView()->getReportName() ?></a></td>
        <td class="center">
            <?php
            if($coachStatus->getComplianceView() instanceof DateBasedComplianceView) {
                echo $coachStatus->getComplianceView()->getEndDate('m/d/Y');
            }
            ?>
        </td>
        <td class="center">
    ...
    <tr>
        <td class="right" style="font-size: 7pt;">
            ...
            <?php echo $coachStatus->getComplianceView()->getEndDate('m/d/Y') ?>
        </td>
        <td></td>
        <td></td>
        <td class="center">
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2aKBHM">A. Have these screening results in the ideal zone:</a></td>
        <td colspan="3">
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2cRPS">B. <?php echo $preventiveScreeningsStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2dAFV">C. <?php echo $fluVaccineStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2eRPA">D. <?php echo $physicalActivityStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2fHC">E. <?php echo $workWithHealthCoachStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2gCoolEvents">F. <?php echo $workshopStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2hEL">G. <?php echo $extraELearningStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2iVT">H. <?php echo $volunteeringStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2iVT">I. <?php echo $weightStatus->getComplianceView()
            ->getReportName() ?></a></td>
        <td class="center"><?php echo $weightStatus->getPoints(); ?></td>
        <td class="center"><?php echo $weightStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
        <td class="links">
            <?php
            foreach($weightStatus->getComplianceView()->getLinks() as $link) {
                echo $link->getHTML();
            }
            ?>
        </td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2iVT">J. <?php echo $tobaccoStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td colspan="2"><a href="/content/1094#2iVT">K. <?php echo $shareStatus->getComplianceView()
            ->getReportName() ?></a></td>
        <td class="center"><?php echo $shareStatus->getPoints(); ?></td>
        <td class="center"><?php echo $shareStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
        <td class="links">
            <?php
            foreach($shareStatus->getComplianceView()->getLinks() as $link) {
                echo $link->getHTML();
            }
            ?>
        </td>
    ...
    <tr>
        <td class="right" colspan="2">Total number as of <?php echo date('m/d/Y'); ?> =</td>
    ...
    <tr class="headerRow">
        <th colspan="2">3. Deadlines, Requirements & Status</th>
        <td># Points</td>
        <td>Status</td>
    ...
    <tr>
        <td style="text-align: right;" colspan="2">Status of 1ABCDEF + ≥ 150 points as of: <?php echo date('m/d/Y'); ?>
            =
        </td>
