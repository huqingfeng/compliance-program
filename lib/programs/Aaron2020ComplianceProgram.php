...
class Aaron2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Aaron2020ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '10/2/2020');
        ...
        $hraView->setAttribute('goal', '10/2/2020');
...
class Aaron2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/pdf/clients/aaron_equipment/2020_Aaron_Equipment_AQF.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN October 31, 2020</strong>
                            </td>
                         <?php endif ?>
                    </tr>
