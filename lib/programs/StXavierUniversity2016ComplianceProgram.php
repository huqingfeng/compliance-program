...
class StXavierUniversity2016ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new StXavierUniversity2016ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $hraScreeningStartDate = '2015-10-01';
        $hraScreeningEndDate = '2016-09-30';
        ...
        $spouseStatus->setStatusSummary(ComplianceStatus::COMPLIANT, 'Spouse and/or dependent(s) complete the 2015 Biometric Screening & HRA');
        ...
        $phyExam->emptyLinks();
        $phyExam->addLink(new Link('Verification form', '/resources/6821/2015-16_PreventiveCare%20Cert.pdf'));
        ...
        $prevServ->addLink(new Link('Verification form', '/resources/6821/2015-16_PreventiveCare Cert.pdf'));
        ...
        $smoking->addLink(new Link('SXU Wellness Form', '/resources/6824/2015-16_WellnessEventCert.pdf'));
        ...
        $fiveK->addLink(new Link('SXU Wellness Form', '/resources/6824/2015-16_WellnessEventCert.pdf'));
        ...
        $cprCertified->addLink(new Link('SXU Wellness Form', '/resources/6824/2015-16_WellnessEventCert.pdf'));
...
class StXavierUniversity2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
//                $('.view-activity_21').children('td:eq(0)').attr('rowspan', 2);
        ...
        <p>Rewards will be based on points earned between 11/1/15 and 10/31/2016
        ...
        <table style="width:100%" id="status-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <span style="font-weight: normal;">Choice of $100 VISA Gift Card or Fitbit Flex</span>
                </td>
            </tr>
            <tr>
                <td>June 30, 2016</td>
