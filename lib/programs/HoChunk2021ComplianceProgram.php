...
class HoChunk2021ComplianceProgram extends ComplianceProgram
{
...
.title1 {                font-size: 13pt;
        ...
        <div>
          ...
          <p>        
          <ul>
            <li><span class="bold1">Blood Pressure:</span> 1 point is added per BP unit above 119/79 <span class="bold1">(Systolic/Diastolic)</span>. A credit of -5 points can be earned for EACH of your results that are at or below the target range.</li>
            <li><span class="bold1">LDL Cholesterol:</span> 1 point is added per LDL unit above 99 mg/dl.  A credit of -5 points can be earned if you are at or below your LDL target. </li>
    ...
    {
        return new HoChunk2021ComplianceProgramReportPrinter();
    }
...
class HoChunk2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width: 48%; text-align: right">
                    <img src="/images/ho_chunk/Ho-Chunk-Nation.png" style="height:70px;"  />
                </div>
            </p>
            ...
            <div style="margin-left:10px;">
                ...
                <p>
                    In order to earn the incentive for 2022, participants must only complete the screening and health risk assessment in 2021. The scoring below provides a baseline reading so that you understand your current overall risk score and what your personal health goal is for next year.
                </p>

                <p>
                    In order to earn the incentive for 2023, participants must achieve an overall health risk score of 0 or less or meet their personal health goal.
                </p>
            </div>
    ...
    private function getTable($status)
    {
        ...
        $topCompliant = $screeningStatus->isCompliant() && $hraStatus->isCompliant();
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 9/10/2021</th>
                    ...
                    <?php if ($topCompliant):?>
                        <tr class="status-4">
                            <td colspan="2" style="text-align: left;" class="activity_name">C. 1A & 1B are done for the 2022 Incentive</td>
                            <td colspan="2"></td>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;">
                            <ol style="list-style-type: upper-alpha;">
                                ...
                                <li>If your score is 26-40 &#8594; Your goal is ti reach 25 or less</li>
                    ...
                    <tr>
                        <td colspan="6">
                            <p>
                                ...
                                <a href="/compliance_programs/localAction?local_action=dashboardCounts">About the health risk score.</a>
                            </p>
                        </td>
                    </tr>
