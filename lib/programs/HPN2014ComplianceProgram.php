...
class HPN2014ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new HPN2014Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $scrMapper = new ComplianceStatusPointMapper(10, 5, 0, 0);
...
//        $key = new ComplianceViewGroup('key', 'See how many points you can earn! by '.$this->getEndDate('m/d/Y'));
        ...
        $prev = new CompletePreventiveExamWithRollingStartDateLogicComplianceView(date('Y-m-d'), $endDate, 5);
        ...
        $phy->setMaximumNumberOfPoints(1100);
        $phy->setFractionalDivisorForPoints(1);
        $phy->setMinutesDivisorForPoints(12);
        $phy->setCompliancePointStatusMapper(new CompliancePointStatusMapper(60 * 100, 5, 0, 0));
        ...
        $doc->addLink(new Link('Click For Form', '/resources/4981/HPN_DCM_note_from_doctor_072414.pdf'));
        ...
        $smart->setReportName('Present MAD/SMART/TED talks @ HPN');
        ...
        $my25->addLink(new Link('Take Me to My25', 'http://www.my25.com/organizations/sign_in/d3166a4c-7eaf-45ba-a381-c8996d1515ed/2a98ce36-7c9c-4d88-830e-27c78603953d'));
...
class HPN2014Printer extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <ol>
            <li>You will receive $500 pre-tax;</li>
