...
class MTI2018ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2')) {
            return new MTI2018WMS2Printer();
        } else {
            $printer = new MTI2018Printer();
...
class MTI2018Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
...
class MTI2018WMS2Printer implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
