...
class MTIActivities2018Q1WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '01/01/2018 through 01/07/2018',
        2 => '01/08/2018 through 01/14/2018',
        3 => '01/15/2018 through 01/21/2018',
        4 => '01/22/2018 through 01/28/2018',
        5 => '01/29/2018 through 02/04/2018',
        6 => '02/05/2018 through 02/11/2018',
        7 => '02/12/2018 through 02/18/2018',
        8 => '02/19/2018 through 02/25/2018',
        9 => '02/26/2018 through 03/04/2018',
        10 => '03/05/2018 through 03/11/2018',
        11 => '03/12/2018 through 03/18/2018',
        12 => '03/19/2018 through 03/25/2018',
        13 => '03/26/2018 through 04/01/2018'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2018-01-01', '2018-03-31');
...
class MTIActivities2018Q1ComplianceProgram extends ComplianceProgram
{
    const MTI_2018Q1_ACTIVITY_START_DATE = '2018-01-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2018Q1WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function executeAuthorizeFitbit(sfActions $actions)
    {
        ...
        if(handle_fitbit_registration($actions, $user)) {
            $actions->redirect('/compliance_programs?id=1306');
        } else {
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2018Q1WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2018Q1WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2018Q1_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2018Q1ComplianceProgram::MTI_2018Q1_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
