...
class FTE2012Using2011DataAutomotiveComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new FTE2012Using2011DataAutomotiveComplianceProgramReportPrinter();
    }
...
class FTE2012Using2011DataAutomotiveComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <p style="color:red; font-weight:bold;">This report card is setup so that you can see how you would have scored in
        2011 with the new 2012 criteria. <br/>
    ...
    <p>In addition to being a great resource for health-related topics, this site allows you to review the results from
        your 2011 wellness screening. </p>
    ...
    <p><a href="/resources/3791/Pregnancy exception form 2012.pdf">Are you pregnant or 6 months postpartum?</a></p>
