...
class CollegeParkChurch2014ComplianceProgram extends ComplianceProgram
{
  ...
  {
    return new CollegeParkChurch2014ComplianceProgramReportPrinter();
  }
}

class CollegeParkChurch2014ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
  ...
  <p> <a href="<?php echo url_for('/compliance_programs/?id=251') ?>">View previous, 2013 Report Card</a></p>
