...
class CHW18JanCincinnatiCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW18JanCincinnatiComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $quizLawsView = new CHW18JanCincinnatiCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365), false);
        ...
        $quizVitalView = new CHW18JanCincinnatiCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
...
//        $registerCHWView->addLink(new Link('Details & Places', '/content/1094#2dflu'));
    ...
    {
        $printer = new CHW18JanCincinnatiComplianceProgramReportPrinter();
...
class CHW18JanCincinnatiComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
