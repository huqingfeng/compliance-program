...
class FTE2013AutomotiveComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new FTE2013AutomotiveComplianceProgramReportPrinter();
    }
...
class FTE2013AutomotiveComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    <!--<p style="font-weight:bold"><a href="/compliance_programs?id=203">How would I have scored in 2011 with the new 2013 criteria?</a></p>-->
        <p>
            <a href="/compliance_programs/index?id=195">
    ...
    <p>In addition to being a great resource for health-related topics, this site allows you to review the results from
        your 2013 wellness screening as well as previous screening year’s results. </p>
    <p>When you complete your health screening in the fall of 2013, your results will be updated, and you will be able
        to determine
        if you qualify for the premium discount. </p>
    <p>You must complete the following steps in the fall of 2013 to receive your premium incentive of up to $90.00 per
        month ($1080.00 per year) beginning 1/1/2014.
    ...
    <p>Your health plan is committed to helping you achieve your best health.  Rewards for participating in a
        ...
        <a href="/content/12088?course_id=2740">Living Free</a> course by December 15, 2013 for credit. For all other biometric measures in your report card
        you may complete a <a href="/resources/4517/FTE_Medical_Exception_form092513.pdf">Medical Exception Form </a>at your personal physician and submit to Circle Wellness via info
        on the form no later than November 1, 2013. </p>


    <p><a href="/resources/4518/FTE_Pregnancy_exception_form092513.pdf">Are you pregnant or 6 months postpartum?</a></p>
