...
class Medtronic2021CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class Medtronic2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Medtronic2021ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView = new Medtronic2021CompleteScreeningComplianceView($programStart, $programEnd);
        ...
        $screeningView->setAttribute('goal', '12/06/21');
...
class Medtronic2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                Congratulations for participating in the 2021 Wellness Screening program. Below is a chart that outlines
            ...
            <p style="text-align: center; font-size: 13pt;">Your Healthy Measures Results for 2021</p>
        ...
        <p>
            <img src="/resources/10642/Medtronic_2021_AQF_031521.jpg" />
        </p>
    <?php endif ?>
                    ...
                    <tr>
                        <td colspan="7">
                            ...
                            <?php if($healthyGroupStatus->getStatus() == ComplianceStatus::NOT_COMPLIANT && $coreStatus->getComplianceViewStatus('complete_screening')->getComplianceView()->getAttribute('has_screening')) : ?>
                                <p style="color: red;">
                                    You may complete and return the <a href="/resources/10641/Medtronic_2021_AQF_031521.pdf">Alternate Qualification Form</a>
