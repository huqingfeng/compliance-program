...
class NSKPreventive2016ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if(sfConfig::get('app_wms2')) {
            return new NSKPreventive2016WMS2Printer();
        } else {
            return new NSKPreventive2016ComplianceProgramReportPrinter();
        }
...
class NSKPreventive2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
...
class NSKPreventive2016WMS2Printer implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div>
            <a href="https://static.hpn.com/wms2/documents/clients/nsk/2016%20Preventative%20Screening%20Recommendations.pdf">Recommended Preventative Tests</a>
        </div>
