...
class VangilderComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $coreGroupEndDate = strtotime('2010-02-28');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new VangilderComplianceProgramReportPrinter();
        }
...
class VangilderComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
