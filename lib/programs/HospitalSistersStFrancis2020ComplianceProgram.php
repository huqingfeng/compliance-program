...
class HospitalSistersStFrancisLearningAlternativeComplianceView extends ComplianceView
{
...
class HospitalSistersStFrancis2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new HospitalSistersStFrancis2020ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '11/23/20');
        ...
        $hraView->setAttribute('goal', '11/23/20');
        ...
        $bmiView->overrideTestRowData(null, null, 24.999, null);
        $bmiView->emptyLinks();
        ...
        $bloodPressureView->overrideSystolicTestRowData(null, null, 130.999, null);
        $bloodPressureView->overrideDiastolicTestRowData(null, null, 90.999, null);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        foreach($healthGroupStatus->getComplianceViewStatuses() as $viewStatus) {
            ...
            $noncompliant_values = ['QNS', 'qns', "Declined", "declined"];
            if (in_array($viewStatus->getComment(), $noncompliant_values)) {
...
class HospitalSistersStFrancis2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>Hospital Sisters of St. Francis is committed to encourage and help support the health, care and wellbeing
            ...
            <p>Earning the incentive this year requires completing a wellness screening, the Empower Health
                ...
                your name will be on a list that is sent to Hospital Sisters of St. Francis for everyone earning the
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10595/Hospital_Sisters_of_St_Francis_AQF_093020.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 4, 2020</strong>
                            </td>
                         <?php endif ?>
                    </tr>
