...
class Glenbrook20172018EmployeeSemesterWrapperView extends ComplianceView
{
...
class Glenbrook20172018EmployeeComplianceProgram extends ComplianceProgram
{
    /**
    ...
    public function getRaffleTickets(ComplianceProgramStatus $status)
    {
        ...
        Glenbrook20172018EmployeeSemesterWrapperView::setFirstSemesterOnly(true);

        $firstSemesterProgramStatus = $firstSemesterProgram->getStatus();

        Glenbrook20172018EmployeeSemesterWrapperView::setFirstSemesterOnly(false);
    ...
    public function loadGroups()
    {
        ...
        $screeningStartDate = '2017-05-02';
        $hraScreeningContactEndDate = '2017-12-15';

        $this->setComplianceStatusMapper(new AlternativeComplianceStatusMapper());

        $coreGroup = new ComplianceViewGroup('core', '$175 Rebate Requirements - verify/update contact info this year,
        ...
        Fitness Class) OR complete 2 E-Learning Lessons from qualifying list by December 15th, 2017.');
        ...
        $learningView->addLink(new Link('$175 Rebate Qualifying List 2017 <br />', '/content/9420?action=lessonManager&tab_alias=required_2016'));
        ...
        $workWithHealthCoachView->addLink(new Link('Get Dr. Form', '/resources/9691/GBD225FormDrOptionforScreeningFollow-Up.082417.pdf'));
        ...
        $offsiteFitViewWrapper = new Glenbrook20172018EmployeeSemesterWrapperView($offsiteFitView);
        ...
        $gymMembershipViewWrapper = new Glenbrook20172018EmployeeSemesterWrapperView($gymMembershipView);
        ...
        $exerciseView->setReportName('Other regular exercise (1 pt/hour; max 200/year; max 100 points each/semester)');
        ...
        $exerciseViewWrapper = new Glenbrook20172018EmployeeSemesterWrapperView($exerciseView);
        ...
        $partEventsView->setReportName('Participate in 5k or 10k Walk/Run Events between 05/02/2017 & 04/30/2018 (25 points each)');
        ...
        $partMarathonsView->setReportName('Participate in half or full marathons, triathlons, or iron man events between 05/02/2017 & 04/30/2018 (50 points each)');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new Glenbrook20172018EmployeeScreeningPrinter();
            ...
            $printer = new Glenbrook20172018EmployeeComplianceProgramReportPrinter();
        }
...
class Glenbrook20172018EmployeeScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class Glenbrook20172018EmployeeComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    {
        // Redirect to spouse compliance report
        global $_user;
        $relationship = $_user->getRelationshipType();
        if ($relationship == Relationship::SPOUSE) {
            header('Location: /compliance_programs?id=1291'); exit();
        }
...
//        $this->setScreeningResultsLink(new FakeLink('Have These Screening Results in the Ideal Zone:', '/content/1094#2aKBHM'));
        ...
        <script type="text/javascript">
            $(function(){
                ...
                $('.view-additional_elearning').after('<tr style="font-size:9pt; height:30px; text-align:center;"><td>$175 Rebate Reward Status</td><td></td><td><img src="<?php echo $coreGroupStatus->getLight(); ?>" class="light" alt=""/></td><td style="font-size:8pt;">Deadline - 12/15/2017</td></tr><tr style="height:36px;"><td colspan=4></td></tr>')
        ...
        <div id="altPageHeading">Glenbrook School District 225’s 2017-2018 Shape Your Life Program</div>

        <p><strong>Hello <?php echo $status->getUser()->getFullName(); ?>,</strong></p>


        <p>Welcome to your summary page for Glenbrook School District 225’s 2017-2018 Shape Your Life Program.
        ...
        <ol>
            <li><strong>$175 Medical Premium Rebate For Employee Only Participation </strong> –  By verifying your contact
                information this year, completing the Health Power Assessment (HPA) this year, participating in the Annual
                Wellness Screening (or qualified screening by your own doctor) this year, verifying you have a Main / Primacy
                Care Provider with their contact info or confirming historical info is accurate for this year, Completing 1
                E-Learning Lesson from the qualifying list, and Attending 1 Wellness Sponsored Event OR Completing 2 additional
                E-Learning Lessons from a qualifying list you will received $175 rebate on your medical benefit premiums. All
          activities must be completed by 12/15/2017. Rebates will be distributed in one lump sum in early Spring 2018.</li><br />

            <li><strong>$250 Medical Premium Rebate Total For Employee + Spouse Participation</strong> – Employees must complete
                all of the activities listed above under the $175 Medical Premium Rebate For Employee Only Participation. If
                additionally an employee's spouse completes the Health Power Assessment (HPA) and participates in the Annual Wellness
                Screening (or qualified screening by your own doctor) this year the Employee will receive a total medical premium rebate of $250.
            Retirees are not eligible for medical premium rebates.</li><br />

            <li><strong>Winter Raffle with prizes including Fitbit HRs and iPad Mini 2s</strong> – Choose from activities
                in 2A-S below to earn points for key actions you are taking for your health and wellbeing PLUS some bonus
                points for certain screening results. Get 1 raffle ticket for every 100 points earned. Deadline to enter
                points for Winter Raffle is 12/15/2017. Please note, you are only eligible for raffles if you register
            ...
            <li><strong>Spring Raffle with prizes including Fitbit HRs and iPad Mini 2s</strong> – Choose from activities
                in 2A-S below to earn points for key actions you are taking for your health and wellbeing PLUS some bonus
                points for certain screening results. Get 1 raffle ticket for every 100 points. Deadline to enter points
                for Spring Raffle is 04/30/2018. Please note, you are only eligible for raffles if you register for the
                Shape Your Life program at the start of the year.
            </li><br />

            <li><strong>2018 Prize</strong> – By earning a total 400 points you can receive the 2018 Shape Your Life Prize.
                Historically this has been a wearable, backpack, or bag. Choose any activities that you would like to participate
                in from 2A-S to earn the 400 points required for the 2018 Prize. Deadline to enter points for 2018 Prize
                is 04/30/2018. Please note, you are only eligible for the 2018 Prize if you register for the Shape Your
                Life program at the start of the year.
            </li>
        </ol>
    ...
    protected function printCustomRows($status)
    {
        ...
        <tr>
            <td style="text-align:right;">
                2017 Winter Raffle: # Tickets by 12/15/2017
            </td>
            <td style="text-align:center;">
                <?php echo $raffleTickets['2017_winter_i_gift_card_raffle_tickets'] ?>
            </td>
        ...
        <tr>
            <td style="text-align:right;">
                2018 Spring Raffle: # Tickets by 04/30/2018
            </td>
            <td style="text-align:center;">
                <?php echo $raffleTickets['2018_spring_raffle_tickets'] ?>
            </td>
            <td style="text-align:center;" colspan="2">
                18 tickets possible per person
            </td>
        </tr>
        <tr>
            <td style="text-align:right;">
                2018 SYL Prize: Earn 400 points by 04/30/2018
            </td>
            <td style="text-align:center;">
                <?php echo $raffleTickets['2018_wearable_award_tickets'] ?>
            </td>
            <td style="text-align:center;" colspan="2">
