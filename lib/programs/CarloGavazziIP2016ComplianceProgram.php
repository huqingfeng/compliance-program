...
class CarloGavazziIP2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new CarloGavazziIP2016ComplianceProgramReportPrinter();
    }
...
class CarloGavazziIP2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/8421/EHS Carlo Gavazzi IRC Alt To-Do Doctor Support Form rev2 092216.pdf" target="_blank">Alternate Qualification Form</a>
