...
class IPCInternational2020ComplianceProgram extends ComplianceProgram
{
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $printer->addStatusFieldCallback('Total Risk Score', function($status) {
            ...
            return $healthRiskPoints;
        });

        $printer->addStatusFieldCallback('Total Compliant', function($status) {
    ...
    {
        return new IPCInternational2020ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $tobaccoView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            } elseif($status->getAttribute('has_result')) {
                if($status->getStatus() == ComplianceStatus::COMPLIANT) {
                    $status->setAttribute('health_risk_points', 0);
...
class IPCInternational2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <div style="margin-left:10px;">
                ...
                <p>
                    To earn the full incentive for this year, participants must achieve an overall health risk score of 25 or less.
                </p>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started – Get these done by 1/31/2021</th>
                    ...
                    <tr class="headerRow">
                        ...
                        <td>Is score ≤25 or is AQF received?</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;">
                            <ol style="list-style-type: upper-alpha;">
                                <li>If your score is 0 or less &#8594; <span class="bold" style="color: green">Congratulations!  The lower the better!</span> <br/><span style="margin-left:160px;">&#8594; Your goal is to maintain 0 or less in 2021</span></li>
                                <li>If your score is 1-25 &#8594; Your goal is to reach 0 or less in 2021</li>
                                <li>If your score is 26-40 &#8594; Your goal is to reach 25 or less in 2021</li>
                                <li>If your score is 41 or more &#8594; Your goal is to reach 40 or less in 2021</li>
                            </ol>
                        </td>
                    ...
                    <tr>
                        <td colspan="6">
                            <p style="margin:10px; width:95%;">
                                E. If risk score is >25, you may still earn the full incentive by having your physician
                                 complete and submit the Alternate Qualification Form by 2/28/2021.  You can
                                 <a href="/resources/10606/2020_IPC_International_AQF_112520.pdf" download="2021_AQF">download</a>
