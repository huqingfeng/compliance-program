...
class TechnotransAmericaIP2018LearningAlternativeComplianceView extends ComplianceView
{
...
class TechnotransAmericaIP2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TechnotransAmericaIP2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/08/18');
        ...
        $hraView->setAttribute('goal', '11/08/18');
...
class TechnotransAmericaIP2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10139/Technotrans_America_AQF_081418.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 6, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
