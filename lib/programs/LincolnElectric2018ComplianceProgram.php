...
class LincolnElectric2018CompleteScreeningView extends CompleteScreeningComplianceView
{
    ...
    public function getData(User $user)
    {
        $query = SelectQuery::create()
            ...
            ->andWhere('(s.created_at <= ? || s.created_at >= ?)', array('2017-12-31', '2018-11-29'));
...
class LincolnElectric2018HomePageComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $screeningFormView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use($screeningFormView) {
            ...
            if($activeProgramRecord->id == 1340) {
            ...
            $status->getComplianceView()->addLink(new Link('Download Form', '/resources/10037/2018 PCP Form 032918.pdf', false, '_blank'));
...
class LincolnElectric2018ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $screeningView = new LincolnElectric2018CompleteScreeningView($programStart, $programEnd);
        ...
        $screeningView->setAttribute('deadline', '11/16/2018');
        ...
        $screeningView->addLink(new Link('<br />Download Form', '/resources/10037/2018 PCP Form 032918.pdf'));
        ...
        $nicotineFormView->setAttribute('deadline', '11/16/2018');
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $printer->addMultipleStatusFieldsCallback(function(ComplianceProgramStatus $status) {
            ...
            return array(
                ...
                'Program - 2018 Wellness Screening - Compliant' => $completeScreeningStatus->isCompliant() ? 'Yes' : 'No',
                'Program - 2018 Wellness Screening - Comment' => $completeScreeningStatus->getComment(),
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new LincolnElectric2018ComplianceProgramReportPrinter();
...
class LincolnElectric2018ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="pageHeading">2019 HealthLinc Workplace Wellness Program</div>
