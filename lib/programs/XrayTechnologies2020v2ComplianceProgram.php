...
class XrayTechnologies2020v2ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new XrayTechnologies2020v2WMS2Printer();
    }
    ...
    function getRisk(User $user) {
        ...
        $risk = getChpExtendedRiskForUser($user, array_unique(array_merge(array_keys($riskIdentifiers), array_keys($resultIdentifiers))), !empty($hraData['id']) ? $hraData['id'] : false, !empty($screeningData['id']) ? $screeningData['id'] : false, '2019-12-01', '2020-03-30');
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new CompleteScreeningComplianceView("2020-06-01", $program_end);
        ...
        $consultation_view = new CompletePrivateConsultationComplianceView($program_start, "2021-03-01");
        ...
        $spouseParticipation->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if(!$spouseUser || (isset($this->options['in_spouse']) && $this->options['in_spouse']))  {
                ...
                $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologies2020v2ComplianceProgram::XRAYTECHNOLOGIES_2020_V2_RECORD_ID)->getComplianceProgram(array('in_spouse' => true));
    ...
    const XRAYTECHNOLOGIES_2020_V2_RECORD_ID = 1532;
}


class XrayTechnologies2020v2WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div id="">
            <h3>2020 X-Ray Report Card</h3>
            <div class="main-content">
                <p>Due to the many unknowns of the COVID 19 Pandemic and the challenges we may continue to face, we’ve made some changes to the wellness program to simplify the requirements for this year while offering you a more in-depth picture of your well-being.</p>

                <ul>
                    <li>
                        <p><strong>Let's avoid flu season!</strong> We felt it was in our employees’ best interest to begin accepting biometric screenings in August this year to avoid sending you to your physician’s office or to the lab during flu season! We hope you will take advantage of this opportunity!</p>
                    </li>
                    <li>
                        <p>	There are only <strong>TWO requirements</strong> that everyone must complete in 2020 to be compliant for 2021: <strong>Take the Health Risk Assessment</strong> and <strong>Complete a Screening</strong>. If you are identified by Circle Wellness through your HRA and Screening results to be of higher risk, you will be notified by letter and will be required to either complete 1 health coaching call with Circle Wellness or submit a form from your doctor stating that you have shared your results with them. </p>
                    </li>
                    <li>
                        <p>Our health screening panel is expanding this year! We know that the more health concerns a person has, the more susceptible they are to complications from COVID. We want to help you identify more areas of concern and have expanded the testing panel this year to provide you with a better look at your overall health. <a href="http://www.static.hpn.com/pdf/clients/xray/Screening_Components_29_Panel_Plus_HBA1C.pdf" target="_blank">Click here to view all results that will be tested.</a> All results are confidential and will only be accessed by Circle Wellness.</p>
                    </li>
                </ul>
            ...
            <div class="basic-report-card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 actions">
                        <a class="btn btn-primary btn-sm" href="/compliance/xray-industries-2020/my-health">Take HRA</a>
                    </div>
                    <div class="col-sm-2 icon hra"><?= $hra_status; ?></div>
                </div>
                <div class = "alert alert-norisk" style="display: inline-block;">Complete between 8/1/2020 & 11/2/2020</div>
                <div class="row">
                    <div class="col-sm-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 actions">
                        ...
                        <a class="btn btn-primary btn-sm top-buffer-10" href="http://www.static.hpn.com/pdf/clients/xray/X-Ray_Physician_Packet.pdf" target="_blank">Download Physician Form</a>
                    </div>
                    <div class="col-sm-2 icon screening"><?= $screening_status; ?></div>
                </div>
                <div class = "alert alert-norisk">Request an on-demand packet to take to a local LabCorp location or download the physician form and bring it to your doctor. Complete between 6/1/2020 & 11/2/2020</div>
                <div class="row">
                    <div class="col-sm-12">
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 actions">
                        <a class="btn btn-primary btn-sm" href="http://www.static.hpn.com/pdf/clients/xray/2021_Physician_Verification_Letter.pdf" target="_blank">Download Form</a>
                    </div>
                    <div class="col-sm-2 icon consultation"><?= $share_results_status; ?></div>
                </div>
                <div class = "alert alert-norisk">If you have 4 or more risks, share your results with your physician and have them complete and return the Physician Form or call Circle Wellness at 1-866-682-3020; ext. 204 to complete one coaching call with the health coach by 3/1/2021</div>
