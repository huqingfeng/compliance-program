...
class TechnotransAmericaIP2020LearningAlternativeComplianceView extends ComplianceView
{
...
class TechnotransAmericaIP2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TechnotransAmericaIP2020ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/06/2020');
        ...
        $hraView->setAttribute('goal', '11/06/2020');
...
class TechnotransAmericaIP2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10579/2020_technotrans america_AQF_081220.pdf" target="_blank">Alternate Qualification Form</a>
