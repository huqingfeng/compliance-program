...
class Justrite2019ManufacturingAlternativeComplianceStatusMapper extends ComplianceStatusMapper
{
...
class JustriteManufacturing2019ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $this->setComplianceStatusMapper(new Justrite2019ManufacturingAlternativeComplianceStatusMapper());
        ...
        $numbers = new ComplianceViewGroup('points', 'Gain points through areas D-E below by the November 18, 2019 deadline in order to receive a premium discount.');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new JustriteManufacturing2019ComplianceProgramReportPrinter();
        }
...
class JustriteManufacturing2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-ras_physician .result').html('<a href="/resources/10385/Justrite_Points_Sheet&RAS_Form_2019_v2.pdf">RAS Physician Verification Form</a>');
                ...
                $('.view-comply_with_bmi_screening_test').children(':eq(3)').html('<a href="/compliance_programs?preferredPrinter=ScreeningProgramReportPrinter&id=1414">View Result</a><br /><a href="/content/9420?action=displayQuiz&category_url=L2NvbnRlbnQvOTQyMD9hY3Rpb249bGVzc29uTWFuYWdlciZ0YWJfYWxpYXM9YWxsX2xlc3NvbnM%3D&category=QWxsIExlc3NvbnM%3D&quiz_id=3574">Complete 1 Body Metric Lesson</a>');
        ...
        <p>Welcome to your summary page for the 2019 Justrite Screening Criteria and Premium Discounts.
            <strong>The deadline to complete all actions is November 18, 2019.</strong></p>
