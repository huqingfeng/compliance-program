...
class AmericanGeneral2015ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new AmericanGeneral2015ComplianceProgramReportPrinter;
    }
...
class AmericanGeneral2015ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
    ...
    public function printClientMessage()
    {
        ...
        <p><strong>Step 2</strong>- <a href="/content/1006">Click here </a> to complete your HRA if you have not done so already. Your current status for each are summarized below.</span></p>
