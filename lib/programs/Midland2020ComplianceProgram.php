...
class Midland2020TobaccoFormComplianceView extends ComplianceView
{
...
class Midland2020ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'Core Actions to get done by 1/31/21 for your Core Reward and toward your Bonus Reward:');
        ...
        $screeningView->addLink(new Link('Results', '/compliance/midland-paper-2019/my-results/content/my-health'));
        ...
        $hraView->setName('hra');
        $hraView->emptyLinks();
        $hraView->addLink(new Link('Take HRA', '/compliance/midland-paper-2019/my-results/content/my-health'));
        $hraView->addLink(new Link('Results', '/compliance/midland-paper-2019/my-results/content/my-health'));
        $coreGroup->addComplianceView($hraView);

        $this->addComplianceViewGroup($coreGroup);

        $numbers = new ComplianceViewGroup('points', 'And, earn at least 350 points by 1/31/21 through the opportunities below for your Bonus Reward:');
...
//        $hdlCholesterolView->overrideTestRowData(0, 0, 4.499, 4.499);
        ...
        $nonSmokerView = new Midland2020TobaccoFormComplianceView($programStart, $programEnd);
        ...
        $physicalActivityView->setReportName('Get Regular Physical Activity - use one or both below to sync or update for exercise/activity points between 2/1/20 and 1/31/21');
        $physicalActivityView->setMaximumNumberOfPoints(250);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinterMidland' && $this->getActiveUser() !== null) {
            ...
            $printer = new Midland2020ComplianceProgramReportPrinter();
        }
...
class Midland2020ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your summary page for the 2021 Midland Paper Wellness Rewards benefit.</p>

        <p><em>Do you have medical benefit coverage through Midland Paper?</em> If yes, you can earn rewards of $480 to $1,080 ($40-$90 per month) in savings toward your 2021 medical plan premium contribution.</p>

        <p>
            Here’s how:
        <ol>
            <li><strong>Core Reward</strong> – complete the Wellness Screening and Health Power Assessment by 1/31/21 and get:
                <ol type="a">
            ...
            <li><atrong>And a Bonus Reward</atrong> – get the core actions (above) done <strong>PLUS</strong> earn at least 350 points by 1/31/21 and:
                <ol type="a">
        ...
        <p>
            ...
            <span style="font-size: 14pt; text-align: center; display: block;"><a href="/content/1094_midlandpaper_2020">Click here for more details about each action and point-earning option.</a> </span>
        </p>
    ...
    { 
        // this is here so the points can be retrieved for the to do list on midlands home page
        if(isset($_GET['points_only'])) {
            echo json_encode(['total_points' => $status->getPoints(), 'screening' => $status->getComplianceViewStatus('annual_screening')->getStatus(), 'hra' => $status->getComplianceViewStatus('hra')->getStatus()]);
            die;
        }
        ...
        <table class="phipTable">
           ...
           <tbody>
              <tr class="headerRow headerRow-core">
                 <th><strong>1</strong>. Core Actions to get done by 1/31/21 for your Core Reward and toward your Bonus Reward:</th>
                 <td></td>
                 <td>Completed</td>
                 <td>Status</td>
                 <td>Links</td>
              ...
              <tr class="headerRow headerRow-points">
                 <th><strong>2</strong>. And, earn at least 350 points by 1/31/21 through the opportunities below for your Bonus Reward:</th>
                 <td>My Steps</td>
                 <td># Points Earned</td>
              ...
              <tr>
                ...
                <td class="center"></td>
                <td class="links"><a href="/content/fitness">Fitness Tracker</a></td>
            </tr>
            <tr>
                ...
                <td class="center"></td>
                <td class="links"><a href="/content/fitness">Enter/Update Info</a></td>
            </tr>
            ...
            <tr>
              ...
              <tr class="view-get_fit">
                 ...
                 <td class="points"><?php echo $getFitStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $volunteerStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $preventativeStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $wellnessStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $bcbsStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $mdLiveStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $eapStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
              ...
              <tr class="view-volunteer">
                 ...
                 <td class="points"><?php echo $enterInfoStatus->getComplianceView()->getMaximumNumberOfPoints(); ?></td>
                 <td class="links">
           ...
           <tbody>
              ...
              <tr class="bonus_panel">
                 <td colspan="3">Core Reward status: Core Actions done as of <?php echo date('m/d/y'); ?> </td>
                 <td class="center"><img style="width:25px;" src="<?php echo $light_map[$coreGroupStatus->getStatus()]; ?>"></td>
                 <td><?php echo $overall_text; ?></td>
              </tr>
              <tr class="bonus_panel">
                 <td colspan="3">Bonus Reward status: Core Actions done + ≥350 points earned</td>
                 <td class="center"><img style="width:25px;" src="<?php echo $overall_status; ?>"></td>
                 <td><?php echo $overall_text; ?></td>
              </tr>
           </tbody>
        </table>
