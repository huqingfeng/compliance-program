...
class SBMF2015BloodDonationComplianceView extends DateBasedComplianceView
{
...
class SBMF2015BMIMaintainComplianceView extends DateBasedComplianceView
{
...
class SBMF2015BMIReductionBonusComplianceView extends DateBasedComplianceView
{
    public function __construct($start, $end)
    {
        $this->setStartDate($start);
...
class SBMF2015LifestyleProgramOne extends PlaceHolderComplianceView
{
}

class SBMF2015LifestyleProgramTwo extends PlaceHolderComplianceView
{
}

class SBMF2015ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new SBMF2015ComplianceProgramReportPrinter();
        $printer->setPageHeading('My 2015 Incentive Scorecard');
    ...
    public function loadGroups()
    {
        ...
        $hraScreeningView = new CompleteHRAAndScreeningComplianceView('2015-04-01', '2015-08-31');
...
//        $bmiLearn->setEvaluateCallback($this->constructCallback($bmiReductionView));
        ...
        $physicalView = new CompletePreventionPhysicalExamComplianceView('2014-09-01', '2014-09-01');
        $physicalView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(2, 0, 0, 0));
        $physicalView->addLink(new Link('I did this', '/content/chp-document-uploader'));
        ...
        $bloodView = new SBMF2015BloodDonationComplianceView('2014-09-01', '2015-10-31');
...
<?php 
    ...
    const ACTIVITY_RECORD_ID = 469;
}

class SBMF2015ComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
...
//                    $('.phipTable tbody').children(':eq(33)').hide();
    ...
    <p><a href="/compliance_programs/localAction?id=468&local_action=previous_reports">Previous Year Scorecards</a></p>
    ...
    <p>Welcome to The SBMF Wellness Website! This site was developed to:</p>
        ...
        <div id="steps">
            <p>By completing the following steps in 2015 you will be eligible for the wellness incentive offered in 2016:</p>

            <p><strong>Step 1</strong>: Complete your health screening, HRA, and blood draw that will be scheduled in July and August, 2015.</p>

            <p><strong>Step 2</strong>: You will again have the opportunity to earn incentive points in 2015. You will need to obtain a minimum of 9
                incentive points to be eligible for the wellness incentive offered in 2016. You are not required to meet the target range for each individual
                ...
                or submit a medical exception form to Circle Wellness. As long as you accumulate a total of 9 points by 10/31/2015, you will be eligible
                for the wellness incentive offered for the 2016 plan year.
            </p>
        </div>
        ...
        <div id="sub_steps">
            ...
            <ol>
                ...
                <li><strong>Health Profile Measurements</strong>: Point values are assigned below in your report card for each measure. Meet the
                    ...
                    2014 screening. Measurements will be taken at the July and August, 2015 onsite wellness screenings.
                </li>

            </ol>
        </div>

<p><a href="compliance_programs?id=469">Click Here to View My Incentive Activities Page</a></p>
    ...
    public function printClientNotice()
    {
        ...
        ?>
        Your scorecard will be updated throughout the year as incentive points are earned. Smoking status and Health Profile measurements will not be updated until completion of the August 2015 screenings. You may use your 2014 health screening results to give you an indication of your current potential to earn incentive points.
    <br/>
        <?php if($user->gender == Gender::FEMALE) : ?>
          <p><a href="/resources/5666/SBMF-Pregnancy-ExceptionForm2015.060815.pdf">Are you pregnant?</a></p>
        <?php endif ?>
       
        <?php
    }
    ...
    <p>
        <strong>Note:</strong>
        Screening Program
        is required for the wellness incentive offered in 2016. No points are awarded for completing the screening program.
    </p>
    <p>
        ...
        an <a href="/resources/5665/SBMF-ExceptionForm2015.060815.pdf">exception form</a>
