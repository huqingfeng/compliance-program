...
class Android2014PCPCampaign extends UpdateDoctorInformationComplianceView
{
...
class Android2014CompleteScreeningView extends CompleteScreeningComplianceView
{
...
class Android2014CompleteHraAndScreeningComplianceView extends CompleteHRAAndScreeningComplianceView
{
    protected function getScreeningView()
    {
        return new Android2014CompleteScreeningView($this->startDate, $this->endDate);
    }
}

class Android2014Vegetables extends CompleteActivityComplianceView
{
...
class Android2014ComplyWithCotinineScreeningTestComplianceView extends ComplyWithCotinineScreeningTestComplianceView
{
...
class Android2014ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new Android2014ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $s = new Android2014CompleteHraAndScreeningComplianceView($programStart, $programEnd);
        ...
        $cotinineView = new Android2014ComplyWithCotinineScreeningTestComplianceView($programStart, $programEnd);
        ...
        //$walkingProgram = new Android2014WalkingProgram($programStart, $programEnd);
 ...
 */
class Android2014WeightProgram extends ComplianceView
{
...
class Android2014WalkingProgram extends DateBasedComplianceView
{
    public function __construct($startDate, $endDate)
    {
...
class Android2014ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
