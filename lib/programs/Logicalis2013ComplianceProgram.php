...
class Logicalis2013ComplianceProgram extends ComplianceProgram
{
  ...
  {
    return new Logicalis2013ComplianceProgramReportPrinter();
  }
}

class Logicalis2013ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
