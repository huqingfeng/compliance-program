    ...
    public function getStatus(User $user)
    {
        ...
        foreach($records as $record) {
            if($record->nicotine_program == 'Not Required') {
                ...
                if($isAttendEnrollment || $isAgreementSigned) {
...
class Shape2015ComplianceProgramAdminReportPrinter extends BasicComplianceProgramAdminReportPrinter
{
...
class Shape2015ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $printer = new Shape2015ComplianceProgramAdminReportPrinter();
