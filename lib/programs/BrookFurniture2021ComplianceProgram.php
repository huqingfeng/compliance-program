...
class BrookFurniture2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new BrookFurniture2021ComplianceProgramReportPrinter();
    }
...
class BrookFurniture2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            <p>
                ...
                will pay less for medical coverage during 2021.
            </p>
            ...
            <p>
                ...
                available for your 2021 medical premiums.
            </p>
            ...
            <?php if($core_points >= 4) : ?>
                ...
                <p>CONGRATULATIONS! You have earned the <strong>Healthy Wellness Discount for 2021</strong>. Based on your wellness screening results,
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p style="color:red">Complete Alternate Qualification Form & submit to HMI by November 20, 2020 or within 30 days of hire date:</p>

                    <p>
                        Team members that satisfy the designated ‘Alternate Process’ requirement
                        <a href="/resources/10580/2020_AQF_Brook Furniture.pdf">and submit the qualification form</a>
                        ...
                        Physician's signature</span>. If your completed form is not received by HMI on or before November 20, 2020 or within 30 days of hire date,
