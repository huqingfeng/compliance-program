<?php
class Culver2016ScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class Culver2016CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class CulverWorkshop2016 extends AttendCompanyWorkshopComplianceView
{
...
class Culver2016LifetimeActivityView extends CompleteActivityComplianceView
{
...
class Culver2016ComplianceProgram extends ComplianceProgram
{
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $programForRaffle1EvaluationStatus = $status->getComplianceProgram()->getEvaluateComplianceViewStatuses($status->getUser(), '2015-08-01', '2015-12-15');
        $pointsGroupPointsForRaffle1 = $programForRaffle1EvaluationStatus->getComplianceViewGroupStatus('points')->getPoints();

        $programForRaffle2EvaluationStatus = $status->getComplianceProgram()->getEvaluateComplianceViewStatuses($status->getUser(), '2015-08-01', '2016-03-01');
        $pointsGroupPointsForRaffle2 = $programForRaffle2EvaluationStatus->getComplianceViewGroupStatus('points')->getPoints();

        $programForRaffle3EvaluationStatus = $status->getComplianceProgram()->getEvaluateComplianceViewStatuses($status->getUser(), '2015-08-01', '2016-05-01');
        $pointsGroupPointsForRaffle3 = $programForRaffle3EvaluationStatus->getComplianceViewGroupStatus('points')->getPoints();

        $programForRaffleFlexEvaluationStatus = $status->getComplianceProgram()->getEvaluateComplianceViewStatuses($status->getUser(), '2015-08-01', '2016-07-31');
    ...
    public function loadGroups()
    {
        ...
        $coreGroupEnd = '2015-12-31';

        $notSpouse = function (User $user) {
            return $user->relationship_type != Relationship::SPOUSE;
        };

        $coreGroup = new ComplianceViewGroup('core', 'All Core Actions Required by '.'December 31, 2015');
        ...
        $requiredLessons = new CompleteRequiredELearningLessonsComplianceView($programStart, '2016-02-01');
        $requiredLessons->setReportName('Complete any 4 new required e-learning lessons <span style="color:red;">by 02/01/2016</span>');
...
//        $infoView->setEvaluateCallback($notSpouse);
        ...
        $preventiveExamsView = new Culver2016LifetimeActivityView(
        ...
        $fluVaccineView = new Culver2016LifetimeActivityView(
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new Culver2016ScreeningPrinter();
            ...
            $printer = new Culver2016ComplianceProgramReportPrinter();
        }
...
class Culver2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
...
//        $extraELearningFinancialStatus = $pointGroupStatus->getComplianceViewStatus('elearning_financial');
        ...
        <p></p>
        <p>Welcome to your summary page for the 2015-2016 Culver Academies Wellness Rewards.</p>
        ...
        <ol>
            ...
            <ul>
                <li>For Raffle 1 - Employees or spouses must earn 200 points by December 15, 2015.</li>
                <li>For Raffle 2 - Employees or spouses must earn 300 points by March 1, 2016</li>
                <li>For Raffle 3 - Employees or spouses must earn 400 points by May 1, 2016</li>
            </ul>
            <li>For the $200 flexible benefit credit, number 1 must be done, AND:</li>
            <ul>
                <li>Employees must earn at least 200 points through the options in the table below by July 31, 2016.</li>
            </ul>
        </ol>
        ...
        <ol style="list-style-type:upper-alpha;">
            <li>Premium contribution credit:   The applicable lower Wellness Rate for premium contributions saving
                you over $300-$2,800 this year depending on the benefits you elected.  If either 1 or 2 do not get
                done by the deadlines, your premium contribution doubles, costing you that much more.
            </li>
        ...
        <table class="phipTable" border="1">
            ...
            <?php if($status->getUser()->relationship_type != Relationship::SPOUSE) : ?>
                <tr>
                    <td><a href="/content/1094#1cReqeL">C. <?php echo $elearningStatus->getComplianceView()->getReportName() ?></a>
                    </td>
                    <td class="center">
            ...
            <tr>
                <td>
                    <a href="/content/1094#2aRaffle">A. <?php echo $raffle1Status->getComplianceView()->getReportName() ?></a>
                </td>
            ...
            <tr>
                <td>
                    <a href="/content/1094#2aRaffle">B. <?php echo $raffle2Status->getComplianceView()->getReportName() ?></a>
                </td>
            ...
            <tr>
                <td>
                    <a href="/content/1094#2aRaffle">C. <?php echo $raffle3Status->getComplianceView()->getReportName() ?></a>
                </td>
            ...
            <tr>
                <td>
                    <a href="/content/1094#2aRaffle">D. <?php echo $raffleFlexStatus->getComplianceView()->getReportName() ?></a>
                </td>
            ...
            <tr>
                <td><a href="/content/1094#3aKBHM">A. Have these screening results in the ideal zone:</a></td>
                <td colspan="3">
            ...
            <tr>
                <td><a href="/content/1094#3bMD">B. <?php echo $haveDoctorStatus->getComplianceView()
                            ->getReportName() ?></a></td>
            ...
            <tr>
                <td><a href="/content/1094#3cPCI">C. <?php echo $infoStatus->getComplianceView()
                            ->getReportName() ?></a></td>
            ...
            <tr>
                <td><a href="/content/1094#3dPS">D. <?php echo $preventiveScreeningsStatus->getComplianceView()
                            ->getReportName() ?></a></td>
            ...
            <tr>
                <td><a href="/content/1094#3eImm">E. <?php echo $fluVaccineStatus->getComplianceView()->getReportName() ?></a>
                </td>
            ...
            <tr>
                <td><a href="/content/1094#3fRPA">F. <?php echo $physicalActivityStatus->getComplianceView()
                            ->getReportName() ?></a></td>
            ...
            <tr>
                <td><a href="/content/1094#3gHC">G. <?php echo $workWithHealthCoachStatus->getComplianceView()
                            ->getReportName() ?></a></td>
            ...
            <tr>
                <td><a href="/content/1094#3hProg">H. <?php echo $workshopStatus->getComplianceView()->getReportName() ?></a>
                </td>
            ...
            <tr>
                <td><a href="/content/1094#3ieLearn">I. <?php echo $extraELearningStatus->getComplianceView()
                            ->getReportName() ?></a></td>
