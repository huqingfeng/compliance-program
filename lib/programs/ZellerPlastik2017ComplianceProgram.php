...
class ZellerPlastik2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new ZellerPlastik2017ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '11/01/18');
        ...
        $hraView->setAttribute('goal', '11/01/18');
...
class ZellerPlastik2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right;">
                    <img src="/images/empower/zeller.gif" style="height:50px;" /><br />
                </div>
            </p>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="images/empower/pdfs/Zeller Plastik_AQF_092117.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN November 1, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
