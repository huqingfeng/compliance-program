...
class CHW2016SepCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW2016SepMansfieldChapComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $quizLawsView = new CHW2016SepCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365));
        ...
        $quizVitalView = new CHW2016SepCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
    ...
    {
        $printer = new CHW2016SepComplianceProgramReportPrinter();
...
class CHW2016SepComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
