...
class GVT2016ComplianceProgram extends ComplianceProgram
{
...
//            $data['Has Biometric Override'] = $status->getAttribute('has_biometric_override') ? 'Yes' : 'No';
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2', true)) {
            return new GVT2016WMS2Printer();
        } else {
            $printer = new GVT2016Printer();
    ...
    public function loadGroups()
    {
        ...
        $spouseParticipation->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if(!$spouseUser)  {
                ...
                $program = ComplianceProgramRecordTable::getInstance()->find(GVT2016ComplianceProgram::GVT_EMPLOYEE_2016_RECORD_ID)->getComplianceProgram();
    ...
    const GVT_EMPLOYEE_2016_RECORD_ID = 743;
}

class GVT2016Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
    ...
    public function printClientMessage()
    {
        ...
        <p>*If you have a medical reason for not being able to reach one or more of the requirements, you can contact
            Christina Myers in Human Resources to discuss a reasonable alternative.
        </p>
...
class GVT2016WMS2Printer implements ComplianceProgramReportPrinter
{
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="more-info">
                    <div class="row">
                        <div class="col-md-6">
                            <p><a href="https://static.hpn.com/wms2/documents/clients/gti/BiMonthly GTI 2017 Medical Rates Copy.pdf">Medical Rate Details</a></p>
