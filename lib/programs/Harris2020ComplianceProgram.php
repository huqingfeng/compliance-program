...
class Harris2020CompleteScreeningView extends CompleteScreeningComplianceView
{
...
class Harris2020HomePageComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $screeningFormView->addLink(new Link('Download Form', '/resources/10552/Harris_2020_PCP_Form_032420.pdf', false, '_blank'));
        ...
        $screeningFormView->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use($screeningFormView) {
            ...
            if($activeProgramRecord->id == 1499) {
        ...
        $healthLinc2020View->setName('healthLinc_2021');
        $healthLinc2020View->setReportName('Track Harris 2021 Wellness Program Status');
        $healthLinc2020View->addLink(new Link('View Status', '/compliance_programs?id=1499'));
        $healthLinc2020View->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            $activeProgramRecord = ComplianceProgramRecordTable::getInstance()->find(1499);
...
class Harris2020ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $screeningView = new Harris2020CompleteScreeningView($programStart, $programEnd);
        ...
        $screeningView->addLink(new Link('<br />Download Form', '/resources/10552/Harris_2020_PCP_Form_032420.pdf'));
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new Harris2020ComplianceProgramReportPrinter();
...
class Harris2020ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="pageHeading">2021 Workplace Wellness Program</div>

        <p><strong>Hello <?php echo $status->getUser()->getFullName(); ?>,</strong></p>

        <P>

            Welcome to your summary page for Harris Workplace Health Promotion Program. This program is designed to promote health awareness,
