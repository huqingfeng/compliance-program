...
class VillageOfSchaumburg2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new VillageOfSchaumburg2021ComplianceProgramReportPrinter();
    }
...
class VillageOfSchaumburg2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="1" style="text-align: left; width: 430px;">1. Get Started - Get these done by November 12, 2021 <br /><span style="margin-left: 15px;">*New Hires - 90 days from date of hire</span></th>
                    ...
                    <tr class="headerRow">
                        <th colspan="1" style="text-align: left; width: 430px;">2. Earn 80 or more points from A&B below by November 12, 2021 <br /><span style="margin-left: 15px;">*New Hires - 90 days from date of hire</span></th>
                    ...
                    <tr class="rewards status-<?php echo $status->getStatus() ?>">
                        <td colspan="2" style="text-align: left; ">
                            ...
                            <div style="display: block; width: 96%; float:right;">
                                ...
                                <ul>
                                    <li>If hired before 10/15/2021, complete coaching sessions by January 15, 2022; or</li>
                                    <li>If hired on or after 10/15/2021, complete coaching sessions within 90 days of when your wellness screening was done.</li>
                                </ul>
                            </div>
