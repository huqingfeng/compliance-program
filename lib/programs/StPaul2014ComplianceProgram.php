...
class StPaul2014CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class StPaul2014ComplianceProgram extends ComplianceProgram
{
    ...
    const OLD_HIRE_DISPLAY_DATE = '2014-06-30';
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new StPaul2014ScreeningTestPrinter();
            ...
            $printer = new StPaul2014ComplianceProgramReportPrinter();
        }
    ...
    public function loadGroups()
    {
        ...
        $scrView = new StPaul2014CompleteScreeningComplianceView(self::SCREENING_START_DATE, $coreEndDate);
        ...
        $scrView->emptyLinks();
        $scrView->addLink(new Link('Schedule/Options', '/content/1051'));
        ...
        $updateView->setAttribute('report_name_link_new_hire', '/content/1094nh#persContact1c');
        $core->addComplianceView($updateView);


        $reqLessons = new CompleteELearningGroupSet($startDate, $coreEndDate, 'required_stpaul');
        ...
        $reqLessons->setAttribute('report_name_link_new_hire', '/content/1094nh#eLearn1e');
        ...
        $numbers = new ComplianceViewGroup('numbers', 'And, earn 100 or more points from options below by '.date('m/d/Y', $endDate));
        ...
        $prev = new CompleteArbitraryActivityComplianceView('2013-07-01', '2014-06-30', 26, 10);
        ...
        $imm = new CompleteArbitraryActivityComplianceView('2013-07-01', '2014-06-30', 242, 10);
        ...
        $additionalLearn = new CompleteAdditionalELearningLessonsComplianceView($startDate, $endDate, 5);
        ...
        $eap->setReportName('Attend EAP or St. Paul Wellness class');
        $eap->addLink(new Link('See Topic Details', '/content/stPaul_classCal'));
        $eap->setAttribute('report_name_link', '/content/1094#class2h');
        $numbers->addComplianceView($eap);

        $nav = new AFSCMEViewWorkbookComplianceView($startDate, $endDate);
        ...
        $nav->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if($user->insurancetype == StPaul2014ComplianceProgram::PPO_TYPE) {
...
class StPaul2014ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function __construct()
    {
        ...
        $this->pageHeading = 'St. Paul 2014-2015 Employee Wellness Benefit';
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <style type="text/css">
            ...
            <?php if($status->getUser()->insurancetype != StPaul2014ComplianceProgram::PPO_TYPE) :  ?>
                .view-nav {
                    display:none;
                }
            <?php endif ?>
        ...
        <?php if($isNewHire) : ?>
            ...
            <p>Welcome to your summary page for the St. Paul 2014-2015 Well Rewards
            ...
            <p>Employees meeting all of the below requirements who enrolled in
                2014-2015 St. Paul Medical Insurance Plan will receive the following
            ...
            <ul style="margin-left:150px;">
                ...
                <li>Monthly: $22.73 per-pay-period reduction</li>
            </ul>

            <p>Employees meeting the criteria that have elected not to enroll
                in a St. Paul Medical Plan, or are ineligible for benefits, will
                receive ___________</p>

            <p style="text-align:center;"><a href="/content/1094nh">Click here for more details about the Well Rewards Program.</a></p>

        <?php else : ?>

            <p>Hello <?php echo $escaper->escapeHtml($status->getUser()->getFullName()) ?>.</p>

            <p>Welcome to your summary page for the St. Paul 2014-2015 Well Rewards benefit.
            ...
            <p>Employees meeting all of the requirements below who enrolled in a
                2014-2015 St. Paul Medical Insurance Plan will receive a per-pay-period
                credit on their health insurance premium (up to $___ annually).
                Employees meeting the criteria that have elected not to enroll in
                a 2014 medical plan, or are ineligible for benefits, will receive _________</p>
...
class StPaul2014ScreeningTestPrinter extends ScreeningProgramReportPrinter
{
