...
class TataSteel2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TataSteel2020ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '11/27/20');
        ...
        $hraView->setAttribute('goal', '11/27/20');
...
class TataSteel2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10593/2020_Tata Steel_AQF_092920.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 11, 2020</strong>
                            </td>
                         <?php endif ?>
                    </tr>
