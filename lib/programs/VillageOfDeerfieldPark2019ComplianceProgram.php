...
class VillageOfDeerfieldPark2019WalkingComplianceView extends CompleteActivityComplianceView
{
...
class VillageOfDeerfieldPark2019TobaccoComplianceView extends ComplianceView
{
...
class VillageOfDeerfieldPark2019VacationTimeComplianceView extends ComplianceView
{
    public function __construct($startDate, $endDate)
    {
        $this->start_date = $startDate;
...
class VillageOfDeerfieldPark2019BiometricComplianceView extends ComplianceView
{
    public function __construct($startDate, $endDate)
    {
        $this->start_date = $startDate;
...
class VillageOfDeerfieldPark2019ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>Welcome to your summary page for the second year of the Wellness Rewards incentive program. Use this page to
        ...
        <p>Earn $1.00 for each point that you log. There is no minimum required. Earn up to $300.00 throughout the year
            (Nov 11, 2019 - October 31, 2020). Plus, earn 100 bonus dollars by participating in the 2020 Wellness
            Screening event that will take place in early October of next year. Log points by October 31, 2020 for your
            reward in 2020.</p>
...
class VillageOfDeerfieldPark2019ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new VillageOfDeerfieldPark2019ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2019-11-11', '2020-10-31'), array(), 525);
        $totalView->setReportName('<strong>By 10/31/2020</strong>');
    ...
    public function loadGroups()
    {
        ...
        $cert = new CompleteArbitraryActivityComplianceView('2018-10-01', $endDate, 341, 15);
        $cert->setName('cert');
        ...
        $nonSmokerView = new VillageOfDeerfieldPark2019TobaccoComplianceView($startDate, $endDate);
        ...
        $vacationTime = new VillageOfDeerfieldPark2019VacationTimeComplianceView($startDate, $endDate);
        ...
        $improveBiometric = new VillageOfDeerfieldPark2019BiometricComplianceView($startDate, $endDate);
