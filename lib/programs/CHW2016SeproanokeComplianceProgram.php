...
class CHW2016SeproanokeCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW2016SeproanokeComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $chwOneView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(300, 0, 0, 0));
        $chwOneView->setName('chw_01');
        $chwOneView->setAttribute('points_required', 225);
        ...
        $healthCare->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(320, 0, 0, 0));
        $healthCare->setAttribute('points_required', 240);
        ...
        $chwPracticum->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(330, 0, 0, 0));
        ...
        $courseCHWGroup = new ComplianceViewGroup('course_chw', 'Module 1 - Community Health Worker 1');

        $week1View = new PlaceHolderComplianceView(ComplianceStatus::NOT_COMPLIANT);
        $week1View->setReportName('Week 1 M-F - June 6-10');
        ...
        $week2View->setReportName('Week 2 MTWR - August 15-18');
        ...
        $week3View->setReportName('Week 3 Not Applicable');
        ...
        $quizLawsView = new CHW2016SeproanokeCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365));
        ...
        $quizVitalView = new CHW2016SeproanokeCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
        ...
        $vitalSignView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(10, 0, 0, 0));
        ...
        $activityOneView->setReportName('Activity 1 - Healthy Me');
        ...
        $chapterThreeView->addLink(new Link('Details & Do', '/resources/7118/Module%201%20Book%20Bridges%20Out%20of%20Poverty%20Study%20Guide%20Qs%20021016.doc'));
        ...
        $courseHealthCareGroup = new ComplianceViewGroup('course_health_care', 'Module 2 - Health Care Across the Lifespan');
        ...
        $questionChapterFiveView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(15, 0, 0, 0));
        ...
        $midtermView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(50, 0, 0, 0));
        ...
        $finalExamView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(50, 0, 0, 0));
        $finalExamView->setName('final_exam');
        $finalExamView->addLink(new Link('Details & Do', '/content/finalExam'));
        ...
        $investigationView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(50, 0, 0, 0));
        ...
        $reportOneView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(20, 0, 0, 0));
        ...
        $reportFiveView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(25, 0, 0, 0));
    ...
    {
        $printer = new CHW2016SeproanokeComplianceProgramReportPrinter();
...
class CHW2016SeproanokeComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function(){
                ...
                $('.view-report_one .links').html('<a target="_self" href="/resources/7133/Module%203%20REPORTS%20Practicum%20Rev%20021616.pdf">Document</a>');
                $('.view-report_one .links').attr('rowspan', '5');
        ...
        <div id="altPageHeading">Community Health Workers 2016 Program</div>
