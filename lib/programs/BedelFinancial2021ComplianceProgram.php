...
class BedelFinancialWMS3StepsComplianceView extends DateBasedComplianceView
{
    ...
    public function getStatus(User $user)
    {
        ...
        $fitnessTrackingQuery =
            "SELECT ftd.activity_date, ftd.value FROM wms3.fitnessTracking_data ftd
              ...
              WHERE ftp.wms1Id = ".$user->id."
              AND ftd.type = 1
              AND ftd.device_id != 5
              AND ftd.activity_date >= '".$startDate."'
...
class BedelFinancial2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new BedelFinancial2021WMS2ComplianceProgramPrinter();
    }
...
//        $bloodPressureView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≥ 140/≥ 90');
        $this->configureViewForElearningAlternative($bloodPressureView, 'blood_pressure_2021');
...
//        $triglView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≥ 200');
        $this->configureViewForElearningAlternative($triglView, 'triglycerides_2021');
...
//        $glucoseView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≤ 49 or ≥ 126');
        $this->configureViewForElearningAlternative($glucoseView, 'glucose_2021');
...
//        $totalHDLRatioView->setStatusSummary(ComplianceStatus::NOT_COMPLIANT, '≥ 7');
        $this->configureViewForElearningAlternative($totalHDLRatioView, 'hdl_2021');
        ...
        $this->configureViewForElearningAlternative($bodyFatView, 'waist_2021');
        ...
        $beingVideo->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            ->andWhere('tbk.completion_date BETWEEN ? AND ?', array('2021-01-01', '2021-06-30'))
            ->hydrateSingleRow()
            ->execute();
...
class BedelFinancial2021WMS2ComplianceProgramPrinter implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
                ...
                <div class="row">
                        ...
                        <div class="row">
                        	<div class="circle-range">
				                <div class="circle-range-inner circle-range-inner-danger">
				                    <div style="font-size: 1.3em; line-height: 1.0em;"><span class="circle-points quarter-1"><?php echo time() >= strtotime('2021-07-01') ? '' : $totalPoints; ?></span><br/><br/>1/1/2021 - 6/30/2021</div>
				                </div>
				            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                    		<div class="circle-range">
				                <div class="circle-range-inner circle-range-inner-danger">
				                    <div style="font-size: 1.3em; line-height: 1.0em;"><span class="circle-points quarter-2"><?php echo time() >= strtotime('2021-07-01') ? '' : 0; ?></span><br/><br/>7/1/2021 - 12/31/2021</div>
				                </div>
				            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="more-info" style="display: none">
                    ...
                    <p>
                        You will have the opportunity to earn incentive points towards the wellness program 1/1-6/30/2021
                        AND 7/1-12/31/2021. You are not required to meet the target range for every measure. The criteria
                    ...
                    <p>
                        PTO days will be rewarded on 7/1/2021 for the 1/1-6/30/2021 program period and 1/3/2022 for
                        the 7/1-12/31/2021 program period.
                    </p>
        ...
        <script type="text/javascript">
            $(function() {
            	<?php if(time() >= strtotime('2021-07-01')): ?>
        		$.ajax({
            		url: '/compliance/bedelfinancial-2021/covid19/compliance_programs?id=1583&points_only=true',
