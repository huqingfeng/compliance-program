...
class Canfor2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Canfor2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/30/17');
        ...
        $hraView->setAttribute('goal', '11/30/17');
        ...
        $bmiElearningView->setReportName('2. <a href="/content/9420?action=lessonManager&tab_alias=body_fat" target="_blank">Click here to complete 6  e-learning lessons (*maximum of 2 per week)</a> related to BMI.');
        $bmiElearningView->setNumberRequired(6);
        ...
        $bmiCoachingView->setReportName('3. Complete 4 telephonic health coaching sessions for BMI. <a href="/resources/9734/Canfor Alternate Standard BMI_09-05-18.pdf">Click here for details.</a>');
        ...
        $tobaccoView->setReportName('1. Complete the Tobacco Affidavit <a href="/resources/9735/Canfor Tobacco Use Affidavit_080917.pdf">Click here for details.</a>');
        ...
        $tobaccoElearningView->setReportName('2. <a href="/content/9420?action=lessonManager&tab_alias=tobacco" target="_blank">Click here to complete 6  e-learning lessons (*maximum of 2 per week)</a> related to Tobacco..');
        $tobaccoElearningView->setNumberRequired(6);
        ...
        $tobaccoCoachingView->setReportName('3. Complete 4 telephonic health coaching sessions for tobacco. <a href="/resources/9736/Canfor Alternate Standard Tobacco_09-05-2017.pdf">Click here for details.</a>');
...
class Canfor2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width:60%">
                    <h5>2018 Incentive Rewards & To-Dos</h5>
                </div>
            </p>
            ...
            <div style="clear: both">
                ...
                <div style="float: right; width: 50%;">
                    <div style="border:1px solid #000000; width: 48%; float:left;">
                        <div style="margin: 10%;">
                            <strong>REMINDER</strong> - <span style="font-size: 9pt;">Option B2 and C2 require completing 2 lessons* each week until 6 lessons are completed over
