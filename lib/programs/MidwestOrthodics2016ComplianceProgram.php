...
class MidwestOrthodics2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new MidwestOrthodics2016ComplianceProgramReportPrinter;
    }
...
class MidwestOrthodics2016ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
    ...
    <p><strong>Step 2</strong>- Complete your Health Risk Assessment (HRA) Questionnaire.<a href="/content/1006">Click here </a>  to complete your HRA if you have not done so already. Your current status for each are summarized below.</span></p>
