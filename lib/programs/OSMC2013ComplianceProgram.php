...
class OSMC2013ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new OSMC2013ComplianceProgramReportPrinter;
    }
...
class OSMC2013ComplianceProgramReportPrinter extends CHPComplianceProgramReportPrinter
{
    ...
    <p><strong>Step 2</strong>- Complete your Health Risk Assessment (HRA) Questionnaire by November 27, 2013. <a href="/content/1006">Click here </a> to complete your HRA if you have not done so already. Your current status for each are summarized below.</span></p>
