...
class ICar2020ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new ICar2020ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $phyExam->emptyLinks();
        $phyExam->addLink(new Link('Verification form', '/resources/10506/ICAR_2020_PreventiveCare.pdf'));
        ...
        $prevServ->addLink(new Link('Verification form', '/resources/10506/ICAR_2020_PreventiveCare.pdf'));
        ...
        $bluebook = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66400, 5);
        ...
        $smoking->addLink(new Link('Verification Form', '/resources/10507/ICAR_2020_WellnessEventCert.pdf'));
        ...
        $healthDocumentary = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66401, 5);
        ...
        $healthBook = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66402, 10);
        ...
        $fiveK = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66403, 10);
        ...
        $tenK = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66404, 15);
        ...
        $halfMar = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66405, 20);
        ...
        $fullMar = new CompleteArbitraryActivityComplianceView($startDate, $endDate, 66406, 30);
...
class ICar2020ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
//                $('.view-lnl_presentation').children('td:eq(0)').remove();
                ...
                $('.view-10_weeks_steps').children('td:eq(0)').html('<strong>A</strong>. Wellness Walking Challenge' +
                    '<br /><br /><span style="font-size:8pt;">Challenge: 6/1/20 - 8/28/20</span>');
                ...
                $('.view-national_bike_challenge').children('td:eq(0)').html('<strong>B</strong>. National Bike Challenge' +
                    '<br /><span style="font-size:8pt;">Challenge: May 2020 - September 2020</span>' +
...
//                $('.view-full_mar').children('td:eq(4)').remove();
        ...
        <p><strong>All Employees that complete the Wellness Screening and Health Assessment Questionnaire are
            ...
            health activities between <strong>1/1/20 - 11/30/20</strong>.</p>
