...
class CityOfMcKinney2022ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if(sfConfig::get('app_wms2')) {
            return new CityOfMcKinney2022WMS2Printer();
        } else {
            return new CityOfMcKinney2022WMS2Printer();
        }
    }
...
//        $biometricGroup->setPointsRequiredForCompliance(0);
        ...
        $preventative->setReportName('Preventative Care Exam - must be completed between <br /> &nbsp;&nbsp; 12/1/2021 and 11/30/2022.');
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        if(!CityOfMcKinney2022ComplianceProgram::isOptionTwo($user)) {
            $numCompliant = 0;
            $coreCompliant = false;
...
class CityOfMcKinney2022WMS2Printer implements ComplianceProgramReportPrinter
{
    private function getHeader(ComplianceProgramStatus $status)
    {
        ?>

        <?php if(!CityOfMcKinney2022ComplianceProgram::isOptionTwo($status->getUser())) : ?>
        <div class="row">
            <div class="col-md-12">
                <div>
                    <p>Participants can earn up to $600 Wellness Dollars for completing the three activities/goals below by
                        <strong>December 1, 2022</strong>. Wellness Dollars earned in 2022 will be paid out in a lump-sum payment in January
                        of 2023.</p>
            ...
            <div class="col-md-12">
                <div>
                    <p>Participants electing this option will receive a monthly, employee-only membership to the new McKinney
                        ...
                        Screen by <strong>December 1, 2022</strong>. The $100 lump-sum payout would occur in January of 2023. Memberships will be
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        $isOptionTwo = CityOfMcKinney2022ComplianceProgram::isOptionTwo($status->getUser());
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="/compliance/mckinney-2021-interface/my-incentives/compliance_programs?id=1574">View Previous Year's Report Card</a>
            </div>
        </div>
