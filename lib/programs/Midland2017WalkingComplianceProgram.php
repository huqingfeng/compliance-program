...
class Midland2017RangeStepsComplianceView extends DateBasedComplianceView
{
...
class Midland2017WalkingComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $quarterOneStart = '2017-01-01';
        $quarterOneEnd = '2017-03-31';

        $quarterOne6K = new Midland2017RangeStepsComplianceView($quarterOneStart, $quarterOneEnd, 6000, 8000, 1);
        ...
        $quarterOne8K = new Midland2017RangeStepsComplianceView($quarterOneStart, $quarterOneEnd, 8000, 10000, 2);
        ...
        $quarterOne10K = new Midland2017RangeStepsComplianceView($quarterOneStart, $quarterOneEnd, 10000, null, 3);
        ...
        $quarterTwoStart = '2017-04-01';
        $quarterTwoEnd = '2017-06-30';

        $quarterTwo6K = new Midland2017RangeStepsComplianceView($quarterTwoStart, $quarterTwoEnd, 6000, 8000, 1);
        ...
        $quarterTwo8K = new Midland2017RangeStepsComplianceView($quarterTwoStart, $quarterTwoEnd, 8000, 10000, 2);
        ...
        $quarterTwo10K = new Midland2017RangeStepsComplianceView($quarterTwoStart, $quarterTwoEnd, 10000, null, 3);
        ...
        $quarterThreeStart = '2017-07-01';
        $quarterThreeEnd = '2017-09-30';

        $quarterThree6K = new Midland2017RangeStepsComplianceView($quarterThreeStart, $quarterThreeEnd, 6000, 8000, 1);
        ...
        $quarterThree8K = new Midland2017RangeStepsComplianceView($quarterThreeStart, $quarterThreeEnd, 8000, 10000, 2);
        ...
        $quarterThree10K = new Midland2017RangeStepsComplianceView($quarterThreeStart, $quarterThreeEnd, 10000, null, 3);
        ...
        $quarterFourStart = '2017-10-01';
        $quarterFourEnd = '2017-12-31';

        $quarterFour6K = new Midland2017RangeStepsComplianceView($quarterFourStart, $quarterFourEnd, 6000, 8000, 1);
        ...
        $quarterFour8K = new Midland2017RangeStepsComplianceView($quarterFourStart, $quarterFourEnd, 8000, 10000, 2);
        ...
        $quarterFour10K = new Midland2017RangeStepsComplianceView($quarterFourStart, $quarterFourEnd, 10000, null, 3);
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        $printer = new Midland2017WalkingComplianceProgramReportPrinter();
...
class Midland2017WalkingComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <table class="phipTable">
            <tbody>
            <tr><th colspan="6" class="headerRow">2017 Midland Step Challenge</th></tr>
            ...
            <tr>
                <td rowspan="3">
                    ...
                    &nbsp;<strong>Quarter 1: 01/01/2017 - 03/31/2017</strong>
                </td>
            ...
            <tr>
                <td rowspan="3">
                    &nbsp;Individual Walking Program <br /><br />
                    &nbsp;<strong>Quarter 2: 04/01/2017 - 06/30/2017</strong>
                </td>
                <td class="requirement">Walk an average of 6,000 steps/day </td>
            ...
            <tr>
                <td rowspan="3">
                    &nbsp;Individual Walking Program <br /><br />
                    &nbsp;<strong>Quarter 3: 07/01/2017 - 09/30/2017</strong>
                </td>
                <td class="requirement">Walk an average of 6,000 steps/day </td>
            ...
            <tr>
                <td rowspan="3">
                    &nbsp;Individual Walking Program <br /><br />
                    &nbsp;<strong>Quarter 4: 10/01/2017 - 12/31/2017</strong>
                </td>
                <td class="requirement">Walk an average of 6,000 steps/day </td>
            ...
            <tr>
                <td colspan="6" style="text-align: center; font-size: 10pt;">
                    ...
                    Q1: Earn at least 75 pts between January 1 - March 31, 2017<br />
                    Q2: Earn at least 125 pts between April 1 - June 30, 2017<br />
                    Q3: Earn at least 175 pts between July 1 - September 30, 2017<br />
                    Q4: Earn at least 200 pts between October 1 - December 31, 2017<br /><br />
