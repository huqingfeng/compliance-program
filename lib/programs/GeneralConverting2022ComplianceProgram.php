...
class GeneralConverting2022ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new GeneralConverting2022ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $this->configViewForPreEvaluate($trigView);
        ...
        $this->configViewForPreEvaluate($gluView);
        ...
        $this->configViewForPreEvaluate($cotinineView);
    ...
    public function configViewForPreEvaluate(ComplianceView $view) {
        $view->setPreMapCallback(function(ComplianceViewStatus $status){
            $result = $status->getAttribute('real_result') ? $status->getAttribute('real_result') : $status->getComment();

            $noncompliantValues = array('qns', 'tnp', 'test not taken', 'declined');

            if(in_array(strtolower($result), $noncompliantValues)) {
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        if($cotinine->getStatus() != ComplianceStatus::COMPLIANT) {
            if($elearningTobacco->getStatus() == ComplianceStatus::COMPLIANT) {
                $cotinine->setStatus(ComplianceStatus::COMPLIANT);
                $cotinine->setPoints(100);
            }
        }
...
class GeneralConverting2022ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <div style="clear: both">
                <div style="width: 100%; margin-top: 10px; display: block">
                    ...
                    <ol type="A">
                        <li><strong>Health Action Reward:</strong> Earn 1,000 points out of the 1,900 possible points by 8/12/22. <strong>Discount = $100/month</strong>.</li>
                        <li><strong>Tobacco Free Reward:</strong> Test negative or complete 5 online tobacco cessation lessons by 8/12/22. <strong>Discount = $100/month</strong>.</li>
                    </ol>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th style="text-align: left; width: 320px;" colspan="2">A. Earn 1,000 or more points by 8/12/22 in any of the ways below:</th>
                    ...
                    <tr>
                        <td style="text-align: left; width: 320px;" colspan="3">
                            ...
                            <em style="color: red;">*  #9 and #10 can be done anytime from 1/1/2022 to 8/12/22 for points – just use the related
                    ...
                    <tr>
                        ...
                        <td>100</td>
                        <td><?= $cotinine->getPoints()?></td>
                        <td><?= ($cotinine->getPoints() >= 100) ? "Goal Met!" : "Not Met Yet"?></td>
                    </tr>
                </tbody>
            </table>
        </p>
