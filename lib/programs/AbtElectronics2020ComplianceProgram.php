...
class AbtElectronics2020ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreGroup = new ComplianceViewGroup('core', 'Get Started - Get these done by January 15, 2021');
        ...
        $pointGroup = new ComplianceViewGroup('points', 'Earn 35 or more points from A&B below by January 15, 2021');
    ...
    {
        $printer = new AbtElectronics2020ComplianceProgramReportPrinter();
...
class AbtElectronics2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <table class="phipTable" border="1">
            ...
            <tr>
                <td colspan="2">
                    ...
                    Form (AQF) by February 14, 2021. Download and print the form which has places for both of you to
                ...
                <td class="center"><a href="/resources/10607/ABT_AQF_101220.pdf" download>If needed, click here to download the AQF pdf</a></td>
            </tr>
