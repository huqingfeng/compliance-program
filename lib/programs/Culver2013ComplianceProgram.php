<?php
class Culver2013ScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class Culver2013CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class CulverWorkshop2013 extends AttendCompanyWorkshopComplianceView
{
...
class Culver2013LifetimeActivityView extends CompleteActivityComplianceView
{
...
class Culver2013ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $coreGroupEnd = '2012-12-31';

        $notSpouse = function (User $user) {
            return $user->relationship_type != Relationship::SPOUSE;
        };

        $coreGroup = new ComplianceViewGroup('core', 'All Core Actions Required by '.'December 31, 2012');
...
//
        ...
        $preventiveExamsView = new Culver2013LifetimeActivityView(
        ...
        $fluVaccineView = new Culver2013LifetimeActivityView(
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new Culver2013ScreeningPrinter();
            ...
            $printer = new Culver2013ComplianceProgramReportPrinter();
        }
...
class Culver2013ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
    ...
    <p></p>
    <p>Welcome to your summary page for the 2012-2013 Culver Academies Wellness Rewards.</p>
    ...
    <ol>
        ...
        <ol style="list-style-type:lower-alpha;">
            <li>Complete ALL core actions listed in table below by December 31, 2012: AND</li>
            <li>Earn at least 200 points through the options in the table below by July 31, 2013.
        </ol>
        <li>Spouses must complete the Health Power Assessment (1A) and Wellness Screening (1B) by December 31, 2012</li>
    </ol>
