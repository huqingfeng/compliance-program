...
class MattersightCorporation2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new MattersightCorporation2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $hraScreeningEndDate = '2018-10-12';
        ...
        $screeningView->setAttribute('goal', '10/12/18');
        ...
        $hraView->setAttribute('goal', '10/12/18');
...
class MattersightCorporation2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10135/Mattersight_AQF_080618.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN October 26, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
