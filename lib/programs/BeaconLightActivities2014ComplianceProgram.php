...
class BeaconActivities2014DailyLogComplianceView extends CompleteActivityComplianceView
{
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints)
    {
        ...
        parent::__construct('2014-07-01', '2015-09-30');
...
class BeaconLightActivities2014ScreeningConfirmationComplianceView extends ComplianceView
{
...
class BeaconLightActivities2014ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2014DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2014ComplianceProgram::LIGHT_SPECTRUM_2014_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2014ComplianceProgram::LIGHT_ACTIVITIES_2014_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2014ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2014ScreeningConfirmationComplianceView($startDate, $endDate);
        ...
        $fitness->addComplianceView($this->getSummableActivityView('strength', 133, 1, 7, 30, 'Strength Training'));
        ...
        $fitness->setAttribute('available_points', 90);
    ...
    const LIGHT_ACTIVITIES_2014_RECORD_ID = 365;
    const LIGHT_SPECTRUM_2014_RECORD_ID = 335;
}



class BeaconLightActivities2014ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
    public function printReport(\ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.phipTable tbody').children(':eq(44)').find('.progress').show();
                $('.phipTable tbody').children(':eq(51)').find('.progress').show();
                $('.phipTable tbody').children(':eq(52)').find('.progress').show();
