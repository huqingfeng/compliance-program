...
class GVTSpouse2017ComplianceProgram extends ComplianceProgram
{
...
//            $data['Has Biometric Override'] = $status->getAttribute('has_biometric_override') ? 'Yes' : 'No';
    ...
    {
        return new GVTSpouse2017WMS2Printer();
    }
...
//
//            if($user->getRelationshipType() != Relationship::SPOUSE || !$employeeUser)  {
//                $status->setStatus(ComplianceStatus::NA_COMPLIANT);
//            } else {
//                $program = ComplianceProgramRecordTable::getInstance()->find(GVTSpouse2017ComplianceProgram::GVT_SPOUSE_2016_RECORD_ID)->getComplianceProgram();
...
//        $preventionEventGroup->addComplianceView($employeeParticipation, true);
    ...
    const GVT_SPOUSE_2016_RECORD_ID = 1132;
}


class GVTSpouse2017WMS2Printer implements ComplianceProgramReportPrinter
{
