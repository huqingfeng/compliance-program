...
class BeaconActivities2016Q4DailyLogComplianceView extends CompleteActivityComplianceView
{
...
class BeaconLightActivities2016Q4ScreeningConfirmationComplianceView extends ComplianceView
{
    ...
    public function getStatus(User $user)
    {
        $startDate = sfConfig::get('app_legacy_beacon_physician_review_report_start_date', '2015-12-31');
...
class BeaconLightActivities2016Q4ComplianceProgram extends ComplianceProgram
{
    ...
    {
        $view = new BeaconActivities2016Q4DailyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints);
    ...
    public function getAdminProgramReportPrinter()
    {
        ...
        $spectrumProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q4ComplianceProgram::LIGHT_SPECTRUM_2015_RECORD_ID)->getComplianceProgram();

        $activitiesProgram = ComplianceProgramRecordTable::getInstance()->find(BeaconLightActivities2016Q4ComplianceProgram::LIGHT_ACTIVITIES_2016_Q4_RECORD_ID)->getComplianceProgram();
    ...
    {
        $printer = new BeaconLightActivities2016Q4ComplianceProgramPrinter();
    ...
    public function loadGroups()
    {
        ...
        $confirmationView = new BeaconLightActivities2016Q4ScreeningConfirmationComplianceView($startDate, $endDate);
    ...
    const LIGHT_ACTIVITIES_2016_Q4_RECORD_ID = 810;
    const LIGHT_SPECTRUM_2015_RECORD_ID = 533;
}



class BeaconLightActivities2016Q4ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
