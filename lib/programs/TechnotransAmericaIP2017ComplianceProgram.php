...
class TechnotransAmericaIP2017LearningAlternativeComplianceView extends ComplianceView
{
...
class TechnotransAmericaIP2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TechnotransAmericaIP2017ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/08/17');
        ...
        $hraView->setAttribute('goal', '11/08/17');
...
class TechnotransAmericaIP2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/9759/Technotrans America_AQF_090517.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 6, 2017</strong>
                            </td>
                         <?php endif ?>
                    </tr>
