...
class ActiveLearningAlternativeComplianceView extends ComplianceView
{
...
class Active2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Active2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '10/09/18');
        ...
        $hraView->setAttribute('goal', '10/09/18');
        ...
        $cotinineView->setReportName('2. Cotinine (Tobacco)');
        ...
        $hdlRatioView->overrideTestRowData(null, null, 4.9, null, 'M');
        $hdlRatioView->overrideTestRowData(null, null, 4.9, null, 'F');
...
class Active2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right;">
                    <img src="/images/empower/active_logo.jpg" style="height:36px;"  />
                </div>
            </p>
            ...
            <p>Active is committed to encourage and help support the health, care and wellbeing
            ...
            <p>Earning the incentive this year requires completing a wellness screening and getting certain results
                ...
                When you meet the required goals for the incentive, your name will be on a list that is sent to Active
                for everyone earning the incentive.  Note about privacy:  As always, individual screening results are
                not shared with employers and remain confidential.</p>
        ...
        <div class="letter">
            <img src="https://static.hpn.com/resources/10138/Active_2018_UHC_Weekly_Insurance_Contributions_080618.png" />
        </div>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="https://static.hpn.com/resources/10137/Active_AQF_080318.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN November 8, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
