...
class CollegeParkChurch2016ComplianceProgram extends ComplianceProgram
{
  ...
  {
    return new CollegeParkChurch2016ComplianceProgramReportPrinter();
  }
}

class CollegeParkChurch2016ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
  ...
  <p> <a href="<?php echo url_for('/compliance_programs/?id=251') ?>">View 2013 Report Card</a></p>
  <p> <a href="<?php echo url_for('/compliance_programs/?id=345') ?>">View 2014 Report Card</a></p>
      <p> <a href="<?php echo url_for('/compliance_programs/?id=453') ?>">View 2015 Report Card</a></p>
      ...
      Employees on the Medical Plan that participate in the 3 steps outlined below will receive a $1,728.00
      annual ($144/month) premium reduction for their incentive. Employees not covered under the Medical plan
