...
class VillageOfLemont2020TobaccoFormComplianceView extends ComplianceView
{
...
class VillageOfLemont2020ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printHeader(ComplianceProgramStatus $status)
    {
        ...
        <p>
            Welcome to your summary page for the 2020 Wellness Rewards benefit at Village of Lemont. This is the seventh
            year of the Village of Lemont's wellness rewards program and 2020 brings with it a few extra incentives to
            achieve your premium discount.
        </p>

        <p>
            In 2020, employees reaching the necessary number of points will receive a discount on their 2020 health
            insurance premium. There will also be incentives for those employees who participate but are not on our
            health plans.
        </p>

        <p>
            In order to earn the first premium discount, you must earn at least 325 points by June 12th, 2020. In order
            to continue to receive a premium discount, you will need to have earned at least a total of 525 points by
            December 16, 2020. You can earn these points from actions taken for your good health and wellbeing across
...
class VillageOfLemont2020ComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new VillageOfLemont2020ComplianceProgramReportPrinter();
//        $printer->setShowPointBasedGroupTotal(true);
    ...
    public function loadEvaluators()
    {
        ...
        $totalFirstHalfView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2020-01-01', '2020-06-12'), array(), 325);
        $totalFirstHalfView->setReportName('<strong>By 06/12/2020</strong>');
        $totalFirstHalfView->setName('total_first_half');
        $totalsGroup->addComplianceView($totalFirstHalfView);

        $totalView = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation('2020-01-01', '2020-12-16'), array(), 525);
        $totalView->setReportName('<strong>By 12/16/2020</strong>');
    ...
    public function loadGroups()
    {
        ...
        $nonSmokerView = new VillageOfLemont2020TobaccoFormComplianceView($startDate, $endDate);
