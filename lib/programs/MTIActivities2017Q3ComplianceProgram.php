...
class MTIActivities2017Q3WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '07/03/2017 through 07/09/2017',
        2 => '07/10/2017 through 07/16/2017',
        3 => '07/17/2017 through 07/23/2017',
        4 => '07/24/2017 through 07/30/2017',
        5 => '07/31/2017 through 08/06/2017',
        6 => '08/07/2017 through 08/13/2017',
        7 => '08/14/2017 through 08/20/2017',
        8 => '08/21/2017 through 08/27/2017',
        9 => '08/28/2017 through 09/03/2017',
        10 => '09/04/2017 through 09/10/2017',
        11 => '09/11/2017 through 09/17/2017',
        12 => '09/18/2017 through 09/24/2017',
        13 => '09/25/2017 through 10/01/2017'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2017-07-03', '2017-10-02');
...
class MTIActivities2017Q3ComplianceProgram extends ComplianceProgram
{
    const MTI_2017Q3_ACTIVITY_START_DATE = '2017-07-03';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2017Q3WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2017Q3WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2017Q3WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2017Q3_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2017Q3ComplianceProgram::MTI_2017Q3_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
