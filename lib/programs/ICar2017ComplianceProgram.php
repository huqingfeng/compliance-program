...
class ICar2017ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new ICar2017ComplianceProgramReportPrinter();
    ...
    public function loadGroups()
    {
        ...
        $phyExam->emptyLinks();
        $phyExam->addLink(new Link('Verification form', '/resources/8860/2017_PreventiveCare Cert.pdf'));
        ...
        $prevServ->addLink(new Link('Verification form', '/resources/8860/2017_PreventiveCare Cert.pdf'));
        ...
        $fluShot->addLink(new Link('Verification form', '/resources/8860/2017_PreventiveCare Cert.pdf'));
        ...
        $smoking->addLink(new Link('Verification Form', '/resources/8866/2017_WellnessEventCert.pdf'));
        ...
        $fiveK->addLink(new Link('Verification Form', '/resources/8866/2017_WellnessEventCert.pdf'));
...
class ICar2017ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
//                $('.view-lnl_presentation').children('td:eq(0)').remove();
                ...
                $('.view-10_weeks_steps').children('td:eq(0)').html('<strong>A</strong>. Wellness Walking Challenge' +
                    '<br /><br /><span style="font-size:8pt;">Challenge: June 1 – August 31, 2017</span>');
                ...
                $('.view-national_bike_challenge').children('td:eq(0)').html('<strong>B</strong>. National Bike Challenge' +
                    '<br /><span style="font-size:8pt;">Challenge: May - September</span>' +
        ...
        <p><strong>All Employees that complete the Wellness Screening and Health Assessment Questionnaire are
            ...
            health activities between <strong>1/1/17 – 11/30/17</strong>.</p>
