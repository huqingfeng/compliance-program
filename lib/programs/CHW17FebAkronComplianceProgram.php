...
class CHW17FebAkronCompleteELearningLessonComplianceView extends CompleteELearningLessonComplianceView
{
...
class CHW17FebAkronComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $quizLawsView = new CHW17FebAkronCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1365), false);
        ...
        $quizVitalView = new CHW17FebAkronCompleteELearningLessonComplianceView($programStart, $programEnd, new ELearningLesson_v2(1406));
...
//        $learningView->setNumberRequired(1);
        ...
        $learningView->setPointsPerLesson(40);
        $courseHealthCareGroup->addComplianceView($learningView, false, $bookJourneySection);
        ...
        $pastTimelineView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(20, 0, 0, 0));
        ...
        $courseHealthCareGroup->addComplianceView($pastTimelineView, false, $bookJourneySection);

        $myLegacyView = new PlaceHolderComplianceView(ComplianceStatus::NOT_COMPLIANT);
        $myLegacyView->setReportName('My Legacy');
        $myLegacyView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(20, 0, 0, 0));
        ...
        $courseHealthCareGroup->addComplianceView($myLegacyView, false, $bookJourneySection);
        ...
        $reportOneView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(30, 0, 0, 0));
        ...
        $reportTwoView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(30, 0, 0, 0));
        ...
        $reportThreeView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(30, 0, 0, 0));
    ...
    protected function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $status->getComplianceViewStatus('health_care')->setPoints(
            $status->getComplianceViewGroupStatus('course_health_care')->getPoints() + $status->getComplianceViewStatus('health_care')->getPoints()
        );
    ...
    {
        $printer = new CHW17FebAkronComplianceProgramReportPrinter();
...
class CHW17FebAkronComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
