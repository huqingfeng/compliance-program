...
class HMI2012ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    <?php
        ProgressBarPrinter::printBar($status, 100);
    }
}

class HMI2012ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new HMI2012ComplianceProgramReportPrinter();
    ...
    public function loadEvaluators()
    {
        ...
        $q2Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2012-06-30'), array(), 100);
        ...
        $q3Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2012-09-30'), array(), 150);
        ...
        $q4Deadline = new ProgramStatusEvaluatorComplianceView($this->cloneForEvaluation($this->getStartDate(), '2012-12-31'), array(), 200);
