<?php
  ...
  use \hpn\data\stream\HttpStream;

  class BedelFinancial2022SecondComplianceProgram extends ComplianceProgram {
    ...
    public function getProgramReportPrinter($preferredPrinter = null) {
      return new BedelFinancial2022SecondWMS2ComplianceProgramPrinter();
    }
    ...
    public function loadGroups() {
      ...
      $beingVideo->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
        ...
        ->andWhere('tbk.completion_date BETWEEN ? AND ?', array('2022-07-01', '2022-12-31'))
        ->hydrateSingleRow()
        ->execute();
      ...
      $nutritionElearningView->addLink(new Link('Complete Lessons', '/content/9420?action=lessonManager&amp;tab_alias[]=foods_nutrition', false, '_blank'));
  ...
  class BedelFinancial2022SecondWMS2ComplianceProgramPrinter implements ComplianceProgramReportPrinter {
    public function printReport(ComplianceProgramStatus $status) {
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($viewStatus->getStatus() == ComplianceStatus::COMPLIANT): ?>
                      <span class="label label-success"><?= $viewStatus->getComment() ?></span>
                    <?php endif; ?>
                  </td>
                  <td class="text-center">
                    <?php if ($viewStatus->getStatus() == ComplianceStatus::COMPLIANT): ?>
                      <span class="label label-success"><?= $viewStatus->getPoints() ?></span>
                    <?php endif; ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($viewStatus->getStatus() == ComplianceStatus::PARTIALLY_COMPLIANT): ?>
                      <span class="label label-warning"><?= $viewStatus->getPoints() ?></span>
                    <?php endif; ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($viewStatus->getStatus() == ComplianceStatus::NOT_COMPLIANT): ?>
                      <span class="label label-danger"><?= $viewStatus->getPoints() ?></span>
                    <?php endif; ?>
                  </td>
                </tr>
              <?php endforeach; ?>
      ...
      <script type="text/javascript">
        $(function() {
        	$.ajax({
        		url: '/compliance/bedelfinancial-2022/covid19/compliance_programs?id=1709&points_only=true',
        		success: function(reply) {
        			$('span.quarter-1').html(reply);
        			$('span.quarter-2').html(<?= $totalPoints; ?>);
        		}
        	})
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="circle-range">
                    ...
                    <div style="font-size: 1.3em; line-height: 1.0em;">
                      <span class="circle-points quarter-1">
            ...
            <div class="col-md-4">
              <div class="row">
              	<div class="circle-range">
	                <div class="circle-range-inner circle-range-inner-danger">
                    <div style="font-size: 1.3em; line-height: 1.0em;">
                      <span class="circle-points quarter-2"></span>
      ...
      <div class="row">
        <div class="col-md-12">
          <p>
            <a href="#" id="more-info-toggle">Click for more information...</a>
          </p>
      ...
      <div class="row">
        <div class="col-md-12">
          <table id="activities">
            ...
            <tbody>
              <?= $tableRow('Biometrics', $status->getComplianceViewGroupStatus('Biometrics')) ?>
              <?= $tableRow('Prevention', $status->getComplianceViewGroupStatus('Prevention')) ?>
              <?= $tableRow('Community', $status->getComplianceViewGroupStatus('Community')) ?>
              <?= $tableRow('Mind', $status->getComplianceViewGroupStatus('Mind')) ?>
              <?= $tableRow('Exercise', $status->getComplianceViewGroupStatus('Exercise')) ?>
              <?= $tableRow('Nutrition', $status->getComplianceViewGroupStatus('Nutrition')) ?>
              <?= $tableRow('De-stress', $status->getComplianceViewGroupStatus('De-stress')) ?>
            </tbody>
          </table>
        </div>
      </div>
