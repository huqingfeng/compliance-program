...
class TataSteel2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TataSteel2018ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '12/01/18');
        ...
        $hraView->setAttribute('goal', '12/01/18');
...
class TataSteel2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10160/Tata Steel_AQF_082518.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 1, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
