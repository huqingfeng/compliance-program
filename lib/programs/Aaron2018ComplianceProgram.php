...
class Aaron2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Aaron2018ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '10/31/2018');
        ...
        $hraView->setAttribute('goal', '10/31/2018');
...
class Aaron2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10115/Aaron Equipment_AQF_072618.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN October 31, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
