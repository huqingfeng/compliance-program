...
class CarloGavazziIP2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new CarloGavazziIP2019ComplianceProgramReportPrinter();
    }
...
class CarloGavazziIP2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10417/Carlo_Gavazzi_AQF_2019.pdf" target="_blank">Alternate Qualification Form</a>
