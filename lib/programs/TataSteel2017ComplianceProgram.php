...
class TataSteel2017ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new TataSteel2017ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '12/01/17');
        ...
        $hraView->setAttribute('goal', '12/01/17');
...
class TataSteel2017ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/9821/Tata Steel_AQF_092917.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 1, 2017</strong>
                            </td>
                         <?php endif ?>
                    </tr>
