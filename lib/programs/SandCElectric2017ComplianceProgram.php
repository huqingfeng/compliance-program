...
class SandCElectric2017CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class SandCElectric2017ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $screening = new SandCElectric2017CompleteScreeningComplianceView($startDate, '2017-05-05');
    ...
    {
        return new SandCElectric2017ComplianceProgramReportPrinter();
    }
...
class SandCElectric2017ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
