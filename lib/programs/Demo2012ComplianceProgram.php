<?php
class DemoScreeningPrinter extends ScreeningProgramReportPrinter
{
...
class Demo2012CoachingView extends GraduateFromCoachingSessionComplianceView
{
...
class DemoWorkshop2012 extends AttendCompanyWorkshopComplianceView
{
...
class Demo2012ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $doctorView = new UpdateContactInformationComplianceView($programStart, $programEnd);
        ...
        $ongoingHealthCoachingView = new Demo2012CoachingView($programStart, $programEnd);
        ...
        $requiredLessons = new CompleteRequiredELearningLessonsComplianceView($programStart, $programEnd);
        $requiredLessons->setReportName('Complete Required e-Learning Lessons');
        ...
        $extraGroup = new ComplianceViewGroup('points', 'And, earn 100 or more points from A-H below by '.date('F d, Y', $programEnd));
...
//
        ...
        $attendWorkshopView->setReportName('Health Programs / Events Participated In');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            $printer = new DemoScreeningPrinter();
            ...
            $printer = new Demo2012ComplianceProgramReportPrinter();
        }
...
class Demo2012ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
    ...
    <tr>
        <td><a href="/content/1094#1dHC">F. <?php echo $elearningStatus->getComplianceView()->getReportName() ?></a>
        </td>
        <td class="center">
    ...
    <tr>
        <td><a href="/content/1094#2cRPS">B. <?php echo $preventiveScreeningsStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td><a href="/content/1094#2dAFV">C. <?php echo $fluVaccineStatus->getComplianceView()->getReportName() ?></a>
        </td>
    ...
    <tr>
        <td><a href="/content/1094#2eRPA">D. <?php echo $physicalActivityStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td><a href="/content/1094#2fHC">E. <?php echo $workWithHealthCoachStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td><a href="/content/1094#2gCoolEvents">F. <?php echo $workshopStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td><a href="/content/1094#2hEL">G. <?php echo $extraELearningStatus->getComplianceView()
            ->getReportName() ?></a></td>
    ...
    <tr>
        <td><a href="/content/1094#2iVT">H. <?php echo $volunteeringStatus->getComplianceView()->getReportName() ?></a>
        </td>
    ...
    <tr>
        <td style="text-align: right;">Status of 1ABCDEF + ≥ 100 points as of: <?php echo date('m/d/Y'); ?> =</td>
