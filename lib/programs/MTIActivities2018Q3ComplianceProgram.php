...
class MTIActivities2018Q3WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validWeeks = array(
        1 => '07/02/2018 through 07/08/2018',
        2 => '07/09/2018 through 07/15/2018',
        3 => '07/16/2018 through 07/22/2018',
        4 => '07/23/2018 through 07/29/2018',
        5 => '07/30/2018 through 08/05/2018',
        6 => '08/06/2018 through 08/12/2018',
        7 => '08/13/2018 through 08/19/2018',
        8 => '08/20/2018 through 08/26/2018',
        9 => '08/27/2018 through 09/02/2018',
        10 => '09/03/2018 through 09/09/2018',
        11 => '09/10/2018 through 09/16/2018',
        12 => '09/17/2018 through 09/23/2018',
        13 => '09/24/2018 through 09/30/2018'
    );
    ...
    public function __construct($questionId, $threshold, $timeLength, $maxPoints, $additional = null)
    {
        ...
        parent::__construct('2018-07-01', '2018-09-30');
...
class MTIActivities2018Q3ComplianceProgram extends ComplianceProgram
{
    const MTI_2018Q3_ACTIVITY_START_DATE = '2018-07-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null, $pointsPerRecord = null, $link = true)
    {
        ...
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $pointsPerRecord
        );
    ...
    protected function getSummableActivityView($name, $questionId, $threshold, $timeLength, $maxPoints, $reportName = null)
    {
        ...
        $view = new MTIActivities2018Q3WeeklyLogComplianceView($questionId, $threshold, $timeLength, $maxPoints, $additional);
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2018Q3WeeklyLogComplianceView::$validWeeks[$w])) {
                    $text = MTIActivities2018Q3WeeklyLogComplianceView::$validWeeks[$w];
    ...
    public function getFitbitActivity($user)
    {
        ...
        $start = strtotime(self::MTI_2018Q3_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $preventionElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $fitnessElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        ...
        $nutritionElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'light_activities');
        ...
        $stressElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        ...
        $financialElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'legal_financial');
        ...
        $communityElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'all_lessons');
        ...
        $brainElearningView = new CompleteELearningGroupSet(MTIActivities2018Q3ComplianceProgram::MTI_2018Q3_ACTIVITY_START_DATE, $endDate, 'brain_nervous_system');
