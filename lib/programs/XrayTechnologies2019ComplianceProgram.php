...
class XrayTechnologies2019ComplianceProgram extends ComplianceProgram
{
    public function getAdminProgramReportPrinter()
    {
        ...
        $printer->addMultipleStatusFieldsCallback(function(ComplianceProgramStatus $status) {
            ...
            $data['Total Points 2017'] = $status->getAttribute('prior_status')->getPoints();
...
//            $data['Has Biometric Override'] = $status->getAttribute('has_biometric_override') ? 'Yes' : 'No';
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if (sfConfig::get('app_wms2', true)) {
            return new XrayTechnologies2019WMS2Printer();
        } else {
            $printer = new XrayTechnologies2019Printer();
    ...
    public function loadGroups()
    {
        ...
        $screeningView = new CompleteScreeningComplianceView('2018-09-01', '2018-11-30');
        ...
        $coachingRequiredUsers = array(2718038, 2762407, 3498304, 2718002, 2718171, 2718229, 2719405, 3130435);
        ...
        $coachingOverall->setAttribute('deadline', '05/31/2019');
        $coachingOverall->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use ($coachingRequiredUsers) {
            $notRequired = SelectQuery::create()
                ...
                ->andWhere('compliance_program_record_id = ?', array(XrayTechnologies2019ComplianceProgram::XRAYTECHNOLOGIES_2019_RECORD_ID))
        ...
        $coachingSession1->setAttribute('deadline', '05/31/2019');
        ...
        $coachingSession2->setAttribute('deadline', '05/31/2019');
        ...
        $spouseParticipation->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) {
            ...
            if(!$spouseUser || (isset($this->options['in_spouse']) && $this->options['in_spouse']))  {
                ...
                $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologies2019ComplianceProgram::XRAYTECHNOLOGIES_2019_RECORD_ID)->getComplianceProgram(array('in_spouse' => true));
...
//        $biometricsGroup->addComplianceView($smokingView);
    ...
    public function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $coachingStartDate = '2018-12-01';
        $coachingEndDate = '2019-05-31';
    ...
    public function getPriorYearBiometricsComplianceViewStatuses(User $user)
    {
        if($user->getRelationshipType() == Relationship::SPOUSE) {
            $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologies2019ComplianceProgram::XRAYTECHNOLOGIES_2018_SPOUSEE_RECORD_ID)->getComplianceProgram();
        } else {
            $program = ComplianceProgramRecordTable::getInstance()->find(XrayTechnologies2019ComplianceProgram::XRAYTECHNOLOGIES_2018_EMPLOYEE_RECORD_ID)->getComplianceProgram();
        }
    ...
    const XRAYTECHNOLOGIES_2018_EMPLOYEE_RECORD_ID = 1257;
    const XRAYTECHNOLOGIES_2018_SPOUSEE_RECORD_ID = 1260;
}

class XrayTechnologies2019Printer extends CHPStatusBasedComplianceProgramReportPrinter
{
...
class XrayTechnologies2019WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
            ...
            <div class="col-md-12">
                ...
                <div id="more-info">
                    <div class="row">
                        <div class="col-md-12">
                            <p>
                                Welcome to the 2019 X-Ray Industries Wellness Program. In order to qualify for the $600
                                incentive in 2019, employees who are on the medical plan and are participating in wellness
                                must meet 4 objectives to qualify for the 2019 incentive. Spouses on the medical plan will
                                only be required to meet requirements 1, 2 and 3 to qualify for the 2019 incentive.
                            </p>
                            <ul style="list-style: decimal">
                                <li>Complete an online Health Risk Assessment by <strong>November 30, 2018</strong>.</li>
                                <li>Complete an onsite Health Screening by <strong>November 30, 2018</strong>.*</li>
                                <li><strong>If notified by Circle Wellness</strong>, you must complete 2 coaching contacts by May 31, 2019 or you will lose the incentive effective June 1, 2019.</li>
                            ...
                            <p>
                                ...
                                ELearning lessons must be completed by December 7, 2018. You must have a total of nine points to qualify
                                for the incentive. Please contact the Circle Wellness Hotline if you have any questions: 1-866-682-3020 ext. 204.
                                <br/><br/>
                                OR<br/><br/>
                                • Bring a <a href="/resources/10129/2018 X-RAY Physician Exception Form.pdf" target="_blank">Physician Exception Form</a>
                                to your physician to complete. The form must be returned by December 7, 2018.
                            </p>
                            ...
                            <p>
                                ...
                                <a href="/resources/10130/2018 X-RAY Pregnancy Exception Form.pdf" target="_blank">Pregnancy Exception Form</a>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.view-spouse_participation').children(':eq(0)').html('5. <?php echo $status->getComplianceViewStatus('spouse_participation')->getAttribute('spouse_text') ?> Compliance');
            });
        </script>
        <?php
    }
