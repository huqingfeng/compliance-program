...
class SBMFSecondary2015BloodDonationComplianceView extends DateBasedComplianceView
{
...
class SBMFSecondary2015BMIMaintainComplianceView extends DateBasedComplianceView
{
...
class SBMFSecondary2015BMIReductionBonusComplianceView extends DateBasedComplianceView
{
    public function __construct($start, $end)
    {
        $this->setStartDate($start);
...
class SBMFSecondary2015ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        $printer = new SBMF2015SecondaryComplianceProgramReportPrinter();
        $printer->setPageHeading('My 2015 Incentive Activities');
...
//        $this->addComplianceViewGroup($smokingStatusGroup);
        ...
        $bloodPressureView = new ComplyWithBloodPressureScreeningTestComplianceView('2014-09-01', '2015-08-31');
        ...
        $tcLearn = new CompleteELearningGroupSet('2015-04-01', '2015-10-31', 'access_cholesterol');
...
//        $this->addComplianceViewGroup($biometricsGroup);
        ...
        $physicalView = new CompletePreventionPhysicalExamComplianceView('2014-09-01', '2015-09-01');
        $physicalView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(2, 0, 0, 0));
        $physicalView->addLink(new Link('I did this', 'https://www.circlewell.com/resources/5663/SBMF-Verification-Form-060415.pdf'));
        ...
        $additionalLessons = new CompleteAdditionalELearningLessonsComplianceView('2015-04-01', '2015-10-31');
...
class SBMF2015SecondaryComplianceProgramReportPrinter extends CHPStatusBasedComplianceProgramReportPrinter
{
        ...
        <p>Your Incentive Activities Page!</p>
            ...
            <ol>
                ...
                <li><strong>Annual Physical Exam</strong>: An annual physical exam will be automatically entered into your record from information received from your health plan. Updates
                    ...
                    the claim will be updated on the website in April or May. OR you can complete a <a href="/resources/5663/SBMF-Verification-Form-060415.pdf">verification form</a>
                    indicating that you had your physical completed. Physical exams need to be completed between September 1, 2014 and August 31, 2015.
                </li>
                <li><strong>Annual Flu Shot</strong>: Employees and spouses who received a flu vaccination between September 1, 2014 and August 31, 2015
                ...
                <li><strong>Blood Donation</strong>: Employees and spouses who donate blood four times a year will receive two points on their wellness scorecard.
                    Those who donate twice a year will earn one point. A double red cell donation will count as two donations. Blood donations must be completed between September 1, 2014 and August 31, 2015.
                </li>
            </ol>
    ...
    public function printClientNotice()
    {
        ...
        ?>
        Your scorecard will be updated throughout the year as incentive points are earned. You may use your 2014 health screening results to give you an indication of your current potential to earn incentive points.
        <br/>
        <p><a href="compliance_programs?id=468">Click Here to View My Incentive Scorecard</a></p>
