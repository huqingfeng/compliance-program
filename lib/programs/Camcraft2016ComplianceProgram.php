...
class Camcraft2016ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Camcraft2016ComplianceProgramReportPrinter();
    }
...
class Camcraft2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="letter">
            ...
            Institute, <?php echo $user->getClient()->getName() ?> has selected six “Health Standards” for you to strive to achieve.</p>

            <p>As communicated, a medical premium discount will be offered for the next plan year, beginning
                6/1/2016, to those employees (and spouses) who fall within the acceptable range for at least three
                out of the six “Health Standards” shown below. If you (or your spouse) do not fall within the
                acceptable range for at least <span class="bund">three</span> measures, you have the option of the "Alternate Process"
                in order to still receive the discount. If you do not successfully complete either of these
            ...
            <?php if($this->getNumCompliant($status) >= 3 && $cotinineCompliant) : ?>
                ...
                acceptable range for at least three “Health Standards” and therefore, qualify for the medical
            ...
            <?php elseif($this->getNumCompliant($status) >= 3 && !$cotinineCompliant) : ?>
                ...
                <p>Based on your results of the 2016 wellness screening, you do fall within the acceptable range for
                at least three “Health Standards”. However, your cotinine result was not in the acceptable range.
                It is <span class="bund">required</span> for you to enroll in American Lung Association’s Smoking Cessation Program
                by June 1, 2016, and complete thereafter.</p>
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>Based on your results of the 2016 wellness screening, you <span class="bund">DO NOT</span> fall within the acceptable range
                        for at least three “Health Standards” and therefore, do not qualify for the medical premium discount.
                    ...
                    <p>In order to receive the discount, we <strong>must</strong> have documentation from your Physician acknowledging
                        the “Health Standard” areas of concern. Please return the form, which will be included in your
                        results packet, to Health Maintenance Institute, complete with your Physician’s signature. If your
                        completed form is not received by the deadline of June 1, 2016, you will not qualify for the discount.</p>

                    <p>Specifically for those who did not fall within the acceptable range for the cotinine test, it is
                        <span class="bund">required</span> for you to enroll in American Lung Association’s Smoking Cessation Program by June 1, 2016,
                        and complete thereafter.</p>
