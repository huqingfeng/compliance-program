...
class HospitalSistersStFrancis2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new HospitalSistersStFrancis2021ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '11/19/21');
        ...
        $hraView->setAttribute('goal', '11/19/21');
...
class HospitalSistersStFrancis2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10699/Hospital_Sisters_of_St_Francis_ AQF_09142021.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 3, 2021</strong>
                            </td>
                         <?php endif ?>
                    </tr>
