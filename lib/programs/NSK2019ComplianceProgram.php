...
class NSK2019CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class NSK2019ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new NSK2019WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningBiometric = new NSK2019CompleteScreeningComplianceView($programStart, $programEnd);
    ...
    protected function configureViewForElearningAlternative(ComplianceView $view, $alias, $allAliases)
    {
        ...
        $view->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use(&$callCache, $alias, $allAliases, $userIdsToIgnore) {
            ...
            if($view->getStartDate('Y-m-d') != '2019-01-01') {
                return;
            }
    ...
    protected function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $priorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($status->getUser(), '2018-01-01', '2018-12-31');
        $priorPriorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($status->getUser(), '2017-04-01', '2017-12-31');
    ...
    const RECORD_ID = 1424;
}


class NSK2019WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="row">
            <div class="col-md-12">
                <h1>2019 Incentive Report Card</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="activities">
                    ...
                    <tr class="point-totals">
                        <th>2019 Without Alternatives</th>
                        <td><?php echo $maxPriorPoints ?></td>
                ...
                <p>
                    ...
                    <a href="/resources/10307/NSK_2019_Pregnancy_Exception_Form.pdf">pregnancy exception form</a>
