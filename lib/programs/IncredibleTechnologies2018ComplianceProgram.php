...
class IncredibleTechnologies2018LearningAlternativeComplianceView extends ComplianceView
{
...
class IncredibleTechnologies2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new IncredibleTechnologies2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '11/02/18');
        ...
        $hraView->setAttribute('goal', '11/02/18');
...
class IncredibleTechnologies2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right;">
                    <img src="/images/empower/incredible_technology_logo.jpg" style="height:80px;"  />
                </div>
            </p>
            ...
            <p>Incredible Technologies is committed to encourage and help support the health, care and wellbeing
            ...
            <p>Earning the incentive this year requires completing a wellness screening, the Empower Health
                ...
                your name will be on a list that is sent to Incredible Technologies for everyone earning the
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10127/Incredible_Technologies_AQF_072518.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN December 3, 2018</strong>
                            </td>
                         <?php endif ?>
                    </tr>
