...
class Active2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Active2019ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '10/16/19');
        ...
        $hraView->setAttribute('goal', '10/16/19');
...
class Active2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="">
            <img src="https://static.hpn.com/resources/10382/2019_BCBS_Weekly_Insurance_Contributions_071619.png" />
        </div>
                         ...
                         <?php else : ?>
                            <td colspan="3" style="background-color: #ffb3b3">
                                <p>
                                    ...
                                    <a href="/resources/10381/2019_Active_AQF_071619.pdf" target="_blank">Alternate Qualification Form</a>
                                    and sending it to Empower Health Services
                                </p>
                                <p>
                                    by fax at 630-385-0156 or mail
                                </p>
                                <strong>NO LATER THAN November 30, 2019</strong>
                            </td>
                         <?php endif ?>
                    </tr>
