...
class AbtElectronics2018ComplianceProgram extends ComplianceProgram
{
    ...
    public function loadGroups()
    {
        ...
        $coreEndDate = "2019-02-22";

        $coreGroup = new ComplianceViewGroup('core', 'Get Started - Get these done by February 22, 2019');
        ...
        $pointGroup = new ComplianceViewGroup('points', 'Earn 35 or more points from A&B below by '.date('F d, Y', $programEnd));
        ...
        $glucoseView->overrideTestRowData(50, 70, 100, 125.999, "M");
        $glucoseView->overrideTestRowData(40, 70, 100, 125.999, "F");
    ...
    {
        $printer = new AbtElectronics2018ComplianceProgramReportPrinter();
...
class AbtElectronics2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div style="float: right;">
            <img style="height: 100px;" src="https://static.hpn.com/resources/10159/Abt_logo.png"/>
        </div>
        ...
        <p></p>
        <p>Abt is committed to supporting the health and wellbeing of its employees and their families. A first step in promoting
            good health is awareness. That is why we offer the annual wellness screening through Empower Health and tie a
            financial incentive to it.</p>

        <p>The incentive is based on participating in all components of the program and earning a minimum of 35 points. Each of
            the results listed below has a scoring range of 10 points (in range value), 5 points (moderate risk level), or 0 points
            (high risk level). If you are unable to total 35 points based on your screening results, you can still earn the full
            incentive by following up with your own physician and submitting the alternate qualification form to Empower Health.
            The form, if needed, can be downloaded by clicking the link in the lower right corner of the chart below.</p>

        <p>Non-participants, those who do not complete all program components, and participants who do not earn not earn at
            least 35 points based on their screenings results and do not complete the alternate qualification form, will pay $500
            more annually for employee-only coverage or $1,000 more annually if both an employee and spouse is covered under
            the Abt medical plan. Both the employee & spouse need to meet all qualifications in order to receive the incentive.</p>
        ...
        <table class="phipTable" border="1">
            ...
            <tr>
                <td><a href="/content/1369_details#3aKBHM">A. Have these screening results in the ideal zone:</a></td>
                <td colspan="4">
            ...
            <tr>
                <td colspan="2">B. If needed, work with your primary care doctor/provide to turn in a Completed
                    Alternate Qualification Form (AQF) by February 22, 2019. Download and print the form which has places
                    for both of you to complete, and the fax or address to use.</td>
                ...
                <td class="center"><a href="https://static.hpn.com/resources/10158/ABT_AQF_082118.pdf" download="true">If needed, click here to download the AQF pdf</a></td>
            </tr>
            ...
            <tr>
                ...
                <td class="center">
                    ...
                    <?php else:?>
                        Not Met Yet <img style="margin-left: 10px;" src="/images/lights/yellowlight.gif" class="light">
                    <?php endif;?>
                </td>
            </tr>
