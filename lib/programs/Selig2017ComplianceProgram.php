...
class Selig2017ComplianceProgram extends ComplianceProgram
{
    public function getAdminProgramReportPrinter()
    {
        ...
        $printer->addStatusFieldCallback('01/01/2017 - 11/30/2017 - Points', function(ComplianceProgramStatus $status) {
            $user = $status->getUser();

            $program = $this->cloneForEvaluation('2017-01-01', '2017-11-30');
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $hraScreeningView = new CompleteHRAAndScreeningComplianceView($programStart, '2017-06-30');
        ...
        $hraScreeningView->setAttribute('requirement', 'Employee completes the wellness screening & health assessment <strong>BEFORE 6/30/17</strong>');
        ...
        $physicalExam->setAttribute('requirement', 'Follow-up with your medical provider and receive your Annual Physical Exam <strong>BEFORE 11/30/17</strong>');
        $physicalExam->setAttribute('points_per_activity', '50');
        $physicalExam->emptyLinks();
        $physicalExam->setAllowPointsOverride(true);
        $physicalExam->addLink(new FakeLink('Admin will enter', '#'));
        ...
        $spouseScreening = new PlaceHolderComplianceView(null, 0);
        ...
        $spouseScreening->setAttribute('requirement', 'Eligible Spouse or Domestic Partner, completes the Wellness Screening & Health Assessment <strong>BEFORE 6/30/17</strong>');
        ...
        $spouseScreening->setAllowPointsOverride(true);
        $wellnessGroup->addComplianceView($spouseScreening);

        $dependentScreening = new PlaceHolderComplianceView(null, 0);
        ...
        $dependentScreening->setAttribute('requirement', 'Dependent 18 + completes 2017 Wellness Screening and Health Assessment <strong>BEFORE 6/30/17</strong>');
        $dependentScreening->setAttribute('points_per_activity', '15');
        $dependentScreening->emptyLinks();
        $dependentScreening->setAllowPointsOverride(true);
        ...
        $preventiveServiceView->setReportName('Preventive Exams Submit proof of completion to HMI via the wellness portal or email at wellness@axionrms.com.');
        ...
        $preventiveServiceView->addLink(new Link('Verification Form <br />', 'https://static.hpn.com/wms2/documents/clients/selig/Selig%202017_PreventiveCare%20Cert.pdf'));
        ...
        $spousePreventiveServiceView->setReportName('Spouse/ Dependent 18+ Preventive Exam Submit proof of completion to HMI via the wellness portal or email at wellness@axionrms.com.');
        ...
        $spousePreventiveServiceView->addLink(new Link('Verification Form', 'https://static.hpn.com/wms2/documents/clients/selig/Selig%202017_PreventiveCare%20Cert.pdf'));
        $spousePreventiveServiceView->addLink(new Link('Submit Form', '/content/chp-document-uploader'));
        ...
        $bcbsView->setReportName('<strong>BCBS OnMyTime Online Course</strong><br /> Smoking Cessation Stress Management Nutrition / Weight Mgmt.');
        ...
        $weightLossView->setReportName('<strong>Individual Weight Loss Program</strong><br /> Submit proof of completion to HMI via the wellness portal or email at wellness@axionrms.com.');
        ...
        $kickOffView->setReportName('<strong>Wellness Kick off</strong><br />  Employees are educated about HMI and the Selig Wellness Program.');
        $kickOffView->setAttribute('requirement', 'Attend the wellness kick off meeting or webinar in May/June (date TBD). ');
        $kickOffView->setAttribute('points_per_activity', '10');
        $kickOffView->emptyLinks();
        $kickOffView->addLink(new FakeLink('Sign in at Event', '#'));
        $kickOffView->setMaximumNumberOfPoints(10);
        ...
        $walk6k->setMaximumNumberOfPoints(11);
        ...
        $walk6k->addLink(new Link('Moves Sync <br />', '/standalone/moves'));
        ...
        $walk8k->setMaximumNumberOfPoints(11);
        ...
        $walk10k->setMaximumNumberOfPoints(11);
        ...
        $runRaceView->setReportName('<strong>Run / Walk a Race</strong><br /><br /> Submit proof of participation such as registration form, race results, or bib number to HMI via the wellness portal or email at wellness@axionrms.com.');
        ...
        $runRaceView->addLink(new Link('Verification form', 'https://static.hpn.com/wms2/documents/clients/selig/Selig%202017_WellnessEventCert.pdf'));
        ...
        $walking15HoursView->setReportName('<strong>"Walking Works" Walking Program</strong><br /><br /> Participate in the walking program and record daily activity on the BCBS Walking Works Website');
        ...
        $playoffTeamView->setReportName('<strong>"Walking Works" Playoff Team</strong>');
        ...
        $championshipTeamView->setReportName('<strong>"Walking Works" Championship Team</strong>');
        ...
        $mostActivityTheirTeamView->setReportName('<strong>"Walking Works" All-Star</strong>');
        ...
        $mostActivityAllTeamView->setReportName('<strong>"Walking Works" MVP**</strong>');
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($preferredPrinter == 'ScreeningProgramReportPrinter' && $this->getActiveUser() !== null) {
            ...
            $printer = new Selig2017ComplianceProgramReportPrinter();
        }
...
class Selig2017ComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <p>
            ...
            <div style="text-align: center; width: 62%; float: right; border: 1px solid #000000;">
                <div style="padding: 20px 10px;">
                    <span style="font-size: 12pt; font-weight: bold; color: #6e9de5">2017 Wellness Program Calendar</span> <br />
        ...
        <p>
            Selig' s wellness program will be tracked by our NEW Partner, HMI (Health Maintenance Institute)
             <a href="http://www.myhmihealth.com">http://www.myhmihealth.com</a>. HMI is a HIPAA-compliant,
             biometric screening vendor that will maintain the confidentiality of your personal health information.
             <strong>Your personal health information will not be seen by anyone within the Selig organization. </strong>
        </p>

        <p>
            <strong>HOW DOES THE PROGRAM WORK?</strong>  To participate in the Selig Group Wellness Program, employees are required
            to complete the spring 2017 Health Screening & Assessment.  Participation in the screening and other wellness
            activities (outlined here) will earn points that will be tracked through the HMI website.
        </p>

        <p>
            Participants will first register an account on the HMI site: <a href="http://www.myhmihealth.com">www.myhmihealth.com</a>
            using the site code: <strong>SELIG</strong>.  Once you have enrolled on the HMI site you will be able to
            complete the required health questionnaire.
        </p>

        <p>
            <strong>You must complete the Health Screening by June 30, 2017 AND complete the Follow-Up Physical Exam by
             November 30, 2017 to earn an incentive. </strong>
        </p>
        ...
        <div>
            <table id="programTable">
                ...
                <tr>
                    <td>July 31, 2017</td>
                    <td>•	$300 Lump Sum Payment</td>
                    <td>•	$600 Lump Sum Payment</td>
                </tr>
                <tr>
                    <td>November 30, 2017</td>
                    <td>•	$300 Lump Sum Payment (if not earned in July)</td>
                    <td>
                        •	$600 Lump Sum Payment ($300 if a $300 lump sum payment was earned in July) <br />
                        •	Raffle Entry for 150,000 American Express Points
                     </td>
                </tr>
            </table>
            <p>
                Selig's HR Group will monitor your participation in the Wellness Program throughout the year.  The amount of
                the lump-sum payment received in August and/or December will depend on the number of points earned as of July 31, 2017 and November 30, 2017.
            </p>
            <p style="color: red;">
        ...
        <table class="phipTable">
            ...
            <tr>
                <td  rowspan="2">
                    ...
                    Submit proof of completion to HMI via the wellness portal or email at <a href="http://wellness@axionrms.com">wellness@axionrms.com</a>.
                </td>
            ...
            <tr><th colspan="6" class="section"><span style="font-weight:bolder; font-size: 12pt;">"Walking Works" Walking Program:  May 22, 2017 – July 31, 2017</span></th></tr>
            ...
            <tr>
                ...
                <td class="center" rowspan="5">
                    Track activity at: <br />
                    <a href="http://www.walkingworks.com">www.walkingworks.com</a> <br /><br />
                    Admin will enter points
                </td>
            </tr>
        ...
        <p><strong>**The MVP is not eligible for All-Star Points</strong></p>
