...
class ClinicareCorporation2020ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new ClinicareCorporation2020ComplianceProgramReportPrinter();
    }
...
class ClinicareCorporation2020ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width: 48%; text-align: right">
                    <img src="	/resources/10602/Clinicare_logo_102720.png" style="height:41px;"  />
                </div>
            </p>
            ...
            <div style="margin-left:10px;">
                ...
                <p>
                    To earn the full incentive for this year, participants must complete the wellness screening.
                </p>
        ...
        <p style="text-align:center">
            <table id="results">
                <tbody>
                    ...
                    <tr class="headerRow">
                        <th colspan="2" style="text-align: left; width: 430px;">1. Get Started - Get these done by 12/15/2020</th>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;">
                            <ol style="list-style-type: upper-alpha;">
                                ...
                                <li>If your score is 26-40 &#8594; Your goal is ti reach 25 or less in 2021</li>
                        ...
                        <td colspan="1" class="center bold">
                              <?php echo $status->getComplianceViewGroupStatus('biometric')->getStatus() == ComplianceViewStatus::COMPLIANT ? 'Yes, Congrats!' : 'Not yet!  See 3E' ?>
                        </td>
                    </tr>
