...
class MTIActivities2015Q4WeeklyLogComplianceView extends CompleteActivityComplianceView
{
    static $validQ4Weeks = array(
        1 => '09/28/2015 through 10/04/2015',
        2 => '10/05/2015 through 10/11/2015',
        3 => '10/12/2015 through 10/18/2015',
        4 => '10/19/2015 through 10/25/2015',
        5 => '10/26/2015 through 11/01/2015',
        6 => '11/02/2015 through 11/08/2015',
        7 => '11/09/2015 through 11/15/2015',
        8 => '11/16/2015 through 11/22/2015',
        9 => '11/23/2015 through 11/29/2015',
        10 => '11/30/2015 through 12/06/2015',
        11 => '12/07/2015 through 12/13/2015',
        12 => '12/14/2015 through 12/20/2015',
        13 => '12/21/2015 through 12/27/2015',
        14 => '12/28/2015 through 01/03/2016'
    );
    ...
    public function __construct($questionId, $pointsPer, $divisor, $additional = null)
    {
        ...
        parent::__construct('2015-10-01', '2016-01-30');
    ...
    {
        $records = $this->getActivity()->getRecords($user, '2015-03-01', '2016-01-30');
...
class MTIActivities2015Q4ComplianceProgram extends ComplianceProgram
{
    const MTI_2014_ACTIVITY_START_DATE = '2015-10-01';
    ...
    protected function getActivityView($name, $activityId, $points, $reportName = null)
    {
        $view = new CompleteArbitraryActivityComplianceView(
            MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE,
            $this->getEndDate(),
            $activityId,
            $points
        );
    ...
    protected function getSummableActivityView($name, $activityId, $questionId, $pointsPer, $divisor, $maxPoints, $reportName = null)
    {
      ...
      $view = new MTIActivities2015Q4WeeklyLogComplianceView($questionId, $pointsPer, $divisor, $additional);
    ...
    {
        $printer = new MTIActivities2015Q4ComplianceProgramPrinter();
    ...
    public function executeFitbitFeed(sfActions $actions)
    {
        ...
        $addForWeek = function($data) {
            ...
            foreach($data as $k => $v) {
                ...
                if (isset(MTIActivities2015Q4WeeklyLogComplianceView::$validQ4Weeks[$w])) {
                    $text = MTIActivities2015Q4WeeklyLogComplianceView::$validQ4Weeks[$w];
    ...
    {
        $start = strtotime(MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE);
        $end = $this->getEndDate();
    ...
    public function loadGroups()
    {
        ...
        $fluTetView = new ComplyWithMultipleHraQuestionsComplianceView(MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, array(30, 31));
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'mti_prevention');
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'mti_fitness');
        $learningView->setReportName('Complete an e-learning module');
        $learningView->setNumberRequired(1);
        $learningView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(5, 0, 0, 0));
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'light_activities');
        $learningView->setReportName('Complete an e-learning module');
        $learningView->setNumberRequired(1);
        $learningView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(5, 0, 0, 0));
        ...
        $learningView = new CompleteELearningGroupSet(MTIActivities2015Q4ComplianceProgram::MTI_2014_ACTIVITY_START_DATE, $endDate, 'mti_stress');
        $learningView->setReportName('Complete an e-learning module');
        $learningView->setNumberRequired(1);
        $learningView->setComplianceStatusPointMapper(new ComplianceStatusPointMapper(5, 0, 0, 0));
...
class MTIActivities2015Q4ComplianceProgramPrinter extends CHPComplianceProgramReportPrinter
{
    public function printReport(\ComplianceProgramStatus $status)
    {
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $.get('/compliance_programs?id=445', function(fullPage) {
                    var $page = $(fullPage);
                ...
                $.get('/compliance_programs?id=476', function(fullPage) {
                    var $page = $(fullPage);

                    var thirdQuarterPoints = parseInt($page.find('#3rd_quarter_points').html(), 10);

                    $('#3rd_quarter_points').html(thirdQuarterPoints);
                });
    ...
    protected function printCustomRows(ComplianceProgramStatus $status)
    {
        ...
        <tr class="headerRow">
            ...
            <td id="4th_quarter_points"><?php echo $status->getPoints() ?></td>
            <td></td>
            <td></td>
        </tr>
        <?php
