...
class EdwCLevyPreventive2016ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        if(sfConfig::get('app_wms2')) {
            return new EdwCLevyPreventive2016WMS2Printer();
        } else {
            return new EdwCLevyPreventive2016ComplianceProgramReportPrinter();
        }
...
class EdwCLevyPreventive2016ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
...
class EdwCLevyPreventive2016WMS2Printer implements ComplianceProgramReportPrinter
{
    public function printReport(ComplianceProgramStatus $status)
    {
