...
class Canfor2018ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Canfor2018ComplianceProgramReportPrinter();
    }
...
//        $coreGroup->setPointsRequiredForCompliance(50);
        ...
        $screeningView->setAttribute('goal', '12/15/18');
        ...
        $hraView->setAttribute('goal', '12/15/18');
        ...
        $bmiCoachingView->setReportName('3. Complete 4 telephonic health coaching sessions for BMI. <a href="/resources/10194/Canfor Alternate Standard BMI_101518v2.pdf">Click here for details.</a>');
        ...
        $tobaccoCoachingView->setReportName('3. Complete 4 telephonic health coaching sessions for tobacco. <a href="/resources/10195/Canfor Alternate Standard Tobacco_101518v2.pdf">Click here for details.</a>');
...
class Canfor2018ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            <p style="clear: both;">
                ...
                <div style="float: right; width:60%">
                    <h5>2019 Incentive Rewards & To-Dos</h5>
                </div>
            </p>
