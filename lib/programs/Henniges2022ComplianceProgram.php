...
class Henniges2022CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class Henniges2022CompleteScreeningAlternativeComplianceView extends CompleteScreeningComplianceView
{
    public function getData(User $user)
    {
        $data = ScreeningTable::getInstance()->findOneCompletedForUserBetweenDates($user,
...
class Henniges2022ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Henniges2022WMS2Printer();
    }
    ...
    public function loadGroups()
    {
        ...
        $hraView->addLink(new Link('Take HRA', sfConfig::get('app_wms2') ? '/compliance/henniges-automotive-2021/hra/content/my-health' : '/content/989'));
        $preventionEventGroup->addComplianceView($hraView);

        $screeningView = new Henniges2022CompleteScreeningComplianceView($programStart, $programEnd);
        ...
        $screeningView->setPostEvaluateCallback(function($status, $user) use($programStart, $programEnd) {
            $alternativeView = new Henniges2022CompleteScreeningAlternativeComplianceView($programStart, $programEnd);
...
class Henniges2022WMS2Printer implements ComplianceProgramReportPrinter
{
