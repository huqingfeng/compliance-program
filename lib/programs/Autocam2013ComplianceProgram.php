...
class Autocam2013Coaching extends PlaceHolderComplianceView
{
...
class Autocam2013ComplianceProgram extends ComplianceProgram
{
    public function loadGroups()
    {
        ...
        $hraView = new CompleteHRAComplianceView($programStart, '2014-01-10');
        $hraView->setName('hra');
    ...
    {
        return new Autocam2013ComplianceProgramReportPrinter();
    }
}

class Autocam2013ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    <div id="program_information">
        <p>
            ...
            requirements to maintain compliance in 2013.
        </p>
        ...
        <p>
            ...
            to additional premium sharing. Currently the annual differential is $923 per employee. This rate may
            change for 2014. </p>
        ...
        <tbody>
            ...
            <tr class="requiredrow">
                <td class="requirementscolumn">
                    ...
                    <a href="/content/11358" class="moreinfo">- more info</a>
                    <br/>
                    Receive from your Primary Care Physician (Exam must be completed between 4/1/12 - 12/31/13.)<a
                    href="/resources/4239/2013AutoCamPhysForm.pdf">Download Physician Form</a>
                </td>
                <td class="myrequirementscolumn">
                    Yearly, Due 01/10/2014
                </td>
                <td class="statuscolumn">
