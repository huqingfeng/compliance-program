...
class Avlon2021ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Avlon2021ComplianceProgramReportPrinter();
    }
    ...
    public function loadGroups()
    {
        ...
        $screeningView->setAttribute('goal', '5/13/21');
        ...
        $hraView->setAttribute('goal', '5/13/21');
        ...
        $completeConsultation->setReportName('a. Complete consultation with Dr. Todd by 6/2/21. <a href="https://p.bttr.to/2EqANwX">Click here for details.</a>');
        ...
        $attendSeminarAlt3->setReportName('c. Attend 1 virtual seminar with Dr. Todd on 6/2/21 or 7/21/21. <a href="https://practicebetter.zoom.us/j/8833634683">Click here for details.</a>');
        ...
        $finalConsultationAlt3->setReportName('d. Complete final consultation with Dr. Todd by 7/21/21. <a href="https://p.bttr.to/2EqANwX">Click here for details.</a>');
        ...
        $initialConsultation->setReportName('a. Initial consultation with Dr. Todd by 6/2/21. <a href="https://p.bttr.to/2EqANwX">Click here for details.</a>');
        ...
        $attendSeminarAlt4->setReportName('b. Attend 2 virtual seminars with Dr. Todd on 6/2/21 or 7/21/21. <a href="https://practicebetter.zoom.us/j/8833634683">Click here for details.</a>');
        ...
        $finalConsultation->setReportName('c. Complete final consultation with Dr. Todd by 7/21/21. <a href="https://p.bttr.to/2EqANwX">Click here for details.</a>');
...
class Avlon2021ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <div style="clear: both">
                <div style="width: 100%; margin-top: 10px; display: block">
                    ...
                    <p>Employees can save up to $520 for the 2021-22 plan year by participating and attaining certain health
