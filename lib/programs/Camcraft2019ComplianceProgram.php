...
class Camcraft2019ComplianceProgram extends ComplianceProgram
{
    ...
    {
        return new Camcraft2019ComplianceProgramReportPrinter();
    }
...
class Camcraft2019ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
        ...
        <div class="letter">
            ...
            <?php elseif($this->getNumCompliant($status) >= 3 && !$cotinineCompliant) : ?>
                ...
                <p>Based on your results of the wellness screening, you do fall within the acceptable range for at least
                    three “Health Standards”. However, your cotinine result was not in the acceptable range. It is required
                    for you to enroll in American Lung Association's Smoking Cessation Program <span class="bund">within 30
                        days of your screening date</span> and complete thereafter.</p>
            ...
            <?php else : ?>
                <div id="not_compliant_notes">
                    ...
                    <p>In order to receive the discount, we <strong>must</strong> have documentation from your Physician
                        ...
                        signature. If your completed form is not received within 30 days of your screening date, you will
                        not qualify for the discount.</p>
                    ...
                    <p>
                        Fax: 630-385-0156 <br />
                        Mailing Address: 4205 Westbrook Drive, Aurora, IL 60504. Attn: AQF Department
                    </p>
                </div>
            <?php endif ?>
