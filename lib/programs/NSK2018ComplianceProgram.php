...
class NSK2018CompleteScreeningComplianceView extends CompleteScreeningComplianceView
{
...
class NSK2018ComplianceProgram extends ComplianceProgram
{
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        return new NSK2018WMS2Printer();
    }
    ...
    protected function getPhoneConsultShowed($user)
    {
        $row = SelectQuery::create()
            ...
            ->andWhere('a.date BETWEEN ? AND ?', array('2018-01-01', '2018-12-31'))
    ...
    public function loadGroups()
    {
        ...
        $screeningBiometric = new NSK2018CompleteScreeningComplianceView($programStart, $programEnd);
    ...
    protected function configureViewForElearningAlternative(ComplianceView $view, $alias, $allAliases)
    {
        ...
        $view->setPostEvaluateCallback(function(ComplianceViewStatus $status, User $user) use(&$callCache, $alias, $allAliases, $userIdsToIgnore) {
            ...
            if($view->getStartDate('Y-m-d') != '2018-01-01') {
                return;
            }
    ...
    protected function evaluateAndStoreOverallStatus(ComplianceProgramStatus $status)
    {
        ...
        $priorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($status->getUser(), '2017-05-01', '2017-12-31');
        $priorPriorStatus = $status->getComplianceProgram()->getPriorYearBiometricsComplianceViewStatuses($status->getUser(), '2016-04-01', '2016-12-31');
    ...
    const RECORD_ID = 1333;
}


class NSK2018WMS2Printer implements ComplianceProgramReportPrinter
{
    ...
    public function printReport(ComplianceProgramStatus $status)
    {
        ...
        <div class="row">
            <div class="col-md-12">
                <h1>2018 Incentive Report Card</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <a href="/compliance/nsk-2018/overview">Full Program Details</a><br/>
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="activities">
                    ...
                    <tr class="point-totals">
                        <th>2018 Without Alternatives</th>
                        <td><?php echo $maxPriorPoints ?></td>
                ...
                <p>
                    ...
                    <a href="https://static.hpn.com/wms2/documents/clients/nsk/NSK%202018%20Pregnancy%20Exception%20Form.pdf">pregnancy exception form</a>
                    and submit it to Circle Wellness to obtain credit for the body measurements. This will satisfy the Better
                    of Body Fat or BMI requirement ONLY. If additional points are still needed the remaining alternatives
                    must be completed. With this exemption you will still need to complete alternatives if they appear
                    in your Report Card.
                </p>
            </div>
        </div>
