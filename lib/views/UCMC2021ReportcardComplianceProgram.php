...
class UCMC2021ReportCardComplianceView extends ComplianceView
{
...
class UCMC2021ReportCardComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($_GET['method'] == 'custom_points' && !isset($_GET['reportcard_id'])) {
            ...
            $cards = [
                34 => 'UCMC Reportcard',
                35 => 'Ingalls Reportcard',
                36 => 'UCMC Care Network Reportcard',
                37 => 'UCMC Residents Reportcard'
            ];
...
class UCMC2021ReportCardCompliancePrinter extends ScreeningProgramReportPrinter
{
