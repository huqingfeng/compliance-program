...
class ComplyWithBMIWaistScreeningTestComplianceView extends ComplianceView
{
    ...
    public function __construct($startDate, $endDate)
    {
        ...
        $this->waistView = new ComplyWithWaistScreeningTestComplianceView($this->startDate, $this->endDate);
    }

    public function getDefaultName()
    {
        return 'comply_with_bmi_waist_screening_test';
    }
    ...
    public function overrideWaistTestRowData($riskLow, $low, $high, $riskHigh, $gender = 'E')
    {
        $this->waistView->overrideTestRowData($riskLow, $low, $high, $riskHigh, $gender);
    }
