...
class WMSALTDEMO2020ReportCardComplianceView extends ComplianceView
{
...
class WMSALTDEMO2020ReportCardComplianceProgram extends ComplianceProgram
{
    ...
    public function getProgramReportPrinter($preferredPrinter = null)
    {
        ...
        if($_GET['method'] == 'custom_points' && !isset($_GET['reportcard_id'])) {
                    ...
                    <script>
                        $(function() {
                            $('.edit-card').click(function() {
                                ...
                                if(card_id != -1) {
                                    window.location = '/compliance/wmsdemoalt/well-rewards/compliance_programs?<?php echo $_SERVER['QUERY_STRING']; ?>&reportcard_id=' + card_id;
                                }
                            });
                        })
                    </script>
            ...
            $url = $domain."/wms3/public/wmsdemoaltrc?bypass=true&method=";
...
class WMSALTDEMO2020ReportCardComplianceProgramReportPrinter extends BasicComplianceProgramReportPrinter
{
...
class WMSALTDEMO2020ReportCardCompliancePrinter extends ScreeningProgramReportPrinter
{
