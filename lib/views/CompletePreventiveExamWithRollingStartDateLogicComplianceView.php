 ...
 */
class CompletePreventiveExamWithRollingStartDateLogicComplianceView extends CompleteActivityComplianceView
{
    ...
    public function getStatus(User $user)
    {
        ...
        foreach($records as $rec) {
            ...
            $startDate = $this->rollingStartDate ? strtotime(sprintf('-%s months', $types[$type]), $this->getStartDate()) :  $this->getStartDate();
    ...
    public function setRollingStartDate($rollingStartDate)
    {
