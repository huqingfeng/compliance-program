<?php
class AttendCompanyWorkshopComplianceView extends CompleteActivityComplianceView
{
    /**
    ...
    {
        return new ActivityTrackerActivity(ActivityTrackerActivity::ATTEND_WORKSHOP);
    }
