...
class Culver20092010ComplianceProgramReportPrinter implements ComplianceProgramReportPrinter
{
    ...
    <p></p>
    <p>Welcome to your summary page for the 2009-2010 Culver Academies Wellness Incentives.

    <p>To receive the incentives, eligible employees and spouses MUST EACH take certain actions and meet the criteria
        specified below:</p>

    <ol>
        <li>Premium contribution credit: Complete BOTH core required actions done by November 30, 2009. By getting #1
            done, those with medical benefits through Culver get the applicable lower Wellness Rate for premium
            contributions saving you over $300-$2800 this year depending on the benefits you elected. If not, your
            premium contribution doubles, costing you that much more.
        </li>
        <li>$200 flex benefit credit: Get 7 or more points from key screening results and/or key actions taken for good
            health by August 31, 2010.
        </li>
    </ol>
    <p>Important:</p>
    <ul>
    ...
    <p style="text-align:center;">
        <a href="/content/1175">Click here for more details about the 2009-2010 Wellness Rewards benefit and
            requirements.</a>
    </p>
    <p></p>
    ...
    <table class="phipTable">
        <tbody>
            ...
            <tr>
                <td style="text-align:right;">Did I get #1A&amp;B done by 11/30/<strong>2009</strong> ?</td>
                <td class="points"><?php echo $totalOneStatus; ?></td>
                <td colspan="4" class="points"><?php echo $totalOneComment; ?></td>
            </tr>
            <tr>
                <td style="text-align:right;">Did I get ≥ 7 points on or before 8/31/<strong>2010</strong> ?</td>
